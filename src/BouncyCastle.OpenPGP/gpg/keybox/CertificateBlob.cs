namespace org.bouncycastle.gpg.keybox
{
	...
	public class CertificateBlob : KeyBlob
	{
		...
		/// </para>
		/// </summary>
		public virtual byte[] getEncodedCertificate()
		{
			return getKeyBytes();
		}
	}
