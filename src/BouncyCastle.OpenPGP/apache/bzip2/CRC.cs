...
namespace org.bouncycastle.apache.bzip2
{
	...
	public class CRC
	{
		...
		public virtual void initialiseCRC()
		{
			globalCrc = unchecked((int)0xffffffff);
		}

		public virtual int getFinalCRC()
		{
			return ~globalCrc;
		}

		public virtual int getGlobalCRC()
		{
			return globalCrc;
		}

		public virtual void setGlobalCRC(int newCrc)
		{
			globalCrc = newCrc;
		}

		public virtual void updateCRC(int inCh)
		{
