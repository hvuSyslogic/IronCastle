namespace org.bouncycastle.util.encoders
{
	...
	/// </summary>
	public class HexTranslator : Translator
	{
		private static readonly byte[] hexTable = new byte[] {(byte)'0', (byte)'1', (byte)'2', (byte)'3', (byte)'4', (byte)'5', (byte)'6', (byte)'7', (byte)'8', (byte)'9', (byte)'a', (byte)'b', (byte)'c', (byte)'d', (byte)'e', (byte)'f'};

		/// <summary>
		/// size of the output block on encoding produced by getDecodedBlockSize()
		/// bytes.
		/// </summary>
		public virtual int getEncodedBlockSize()
		{
			return 2;
		}

		public virtual int encode(byte[] @in, int inOff, int length, byte[] @out, int outOff)
		{
		...
		/// bytes.
		/// </summary>
		public virtual int getDecodedBlockSize()
		{
			return 1;
		}

		public virtual int decode(byte[] @in, int inOff, int length, byte[] @out, int outOff)
		{
