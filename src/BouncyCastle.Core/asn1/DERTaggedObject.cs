namespace org.bouncycastle.asn1
{
	...
	public class DERTaggedObject : ASN1TaggedObject
	{
		...
		public DERTaggedObject(bool @explicit, int tagNo, ASN1Encodable obj) : base(@explicit, tagNo, obj)
		{
		}

		public DERTaggedObject(int tagNo, ASN1Encodable encodable) : base(true, tagNo, encodable)
		{
		}
