namespace org.bouncycastle.asn1.cryptopro
{
	...
	/// </pre>
	/// </summary>
	public class GostR3410KeyTransport : ASN1Object
	{
		private readonly Gost2814789EncryptedKey sessionEncryptedKey;
		private readonly GostR3410TransportParameters transportParameters;
		...
		{
			if (obj is GostR3410KeyTransport)
			{
		...
		public virtual Gost2814789EncryptedKey getSessionEncryptedKey()
		{
			return sessionEncryptedKey;
		}

		public virtual GostR3410TransportParameters getTransportParameters()
		{
