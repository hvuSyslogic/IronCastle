...
namespace org.bouncycastle.asn1
{
	...
	/// </summary>
	public class DERExternal : ASN1External
	{
		/// <summary>
		...
		public DERExternal(ASN1EncodableVector vector) : base(vector)
		{
		}
		...
		public DERExternal(ASN1ObjectIdentifier directReference, ASN1Integer indirectReference, ASN1Primitive dataValueDescriptor, DERTaggedObject externalData) : this(directReference, indirectReference, dataValueDescriptor, externalData.getTagNo(), externalData.toASN1Primitive())
		{
		}
		...
		public DERExternal(ASN1ObjectIdentifier directReference, ASN1Integer indirectReference, ASN1Primitive dataValueDescriptor, int encoding, ASN1Primitive externalData) : base(directReference, indirectReference, dataValueDescriptor, encoding, externalData)
		{
		}
		...
		public override void encode(ASN1OutputStream @out)
		{
			...
			{
				baos.write(directReference.getEncoded(ASN1Encoding_Fields.DER));
			}
			if (indirectReference != null)
			{
				baos.write(indirectReference.getEncoded(ASN1Encoding_Fields.DER));
			}
			if (dataValueDescriptor != null)
			{
				baos.write(dataValueDescriptor.getEncoded(ASN1Encoding_Fields.DER));
			}
			DERTaggedObject obj = new DERTaggedObject(true, encoding, externalContent);
			baos.write(obj.getEncoded(ASN1Encoding_Fields.DER));
