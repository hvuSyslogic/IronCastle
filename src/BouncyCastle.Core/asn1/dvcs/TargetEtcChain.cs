...
namespace org.bouncycastle.asn1.dvcs
{
	...
	public class TargetEtcChain : ASN1Object
	{
		...
		public static TargetEtcChain getInstance(ASN1TaggedObject obj, bool @explicit)
		{
		...
		public virtual CertEtcToken getTarget()
		{
			return target;
		}

		public virtual CertEtcToken[] getChain()
		{
			if (chain != null)
			{
		...
		public virtual PathProcInput getPathProcInput()
		{
