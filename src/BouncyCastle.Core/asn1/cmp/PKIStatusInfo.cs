...
namespace org.bouncycastle.asn1.cmp
{
	...
	public class PKIStatusInfo : ASN1Object
	{
		internal ASN1Integer status;
		internal PKIFreeText statusString;
		internal DERBitString failInfo;

		public static PKIStatusInfo getInstance(ASN1TaggedObject obj, bool @explicit)
		{
		...
		public virtual BigInteger getStatus()
		{
			return status.getValue();
		}

		public virtual PKIFreeText getStatusString()
		{
			return statusString;
		}

		public virtual DERBitString getFailInfo()
		{
			return failInfo;
		}
