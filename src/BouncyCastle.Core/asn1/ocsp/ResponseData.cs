...
namespace org.bouncycastle.asn1.ocsp
{
	...
	public class ResponseData : ASN1Object
	{
		...
		/// <param name="responseExtensions"> </param>
		public ResponseData(ResponderID responderID, ASN1GeneralizedTime producedAt, ASN1Sequence responses, X509Extensions responseExtensions) : this(V1, responderID, ASN1GeneralizedTime.getInstance(producedAt), responses, Extensions.getInstance(responseExtensions))
		{
		}
		...
		public static ResponseData getInstance(ASN1TaggedObject obj, bool @explicit)
		{
		...
		public virtual ASN1Sequence getResponses()
		{
			return responses;
		}
