...
namespace org.bouncycastle.asn1
{
	...
	public class DLSet : ASN1Set
	{
		...
		public DLSet(ASN1Encodable obj) : base(obj)
		{
		}

		/// <param name="v"> - a vector of objects making up the set. </param>
		public DLSet(ASN1EncodableVector v) : base(v, false)
		{
		}
		...
		/// </summary>
		public DLSet(ASN1Encodable[] a) : base(a, false)
		{
		}
