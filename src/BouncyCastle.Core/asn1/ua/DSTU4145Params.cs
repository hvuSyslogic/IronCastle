...
namespace org.bouncycastle.asn1.ua
{
	...
	{
		private static readonly byte[] DEFAULT_DKE = new byte[] {unchecked((byte)0xa9), unchecked((byte)0xd6), unchecked((byte)0xeb), 0x45, unchecked((byte)0xf1), 0x3c, 0x70, unchecked((byte)0x82), unchecked((byte)0x80), unchecked((byte)0xc4), unchecked((byte)0x96), 0x7b, 0x23, 0x1f, 0x5e, unchecked((byte)0xad), unchecked((byte)0xf6), 0x58, unchecked((byte)0xeb), unchecked((byte)0xa4), unchecked((byte)0xc0), 0x37, 0x29, 0x1d, 0x38, unchecked((byte)0xd9), 0x6b, unchecked((byte)0xf0), 0x25, unchecked((byte)0xca), 0x4e, 0x17, unchecked((byte)0xf8), unchecked((byte)0xe9), 0x72, 0x0d, unchecked((byte)0xc6), 0x15, unchecked((byte)0xb4), 0x3a, 0x28, unchecked((byte)0x97), 0x5f, 0x0b, unchecked((byte)0xc1), unchecked((byte)0xde), unchecked((byte)0xa3), 0x64, 0x38, unchecked((byte)0xb5), 0x64, unchecked((byte)0xea), 0x2c, 0x17, unchecked((byte)0x9f), unchecked((byte)0xd0), 0x12, 0x3e, 0x6d, unchecked((byte)0xb8), unchecked((byte)0xfa), unchecked((byte)0xc5), 0x79, 0x04};
