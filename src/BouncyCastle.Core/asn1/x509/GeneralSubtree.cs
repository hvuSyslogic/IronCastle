...
namespace org.bouncycastle.asn1.x509
{
	...
	/// </pre>
	/// </summary>
	/// <seealso cref= org.bouncycastle.asn1.x509.NameConstraints
	///  </seealso>
	public class GeneralSubtree : ASN1Object
	{
		...
		public static GeneralSubtree getInstance(ASN1TaggedObject o, bool @explicit)
		{
		...
		public virtual GeneralName getBase()
		{
			return @base;
		}

		public virtual BigInteger getMinimum()
		{
			if (minimum == null)
			{
				return ZERO;
		...
		public virtual BigInteger getMaximum()
		{
			if (maximum == null)
			{
				return null;
