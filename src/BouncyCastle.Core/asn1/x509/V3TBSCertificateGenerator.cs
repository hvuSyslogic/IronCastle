...
namespace org.bouncycastle.asn1.x509
{
	...
	{
		internal DERTaggedObject version = new DERTaggedObject(true, 0, new ASN1Integer(2));
		...
		public virtual void setIssuerUniqueID(DERBitString uniqueID)
		{
			this.issuerUniqueID = uniqueID;
		}

		public virtual void setSubjectUniqueID(DERBitString uniqueID)
		{
