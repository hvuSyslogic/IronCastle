...
public class ByteBuffer
{
    ...
    public ByteBuffer put(byte[] src, int offset, long length)
    {
        stream.Write(src, offset, (int) length);
        return this;
    }
    ...
    public static ByteBuffer wrap(byte[] sig)
    {
        throw new NotImplementedException();
    }
}