...
namespace org.bouncycastle.math.ec.custom.sec
{
	public class SecP192R1Point : ECPoint.AbstractFp
	{
		...
		public SecP192R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y, bool withCompression) : base(curve, x, y)
		{
		...
		public SecP192R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y, ECFieldElement[] zs, bool withCompression) : base(curve, x, y, zs)
		{
