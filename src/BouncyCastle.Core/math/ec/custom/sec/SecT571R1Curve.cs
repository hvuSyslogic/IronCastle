...
namespace org.bouncycastle.math.ec.custom.sec
{
	...
	public class SecT571R1Curve : ECCurve.AbstractF2m
	{
		...
		public override ECLookupTable createCacheSafeLookupTable(ECPoint[] points, int off, int len)
		{
			...
			return new SecT571R1CurveLookupTable(this, len, FE_LONGS, table);
		}

		public class SecT571R1CurveLookupTable : ECLookupTable
		{
			...
			public SecT571R1CurveLookupTable(SecT571R1Curve outerInstance, int len, int FE_LONGS, ulong[] table)
			{
