...
namespace org.bouncycastle.math.ec.custom.sec
{
	...
	public class SecT571K1Curve : ECCurve.AbstractF2m
	{
		...
		public override ECLookupTable createCacheSafeLookupTable(ECPoint[] points, int off, int len)
		{
			...
			return new SecT571K1CurveLookupTable(this, len, FE_LONGS, table);
		}

		public class SecT571K1CurveLookupTable : ECLookupTable
		{
			...
			public SecT571K1CurveLookupTable(SecT571K1Curve outerInstance, int len, int FE_LONGS, ulong[] table)
			{
