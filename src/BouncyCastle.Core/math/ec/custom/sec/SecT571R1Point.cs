...
namespace org.bouncycastle.math.ec.custom.sec
{
	...
	public class SecT571R1Point : ECPoint.AbstractF2m
	{
		...
		public SecT571R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y, bool withCompression) : base(curve, x, y)
		{
		...
		public SecT571R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y, ECFieldElement[] zs, bool withCompression) : base(curve, x, y, zs)
		{
		...
		public override ECPoint add(ECPoint b)
		{
			...
			if (X2.isZero())
			{
				...
				Z3 = (SecT571FieldElement)curve.fromBigInteger(ECConstants_Fields.ONE);
			}
			else
			{
		...
		public override ECPoint twicePlus(ECPoint b)
		{
			...
			ulong[] Z1SqPrecomp = SecT571Field.precompMultiplicand(Z1Sq);
