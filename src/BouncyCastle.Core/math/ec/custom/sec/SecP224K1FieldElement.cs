...
namespace org.bouncycastle.math.ec.custom.sec
{
	...
	public class SecP224K1FieldElement : ECFieldElement.AbstractFp
	{
		...
		private static readonly int[] PRECOMP_POW2 = new int[]{0x33bfd202, unchecked((int)0xdcfad133), 0x2287624a, unchecked((int)0xc3811ba8), unchecked((int)0xa85558fc), 0x1eaef5d7, unchecked((int)0x8edf154c)};
