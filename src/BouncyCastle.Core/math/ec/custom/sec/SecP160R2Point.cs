...
namespace org.bouncycastle.math.ec.custom.sec
{
	...
	public class SecP160R2Point : ECPoint.AbstractFp
	{
		/// <summary>
		...
		public SecP160R2Point(ECCurve curve, ECFieldElement x, ECFieldElement y, bool withCompression) : base(curve, x, y)
		{
		...
		public SecP160R2Point(ECCurve curve, ECFieldElement x, ECFieldElement y, ECFieldElement[] zs, bool withCompression) : base(curve, x, y, zs)
		{
