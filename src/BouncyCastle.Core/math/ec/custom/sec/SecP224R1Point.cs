...
namespace org.bouncycastle.math.ec.custom.sec
{
	...
	public class SecP224R1Point : ECPoint.AbstractFp
	{
		/// <summary>
		...
		public SecP224R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y, bool withCompression) : base(curve, x, y)
		{
		...
		public SecP224R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y, ECFieldElement[] zs, bool withCompression) : base(curve, x, y, zs)
		{
