...
namespace org.bouncycastle.math.ec.custom.sec
{
	...
	public class SecP521R1Point : ECPoint.AbstractFp
	{
		...
		public SecP521R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y, bool withCompression) : base(curve, x, y)
		{
		...
		public SecP521R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y, ECFieldElement[] zs, bool withCompression) : base(curve, x, y, zs)
		{
