...
namespace org.bouncycastle.math.ec.custom.sec
{
	...
	public class SecT193R1Curve : ECCurve.AbstractF2m
	{
		...
		public override ECLookupTable createCacheSafeLookupTable(ECPoint[] points, int off, int len)
		{
			...
			return new SecT193R1CurveLookupTable(this, len, FE_LONGS, table);
		}

		public class SecT193R1CurveLookupTable : ECLookupTable
		{
			...
			public SecT193R1CurveLookupTable(SecT193R1Curve outerInstance, int len, int FE_LONGS, ulong[] table)
			{
