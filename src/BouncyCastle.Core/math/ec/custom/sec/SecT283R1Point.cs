...
namespace org.bouncycastle.math.ec.custom.sec
{
	...
	public class SecT283R1Point : ECPoint.AbstractF2m
	{
		/// @deprecated Use ECCurve.createPoint to construct points 
		public SecT283R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y) : this(curve, x, y, false)
		{
		}

		/// @deprecated per-point compression property will be removed, refer <seealso cref="#getEncoded(boolean)"/> 
		public SecT283R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y, bool withCompression) : base(curve, x, y)
		{
		...
		public SecT283R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y, ECFieldElement[] zs, bool withCompression) : base(curve, x, y, zs)
		{
