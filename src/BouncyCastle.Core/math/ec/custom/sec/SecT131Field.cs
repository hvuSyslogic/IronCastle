...
namespace org.bouncycastle.math.ec.custom.sec
{
	...
	{
		private static readonly long M03 = (long)(unchecked((ulong)-1L) >> 61);
		private static readonly long M44 = (long)(unchecked((ulong)-1L) >> 20);
		...
		public static void reduce(ulong[] xx, ulong[] z)
		{
			...
			x1 ^= (x4 << 61) ^ (x4 << 63);
			x2 ^= ((long)((ulong)x4 >> 3)) ^ ((long)((ulong)x4 >> 1)) ^ x4 ^ (x4 << 5);
			x3 ^= ((long)((ulong)x4 >> 59));

			x0 ^= (x3 << 61) ^ (x3 << 63);
			x1 ^= ((long)((ulong)x3 >> 3)) ^ ((long)((ulong)x3 >> 1)) ^ x3 ^ (x3 << 5);
			x2 ^= ((long)((ulong)x3 >> 59));

			long t = (long)((ulong)x2 >> 3);
			z[0] = x0 ^ t ^ (t << 2) ^ (t << 3) ^ (t << 8);
			z[1] = x1 ^ ((long)((ulong)t >> 56));
			z[2] = x2 & M03;
		}

		public static void reduce61(long[] z, int zOff)
		{
			long z2 = z[zOff + 2], t = (long)((ulong)z2 >> 3);
			z[zOff] ^= t ^ (t << 2) ^ (t << 3) ^ (t << 8);
			z[zOff + 1] ^= ((long)((ulong)t >> 56));
			z[zOff + 2] = z2 & M03;
		}
	...
	//        assert n > 0;
		...
		public static int trace(long[] x)
		{
			...
			return (int)(x[0] ^ ((long)((ulong)x[1] >> 59)) ^ ((long)((ulong)x[2] >> 1))) & 1;
		}
		...
		protected internal static void implCompactExt(long[] zz)
		{
			...
			zz[0] = z0 ^ (z1 << 44);
			zz[1] = ((long)((ulong)z1 >> 20)) ^ (z2 << 24);
			zz[2] = ((long)((ulong)z2 >> 40)) ^ (z3 << 4) ^ (z4 << 48);
			zz[3] = ((long)((ulong)z3 >> 60)) ^ (z5 << 28) ^ ((long)((ulong)z4 >> 16));
			zz[4] = ((long)((ulong)z5 >> 36));
			zz[5] = 0;
		}
		...
		protected internal static void implMultiply(ulong[] x, ulong[] y, ulong[] zz)
		{
			...
			f2 = (((long)((ulong)f1 >> 24)) ^ (f2 << 40)) & M44;
			f1 = (((long)((ulong)f0 >> 44)) ^ (f1 << 20)) & M44;
			f0 &= M44;

			long g0 = y[0], g1 = y[1], g2 = y[2];
			g2 = (((long)((ulong)g1 >> 24)) ^ (g2 << 40)) & M44;
			g1 = (((long)((ulong)g0 >> 44)) ^ (g1 << 20)) & M44;
			g0 &= M44;
	   ...
	   //     assert (w0 & 1L) == 0;
			...
			w0 = ((long)((ulong)w0 >> 1)) ^ ((w1 & 1L) << 43);
			w1 = ((long)((ulong)w1 >> 1)) ^ ((w2 & 1L) << 43);
			w2 = ((long)((ulong)w2 >> 1));
	...
	//      u[0] = 0;
			...
			int j = (int)x;
			long g, h = 0, l = u[j & 7] ^ u[((int)((uint)j >> 3)) & 7] << 3 ^ u[((int)((uint)j >> 6)) & 7] << 6;
			int k = 33;
			do
			{
				j = (int)((long)((ulong)x >> k));
				g = u[j & 7] ^ u[((int)((uint)j >> 3)) & 7] << 3 ^ u[((int)((uint)j >> 6)) & 7] << 6 ^ u[((int)((uint)j >> 9)) & 7] << 9;
				l ^= (g << k);
				h ^= ((long)((ulong)g >> -k));
			} while ((k -= 12) > 0);
