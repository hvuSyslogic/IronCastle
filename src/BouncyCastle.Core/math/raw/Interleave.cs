namespace org.bouncycastle.math.raw
{
	...
	{
		private const long M32 = 0x55555555L;
		private const long M64 = 0x5555555555555555L;
		private const long M64R = unchecked((long)0xAAAAAAAAAAAAAAAAL);
	...
	//    };
		...
		public static long expand32to64(int x)
		{
			...
			int t;
			t = (x ^ ((int)((uint)x >> 8))) & 0x0000FF00;
			x ^= (t ^ (t << 8));
			t = (x ^ ((int)((uint)x >> 4))) & 0x00F000F0;
			x ^= (t ^ (t << 4));
			t = (x ^ ((int)((uint)x >> 2))) & 0x0C0C0C0C;
			x ^= (t ^ (t << 2));
			t = (x ^ ((int)((uint)x >> 1))) & 0x22222222;
			x ^= (t ^ (t << 1));

			return (((int)((uint)x >> 1)) & M32) << 32 | (x & M32);
		}
		...
		public static void expand64To128(long x, long[] z, int zOff)
		{
			// "shuffle" low half to even bits and high half to odd bits
			long t;
			t = (x ^ ((long)((ulong)x >> 16))) & 0x00000000FFFF0000L;
			x ^= (t ^ (t << 16));
			t = (x ^ ((long)((ulong)x >> 8))) & 0x0000FF000000FF00L;
			x ^= (t ^ (t << 8));
			t = (x ^ ((long)((ulong)x >> 4))) & 0x00F000F000F000F0L;
			x ^= (t ^ (t << 4));
			t = (x ^ ((long)((ulong)x >> 2))) & 0x0C0C0C0C0C0C0C0CL;
			x ^= (t ^ (t << 2));
			t = (x ^ ((long)((ulong)x >> 1))) & 0x2222222222222222L;
			x ^= (t ^ (t << 1));

			z[zOff] = (x) & M64;
			z[zOff + 1] = ((long)((ulong)x >> 1)) & M64;
		}
		...
		public static int shuffle2(int x)
		{
			...
			int t;
			t = (x ^ ((int)((uint)x >> 7))) & 0x00AA00AA;
			x ^= (t ^ (t << 7));
			t = (x ^ ((int)((uint)x >> 14))) & 0x0000CCCC;
			x ^= (t ^ (t << 14));
			t = (x ^ ((int)((uint)x >> 4))) & 0x00F000F0;
			x ^= (t ^ (t << 4));
			t = (x ^ ((int)((uint)x >> 8))) & 0x0000FF00;
