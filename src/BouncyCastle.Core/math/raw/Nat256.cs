...
namespace org.bouncycastle.math.raw
{
	...
	public abstract class Nat256
	{
		...
		public static bool eq64(long[] x, long[] y)
		{
			for (int i = 3; i >= 0; --i)
			{
				if (x[i] != y[i])
		...
		public static bool isOne64(long[] x)
		{
			if (x[0] != 1L)
			{
				return false;
		...
		public static bool isZero64(long[] x)
		{
			for (int i = 0; i < 4; ++i)
			{
				if (x[i] != 0L)
		...
		public static void square(int[] x, int[] zz)
		{
			...
			long x_7 = x[7] & M;
			long zz_13 = (zz[13] & M) + ((long)((ulong)zz_12 >> 32));
			zz_12 &= M;
			long zz_14 = (zz[14] & M) + ((long)((ulong)zz_13 >> 32));
			zz_13 &= M;
			{
				zz_7 += x_7 * x_0;
				w = (int)zz_7;
				zz[7] = (w << 1) | c;
				c = (int)((uint)w >> 31);
				zz_8 += ((long)((ulong)zz_7 >> 32)) + x_7 * x_1;
				zz_9 += ((long)((ulong)zz_8 >> 32)) + x_7 * x_2;
				zz_10 += ((long)((ulong)zz_9 >> 32)) + x_7 * x_3;
				zz_11 += ((long)((ulong)zz_10 >> 32)) + x_7 * x_4;
				zz_12 += ((long)((ulong)zz_11 >> 32)) + x_7 * x_5;
				zz_13 += ((long)((ulong)zz_12 >> 32)) + x_7 * x_6;
				zz_14 += (long)((ulong)zz_13 >> 32);
			}
			...
			zz[14] = (w << 1) | c;
			c = (int)((uint)w >> 31);
			w = zz[15] + (int)((long)((ulong)zz_14 >> 32));
			zz[15] = (w << 1) | c;
		}
		...
		public static void square(int[] x, int xOff, int[] zz, int zzOff)
		{
			...
			long x_7 = x[xOff + 7] & M;
			long zz_13 = (zz[zzOff + 13] & M) + ((long)((ulong)zz_12 >> 32));
			zz_12 &= M;
			long zz_14 = (zz[zzOff + 14] & M) + ((long)((ulong)zz_13 >> 32));
			zz_13 &= M;
			{
				zz_7 += x_7 * x_0;
				w = (int)zz_7;
			...
			zz[zzOff + 14] = (w << 1) | c;
			c = (int)((uint)w >> 31);
			w = zz[zzOff + 15] + (int)((long)((ulong)zz_14 >> 32));
			zz[zzOff + 15] = (w << 1) | c;
		}
