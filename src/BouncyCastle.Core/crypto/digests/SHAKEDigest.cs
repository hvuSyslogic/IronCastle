...
namespace org.bouncycastle.crypto.digests
{
	...
	/// </para>
	/// </summary>
	public class SHAKEDigest : KeccakDigest, Xof
	{
		...
		public virtual int doFinal(byte[] @out, int outOff, int outLen)
		{
		...
		public virtual int doOutput(byte[] @out, int outOff, int outLen)
		{
			if (!squeezing)
			{
				absorbBits(0x0F, 4);
		 ...
		 * TODO Possible API change to support partial-byte suffixes.
		 */
		public virtual int doFinal(byte[] @out, int outOff, int outLen, byte partialByte, int partialBits)
		{
