...
namespace org.bouncycastle.crypto.digests
{
	...
	public class MD5Digest : GeneralDigest, EncodableDigest
	{
		...
		public MD5Digest(byte[] encodedState) : base(encodedState)
		{
		...
		private void unpackWord(int word, byte[] @out, int outOff)
		{
			...
			@out[outOff + 1] = (byte)((int)((uint)word >> 8));
			@out[outOff + 2] = (byte)((int)((uint)word >> 16));
			@out[outOff + 3] = (byte)((int)((uint)word >> 24));
		}
