...
namespace org.bouncycastle.crypto.digests
{
	...
	/// </pre>
	/// </summary>
	public class SHA224Digest : GeneralDigest, EncodableDigest
	{
		...
		public SHA224Digest(byte[] encodedState) : base(encodedState)
		{
	...
	//        X[xOff] = Pack.bigEndianToInt(in, inOff);
		...
		public override void reset()
		{
			...
			H1 = unchecked((int)0xc1059ed8);
			H2 = 0x367cd507;
			H3 = 0x3070dd17;
			H4 = unchecked((int)0xf70e5939);
			H5 = unchecked((int)0xffc00b31);
			H6 = 0x68581511;
			H7 = 0x64f98fa7;
			H8 = unchecked((int)0xbefa4fa4);
