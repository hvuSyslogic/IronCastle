namespace org.bouncycastle.crypto.modes.gcm
{
	...
	{
		private const int E1 = unchecked((int)0xe1000000);
		private static readonly long E1L = (E1 & 0xFFFFFFFFL) << 32;
		...
		public static void multiply(int[] x, int[] y)
		{
			...
			for (int i = 0; i < 4; ++i)
			{
				...
				for (int j = 0; j < 32; ++j)
				{
					...
					int m2 = (y3 << 31) >> 8;
					y3 = ((int)((uint)y3 >> 1)) | (y2 << 31);
					y2 = ((int)((uint)y2 >> 1)) | (y1 << 31);
					y1 = ((int)((uint)y1 >> 1)) | (y0 << 31);
					y0 = ((int)((uint)y0 >> 1)) ^ (m2 & E1);
				}
			}
		...
		public static void multiply(long[] x, long[] y)
		{
			...
			for (int j = 0; j < 64; ++j)
			{
				...
				long c = (y1 << 63) >> 8;
				y1 = ((long)((ulong)y1 >> 1)) | (y0 << 63);
				y0 = ((long)((ulong)y0 >> 1)) ^ (c & E1L);
			}

			z0 ^= z2 ^ ((long)((ulong)z2 >> 1)) ^ ((long)((ulong)z2 >> 2)) ^ ((long)((ulong)z2 >> 7));
		...
		public static void multiplyP(int[] x)
		{
			...
			int m = (x3 << 31) >> 31;
			x[0] = ((int)((uint)x0 >> 1)) ^ (m & E1);
			x[1] = ((int)((uint)x1 >> 1)) | (x0 << 31);
			x[2] = ((int)((uint)x2 >> 1)) | (x1 << 31);
			x[3] = ((int)((uint)x3 >> 1)) | (x2 << 31);
		}
		...
		public static void multiplyP(int[] x, int[] z)
		{
			int x0 = x[0], x1 = x[1], x2 = x[2], x3 = x[3];
			int m = (x3 << 31) >> 31;
			z[0] = ((int)((uint)x0 >> 1)) ^ (m & E1);
			z[1] = ((int)((uint)x1 >> 1)) | (x0 << 31);
			z[2] = ((int)((uint)x2 >> 1)) | (x1 << 31);
			z[3] = ((int)((uint)x3 >> 1)) | (x2 << 31);
		}
		...
		public static void multiplyP(long[] x)
		{
			long x0 = x[0], x1 = x[1];
			long m = (x1 << 63) >> 63;
			x[0] = ((long)((ulong)x0 >> 1)) ^ (m & E1L);
			x[1] = ((long)((ulong)x1 >> 1)) | (x0 << 63);
		}
		...
		public static void multiplyP(long[] x, long[] z)
		{
			long x0 = x[0], x1 = x[1];
			long m = (x1 << 63) >> 63;
			z[0] = ((long)((ulong)x0 >> 1)) ^ (m & E1L);
			z[1] = ((long)((ulong)x1 >> 1)) | (x0 << 63);
		}
		...
		public static void multiplyP3(long[] x, long[] z)
		{
			long x0 = x[0], x1 = x[1];
			long c = x1 << 61;
			z[0] = ((long)((ulong)x0 >> 3)) ^ c ^ ((long)((ulong)c >> 1)) ^ ((long)((ulong)c >> 2)) ^ ((long)((ulong)c >> 7));
			z[1] = ((long)((ulong)x1 >> 3)) | (x0 << 61);
		}
		...
		public static void multiplyP4(long[] x, long[] z)
		{
			long x0 = x[0], x1 = x[1];
			long c = x1 << 60;
			z[0] = ((long)((ulong)x0 >> 4)) ^ c ^ ((long)((ulong)c >> 1)) ^ ((long)((ulong)c >> 2)) ^ ((long)((ulong)c >> 7));
			z[1] = ((long)((ulong)x1 >> 4)) | (x0 << 60);
		}
		...
		public static void multiplyP7(long[] x, long[] z)
		{
			long x0 = x[0], x1 = x[1];
			long c = x1 << 57;
			z[0] = ((long)((ulong)x0 >> 7)) ^ c ^ ((long)((ulong)c >> 1)) ^ ((long)((ulong)c >> 2)) ^ ((long)((ulong)c >> 7));
			z[1] = ((long)((ulong)x1 >> 7)) | (x0 << 57);
		}
		...
		public static void multiplyP8(int[] x)
		{
			int x0 = x[0], x1 = x[1], x2 = x[2], x3 = x[3];
			int c = x3 << 24;
			x[0] = ((int)((uint)x0 >> 8)) ^ c ^ ((int)((uint)c >> 1)) ^ ((int)((uint)c >> 2)) ^ ((int)((uint)c >> 7));
			x[1] = ((int)((uint)x1 >> 8)) | (x0 << 24);
			x[2] = ((int)((uint)x2 >> 8)) | (x1 << 24);
			x[3] = ((int)((uint)x3 >> 8)) | (x2 << 24);
		}
		...
		public static void multiplyP8(int[] x, int[] y)
		{
			int x0 = x[0], x1 = x[1], x2 = x[2], x3 = x[3];
			int c = x3 << 24;
			y[0] = ((int)((uint)x0 >> 8)) ^ c ^ ((int)((uint)c >> 1)) ^ ((int)((uint)c >> 2)) ^ ((int)((uint)c >> 7));
			y[1] = ((int)((uint)x1 >> 8)) | (x0 << 24);
			y[2] = ((int)((uint)x2 >> 8)) | (x1 << 24);
			y[3] = ((int)((uint)x3 >> 8)) | (x2 << 24);
		}
		...
		public static void multiplyP8(long[] x)
		{
			long x0 = x[0], x1 = x[1];
			long c = x1 << 56;
			x[0] = ((long)((ulong)x0 >> 8)) ^ c ^ ((long)((ulong)c >> 1)) ^ ((long)((ulong)c >> 2)) ^ ((long)((ulong)c >> 7));
			x[1] = ((long)((ulong)x1 >> 8)) | (x0 << 56);
		}
		...
		public static void multiplyP8(long[] x, long[] y)
		{
			long x0 = x[0], x1 = x[1];
			long c = x1 << 56;
			y[0] = ((long)((ulong)x0 >> 8)) ^ c ^ ((long)((ulong)c >> 1)) ^ ((long)((ulong)c >> 2)) ^ ((long)((ulong)c >> 7));
			y[1] = ((long)((ulong)x1 >> 8)) | (x0 << 56);
		}
		...
		public static void square(long[] x, long[] z)
		{
			...
			z1 ^= z3 ^ ((long)((ulong)z3 >> 1)) ^ ((long)((ulong)z3 >> 2)) ^ ((long)((ulong)z3 >> 7));
