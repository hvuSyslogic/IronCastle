...
namespace org.bouncycastle.crypto.modes.kgcm
{
	...
	public class KGCMUtil_256
	{
		...
		public static void multiply(long[] x, long[] y, long[] z)
		{
			...
			y3 = y2;
			y2 = y1;
			y1 = y0 ^ ((long)((ulong)y4 >> 62)) ^ ((long)((ulong)y4 >> 59)) ^ ((long)((ulong)y4 >> 54));
			...
			z1 ^= ((long)((ulong)z4 >> 62)) ^ ((long)((ulong)z4 >> 59)) ^ ((long)((ulong)z4 >> 54));
		...
		public static void square(ulong[] x, ulong[] z)
		{
			...
			while (--j >= SIZE)
			{
				...
				t[j - SIZE + 1] ^= ((long)((ulong)n >> 62)) ^ ((long)((ulong)n >> 59)) ^ ((long)((ulong)n >> 54));
			}
