...
namespace org.bouncycastle.crypto.modes.kgcm
{
	...
	public class KGCMUtil_512
	{
		...
		public static void multiply(long[] x, long[] y, long[] z)
		{
			...
			for (int i = 0; i < 8; i += 2)
			{
				...
				for (int j = 0; j < 64; ++j)
				{
					...
					long c = y7 >> 63;
					y7 = (y7 << 1) | ((long)((ulong)y6 >> 63));
					y6 = (y6 << 1) | ((long)((ulong)y5 >> 63));
					y5 = (y5 << 1) | ((long)((ulong)y4 >> 63));
					y4 = (y4 << 1) | ((long)((ulong)y3 >> 63));
					y3 = (y3 << 1) | ((long)((ulong)y2 >> 63));
					y2 = (y2 << 1) | ((long)((ulong)y1 >> 63));
					y1 = (y1 << 1) | ((long)((ulong)y0 >> 63));
					y0 = (y0 << 1) ^ (c & 0x125L);
				}
				...
				y3 = y2;
				y2 = y1;
				y1 = y0 ^ ((long)((ulong)y8 >> 62)) ^ ((long)((ulong)y8 >> 59)) ^ ((long)((ulong)y8 >> 56));
				y0 = y8 ^ (y8 << 2) ^ (y8 << 5) ^ (y8 << 8);
			}

			z0 ^= z8 ^ (z8 << 2) ^ (z8 << 5) ^ (z8 << 8);
			z1 ^= ((long)((ulong)z8 >> 62)) ^ ((long)((ulong)z8 >> 59)) ^ ((long)((ulong)z8 >> 56));
		...
		public static void multiplyX(long[] x, long[] z)
		{
			...
			long m = x7 >> 63;
			z[0] = (x0 << 1) ^ (m & 0x125L);
			z[1] = (x1 << 1) | ((long)((ulong)x0 >> 63));
			z[2] = (x2 << 1) | ((long)((ulong)x1 >> 63));
			z[3] = (x3 << 1) | ((long)((ulong)x2 >> 63));
			z[4] = (x4 << 1) | ((long)((ulong)x3 >> 63));
			z[5] = (x5 << 1) | ((long)((ulong)x4 >> 63));
			z[6] = (x6 << 1) | ((long)((ulong)x5 >> 63));
			z[7] = (x7 << 1) | ((long)((ulong)x6 >> 63));
		}
		...
		public static void multiplyX8(long[] x, long[] z)
		{
			long x0 = x[0], x1 = x[1], x2 = x[2], x3 = x[3];
			long x4 = x[4], x5 = x[5], x6 = x[6], x7 = x[7];
			long c = (long)((ulong)x7 >> 56);
			z[0] = (x0 << 8) ^ c ^ (c << 2) ^ (c << 5) ^ (c << 8);
			z[1] = (x1 << 8) | ((long)((ulong)x0 >> 56));
			z[2] = (x2 << 8) | ((long)((ulong)x1 >> 56));
			z[3] = (x3 << 8) | ((long)((ulong)x2 >> 56));
			z[4] = (x4 << 8) | ((long)((ulong)x3 >> 56));
			z[5] = (x5 << 8) | ((long)((ulong)x4 >> 56));
			z[6] = (x6 << 8) | ((long)((ulong)x5 >> 56));
			z[7] = (x7 << 8) | ((long)((ulong)x6 >> 56));
		}
		...
		public static void square(ulong[] x, ulong[] z)
		{
			...
			while (--j >= SIZE)
			{
				...
				t[j - SIZE + 1] ^= ((long)((ulong)n >> 62)) ^ ((long)((ulong)n >> 59)) ^ ((long)((ulong)n >> 56));
			}
