...
namespace org.bouncycastle.crypto.tls
{
	...
	public class TlsDHUtils
	{
		...
		public static readonly int? EXT_negotiated_ff_dhe_groups = Integers.valueOf(ExtensionType.negotiated_ff_dhe_groups);
		...
		private const string draft_ffdhe2432_p = "FFFFFFFFFFFFFFFFADF85458A2BB4A9AAFDC5620273D3CF1"
		...
		private const string draft_ffdhe3072_p = "FFFFFFFFFFFFFFFFADF85458A2BB4A9AAFDC5620273D3CF1"
			+ "D8B9C583CE2D3695A9E13641146433FBCC939DCE249B3EF9"
			+ "7D2FE363630C75D8F681B202AEC4617AD3DF1ED5D5FD6561"
			+ "2433F51F5F066ED0856365553DED1AF3B557135E7F57C935"
			+ "984F0C70E0E68B77E2A689DAF3EFE8721DF158A136ADE735"
		...
		private const string draft_ffdhe4096_p = "FFFFFFFFFFFFFFFFADF85458A2BB4A9AAFDC5620273D3CF1"
			+ "D8B9C583CE2D3695A9E13641146433FBCC939DCE249B3EF9"
			+ "7D2FE363630C75D8F681B202AEC4617AD3DF1ED5D5FD6561"
			+ "2433F51F5F066ED0856365553DED1AF3B557135E7F57C935"
			+ "984F0C70E0E68B77E2A689DAF3EFE8721DF158A136ADE735"
		...
		private const string draft_ffdhe6144_p = "FFFFFFFFFFFFFFFFADF85458A2BB4A9AAFDC5620273D3CF1"
			+ "D8B9C583CE2D3695A9E13641146433FBCC939DCE249B3EF9"
			+ "7D2FE363630C75D8F681B202AEC4617AD3DF1ED5D5FD6561"
			+ "2433F51F5F066ED0856365553DED1AF3B557135E7F57C935"
			+ "984F0C70E0E68B77E2A689DAF3EFE8721DF158A136ADE735"
		...
		private const string draft_ffdhe8192_p = "FFFFFFFFFFFFFFFFADF85458A2BB4A9AAFDC5620273D3CF1"
			+ "D8B9C583CE2D3695A9E13641146433FBCC939DCE249B3EF9"
			+ "7D2FE363630C75D8F681B202AEC4617AD3DF1ED5D5FD6561"
			+ "2433F51F5F066ED0856365553DED1AF3B557135E7F57C935"
			+ "984F0C70E0E68B77E2A689DAF3EFE8721DF158A136ADE735"
		...
		public static short[] getNegotiatedDHEGroupsClientExtension(Hashtable extensions)
		{
		...
		{
			return a.getP().Equals(b.getP()) && a.getG().Equals(b.getG()) && (a.getQ() == null || b.getQ() == null || a.getQ().Equals(b.getQ()));
		}
		...
		public static DHPrivateKeyParameters generateEphemeralServerKeyExchange(SecureRandom random, DHParameters dhParams, OutputStream output)
		{
			AsymmetricCipherKeyPair kp = generateDHKeyPair(random, dhParams);
		...
		public static DHParameters readDHParameters(InputStream input)
		{
		...
		public static DHParameters receiveDHParameters(TlsDHVerifier dhVerifier, InputStream input)
		{
		...
		public static void writeDHParameters(DHParameters dhParameters, OutputStream output)
		{
