...
namespace org.bouncycastle.crypto.tls
{
	...
	public class TlsECCUtils
	{
		...
		public static readonly int? EXT_ec_point_formats = Integers.valueOf(ExtensionType.ec_point_formats);

		private static readonly string[] CURVE_NAMES = new string[] {"sect163k1", "sect163r1", "sect163r2", "sect193r1", "sect193r2", "sect233k1", "sect233r1", "sect239k1", "sect283k1", "sect283r1", "sect409k1", "sect409r1", "sect571k1", "sect571r1", "secp160k1", "secp160r1", "secp160r2", "secp192k1", "secp192r1", "secp224k1", "secp224r1", "secp256k1", "secp256r1", "secp384r1", "secp521r1", "brainpoolP256r1", "brainpoolP384r1", "brainpoolP512r1"};
		...
		public static bool isCompressionPreferred(short[] ecPointFormats, short compressionFormat)
		{
		...
		public static ECPoint deserializeECPoint(short[] ecPointFormats, ECCurve curve, byte[] encoding)
		{
			...
			if (actualFormat != ECPointFormat.uncompressed && (ecPointFormats == null || !Arrays.contains(ecPointFormats, actualFormat)))
			{
				throw new TlsFatalAlert(AlertDescription.illegal_parameter);
			}
		...
		internal static ECPrivateKeyParameters generateEphemeralServerKeyExchange(SecureRandom random, int[] namedCurves, short[] ecPointFormats, OutputStream output)
		{
		...
		public static ECDomainParameters readECParameters(int[] namedCurves, short[] ecPointFormats, InputStream input)
		{
			try
			{
				...
				case ECCurveType.explicit_char2:
				{
					...
					ECCurve curve = (basis == ECBasisType.ec_basis_pentanomial) ? new ECCurve.F2m(m, k1, k2, k3, a, b, order, cofactor) : new ECCurve.F2m(m, k1, a, b, order, cofactor);
		...
		public static void writeECFieldElement(ECFieldElement x, OutputStream output)
		{
		...
		public static void writeECPoint(short[] ecPointFormats, ECPoint point, OutputStream output)
		{
