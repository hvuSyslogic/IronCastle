...
namespace org.bouncycastle.crypto.tls
{
	...
	public class TlsExtensionsUtils
	{
		...
		public static readonly int? EXT_extended_master_secret = Integers.valueOf(ExtensionType.extended_master_secret);
		public static readonly int? EXT_heartbeat = Integers.valueOf(ExtensionType.heartbeat);
		public static readonly int? EXT_max_fragment_length = Integers.valueOf(ExtensionType.max_fragment_length);
		public static readonly int? EXT_padding = Integers.valueOf(ExtensionType.padding);
		public static readonly int? EXT_server_name = Integers.valueOf(ExtensionType.server_name);
		public static readonly int? EXT_status_request = Integers.valueOf(ExtensionType.status_request);
		public static readonly int? EXT_truncated_hmac = Integers.valueOf(ExtensionType.truncated_hmac);
		...
		public static bool hasEncryptThenMACExtension(Hashtable extensions)
		{
		...
		public static bool hasExtendedMasterSecretExtension(Hashtable extensions)
		{
		...
		public static bool hasTruncatedHMacExtension(Hashtable extensions)
		{
