...
namespace org.bouncycastle.crypto.tls
{
	...
	public class DefaultTlsCipherFactory : AbstractTlsCipherFactory
	{
		...
		public virtual TlsBlockCipher createAESCipher(TlsContext context, int cipherKeySize, int macAlgorithm)
		{
		...
		public virtual TlsBlockCipher createCamelliaCipher(TlsContext context, int cipherKeySize, int macAlgorithm)
		{
		...
		public virtual TlsCipher createChaCha20Poly1305(TlsContext context)
		{
			return new Chacha20Poly1305(context);
		}

		public virtual TlsAEADCipher createCipher_AES_CCM(TlsContext context, int cipherKeySize, int macSize)
		{
			return new TlsAEADCipher(context, createAEADBlockCipher_AES_CCM(), createAEADBlockCipher_AES_CCM(), cipherKeySize, macSize);
		}

		public virtual TlsAEADCipher createCipher_AES_GCM(TlsContext context, int cipherKeySize, int macSize)
		{
			return new TlsAEADCipher(context, createAEADBlockCipher_AES_GCM(), createAEADBlockCipher_AES_GCM(), cipherKeySize, macSize);
		}

		public virtual TlsAEADCipher createCipher_AES_OCB(TlsContext context, int cipherKeySize, int macSize)
		{
			return new TlsAEADCipher(context, createAEADBlockCipher_AES_OCB(), createAEADBlockCipher_AES_OCB(), cipherKeySize, macSize, TlsAEADCipher.NONCE_DRAFT_CHACHA20_POLY1305);
		}

		public virtual TlsAEADCipher createCipher_Camellia_GCM(TlsContext context, int cipherKeySize, int macSize)
		{
		...
		public virtual TlsBlockCipher createDESedeCipher(TlsContext context, int macAlgorithm)
		{
		...
		public virtual TlsNullCipher createNullCipher(TlsContext context, int macAlgorithm)
		{
			return new TlsNullCipher(context, createHMACDigest(macAlgorithm), createHMACDigest(macAlgorithm));
		}

		public virtual TlsStreamCipher createRC4Cipher(TlsContext context, int cipherKeySize, int macAlgorithm)
		{
		...
		public virtual TlsBlockCipher createSEEDCipher(TlsContext context, int macAlgorithm)
		{
		...
		public virtual BlockCipher createCamelliaEngine()
		{
			return new CamelliaEngine();
		}

		public virtual BlockCipher createAESBlockCipher()
		{
			return new CBCBlockCipher(createAESEngine());
		}

		public virtual AEADBlockCipher createAEADBlockCipher_AES_CCM()
		{
			return new CCMBlockCipher(createAESEngine());
		}

		public virtual AEADBlockCipher createAEADBlockCipher_AES_GCM()
		{
			// TODO Consider allowing custom configuration of multiplier
			return new GCMBlockCipher(createAESEngine());
		}

		public virtual AEADBlockCipher createAEADBlockCipher_AES_OCB()
		{
			return new OCBBlockCipher(createAESEngine(), createAESEngine());
		}

		public virtual AEADBlockCipher createAEADBlockCipher_Camellia_GCM()
		{
			// TODO Consider allowing custom configuration of multiplier
			return new GCMBlockCipher(createCamelliaEngine());
		}

		public virtual BlockCipher createCamelliaBlockCipher()
		{
			return new CBCBlockCipher(createCamelliaEngine());
		}

		public virtual BlockCipher createDESedeBlockCipher()
		{
			return new CBCBlockCipher(new DESedeEngine());
		}

		public virtual StreamCipher createRC4StreamCipher()
		{
			return new RC4Engine();
		}

		public virtual BlockCipher createSEEDBlockCipher()
		{
			return new CBCBlockCipher(new SEEDEngine());
		}

		public virtual Digest createHMACDigest(int macAlgorithm)
		{
			switch (macAlgorithm)
			{
