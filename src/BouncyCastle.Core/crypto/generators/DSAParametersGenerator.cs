...
namespace org.bouncycastle.crypto.generators
{
	...
	public class DSAParametersGenerator
	{
		...
		/// </summary>
		/// <param name="size"> size of the key (range 2^512 -&gt; 2^1024 - 64 bit increments) </param>
		/// <param name="certainty"> measure of robustness of prime (for FIPS 186-2 compliance this should be at least 80). </param>
		...
		/// </para>
		/// </summary>
		/// <param name="params">  DSA 2 key generation parameters. </param>
		public virtual void init(DSAParameterGenerationParameters @params)
		{
		...
		/// </para>
		/// </summary>
		/// <returns> a generated DSA parameters object. </returns>
		...
		private DSAParameters generateParameters_FIPS186_2()
		{
			...
			for (;;)
			{
				...
				JavaSystem.arraycopy(seed, 0, part2, 0, seed.Length);
				inc(part2);
	...
	// 12. Go to step 5.
		...
		private bool isProbablePrime(BigInteger x)
		{
			/*
	...
	// A.2.3 Verifiable Canonical Generation of the Generator g
			...
			JavaSystem.arraycopy(seed, 0, U, 0, seed.Length);
			JavaSystem.arraycopy(ggen, 0, U, seed.Length, ggen.Length);
		...
		private static void inc(byte[] buf)
		{
			...
			{
				byte b = unchecked((byte)((buf[i] + 1) & 0xff));
				buf[i] = b;
