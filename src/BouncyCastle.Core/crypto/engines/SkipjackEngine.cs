...
namespace org.bouncycastle.crypto.engines
{
	...
	public class SkipjackEngine : BlockCipher
	{
		...
		public virtual void init(bool encrypting, CipherParameters @params)
		{
			...
			{
			throw new IllegalArgumentException("invalid parameter passed to SKIPJACK init - " + @params.GetType().getName());
			}
