...
namespace org.bouncycastle.crypto.engines
{
	...
	/// </para>
	/// </summary>
	public class ThreefishEngine : BlockCipher
	{
		/// <summary>
		...
		private static readonly int TWEAK_SIZE_WORDS = TWEAK_SIZE_BYTES / 8;
		...
		/// </summary>
		private const long C_240 = 0x1BD11BDAA9FC1A22L;
...
//ORIGINAL LINE: public ThreefishEngine(final int blocksizeBits)
		...
		/// </summary>
		/// <param name="params"> an instance of <seealso cref="TweakableBlockCipherParameters"/>, or <seealso cref="KeyParameter"/> (to
		///               use a 0 tweak) </param>
...
//ORIGINAL LINE: final byte[] tweakBytes;
			...
			{
				throw new IllegalArgumentException("Invalid parameter passed to Threefish init - " + @params.GetType().getName());
			}
...
//ORIGINAL LINE: public void init(boolean forEncryption, final long[] key, final long[] tweak)
		...
		private void setKey(long[] key)
		{
			...
			JavaSystem.arraycopy(kw, 0, kw, blocksizeWords + 1, blocksizeWords);
		}
		...
		/// </summary>
		/// <param name="in">  a block sized buffer of words to process. </param>
		/// <param name="out"> a block sized buffer of words to receive the output of the operation. </param>
		...
		/// <exception cref="IllegalStateException"> if this engine is not initialised. </exception>
		public virtual int processBlock(long[] @in, long[] @out)
		{
...
//ORIGINAL LINE: public static void wordToBytes(final long word, final byte[] bytes, final int off)
		...
		internal static long rotlXor(long x, int n, long xor)
		{
			return ((x << n) | ((long)((ulong)x >> -n))) ^ xor;
		}
		...
		/// </summary>
		// Package protected for efficient access from inner class
		internal static long xorRotr(long x, int n, long xor)
		{
			long xored = x ^ xor;
			return ((long)((ulong)xored >> n)) | (xored << -n);
		}

		public abstract class ThreefishCipher
		{
			/// <summary>
			/// The extended + repeated tweak words
			/// </summary>
			protected internal readonly long[] t;
			/// <summary>
...
//ORIGINAL LINE: protected ThreefishCipher(final long[] kw, final long[] t)
			...
			public abstract void encryptBlock(long[] block, long[] @out);

			public abstract void decryptBlock(long[] block, long[] @out);

		}

		public sealed class Threefish256Cipher : ThreefishCipher
		{
			/// <summary>
			/// Mix rotation constants defined in Skein 1.3 specification
			/// </summary>
			internal const int ROTATION_0_0 = 14, ROTATION_0_1 = 16;
			internal const int ROTATION_1_0 = 52, ROTATION_1_1 = 57;
			internal const int ROTATION_2_0 = 23, ROTATION_2_1 = 40;
			internal const int ROTATION_3_0 = 5, ROTATION_3_1 = 37;

			internal const int ROTATION_4_0 = 25, ROTATION_4_1 = 33;
			internal const int ROTATION_5_0 = 46, ROTATION_5_1 = 12;
			internal const int ROTATION_6_0 = 58, ROTATION_6_1 = 22;
			internal const int ROTATION_7_0 = 32, ROTATION_7_1 = 32;

			public Threefish256Cipher(long[] kw, long[] t) : base(kw, t)
			{
			}
...
//ORIGINAL LINE: final int dm3 = mod3[d];
		...
		public sealed class Threefish512Cipher : ThreefishCipher
		{
			/// <summary>
			/// Mix rotation constants defined in Skein 1.3 specification
			/// </summary>
			internal const int ROTATION_0_0 = 46, ROTATION_0_1 = 36, ROTATION_0_2 = 19, ROTATION_0_3 = 37;
			internal const int ROTATION_1_0 = 33, ROTATION_1_1 = 27, ROTATION_1_2 = 14, ROTATION_1_3 = 42;
			internal const int ROTATION_2_0 = 17, ROTATION_2_1 = 49, ROTATION_2_2 = 36, ROTATION_2_3 = 39;
			internal const int ROTATION_3_0 = 44, ROTATION_3_1 = 9, ROTATION_3_2 = 54, ROTATION_3_3 = 56;

			internal const int ROTATION_4_0 = 39, ROTATION_4_1 = 30, ROTATION_4_2 = 34, ROTATION_4_3 = 24;
			internal const int ROTATION_5_0 = 13, ROTATION_5_1 = 50, ROTATION_5_2 = 10, ROTATION_5_3 = 17;
			internal const int ROTATION_6_0 = 25, ROTATION_6_1 = 29, ROTATION_6_2 = 39, ROTATION_6_3 = 43;
			internal const int ROTATION_7_0 = 8, ROTATION_7_1 = 35, ROTATION_7_2 = 56, ROTATION_7_3 = 22;

			public Threefish512Cipher(long[] kw, long[] t) : base(kw, t)
			{
			}
...
//ORIGINAL LINE: final int dm3 = mod3[d];
		...
		public sealed class Threefish1024Cipher : ThreefishCipher
		{
			/// <summary>
			/// Mix rotation constants defined in Skein 1.3 specification
			/// </summary>
			internal const int ROTATION_0_0 = 24, ROTATION_0_1 = 13, ROTATION_0_2 = 8, ROTATION_0_3 = 47;
			internal const int ROTATION_0_4 = 8, ROTATION_0_5 = 17, ROTATION_0_6 = 22, ROTATION_0_7 = 37;
			internal const int ROTATION_1_0 = 38, ROTATION_1_1 = 19, ROTATION_1_2 = 10, ROTATION_1_3 = 55;
			internal const int ROTATION_1_4 = 49, ROTATION_1_5 = 18, ROTATION_1_6 = 23, ROTATION_1_7 = 52;
			internal const int ROTATION_2_0 = 33, ROTATION_2_1 = 4, ROTATION_2_2 = 51, ROTATION_2_3 = 13;
			internal const int ROTATION_2_4 = 34, ROTATION_2_5 = 41, ROTATION_2_6 = 59, ROTATION_2_7 = 17;
			internal const int ROTATION_3_0 = 5, ROTATION_3_1 = 20, ROTATION_3_2 = 48, ROTATION_3_3 = 41;
			internal const int ROTATION_3_4 = 47, ROTATION_3_5 = 28, ROTATION_3_6 = 16, ROTATION_3_7 = 25;

			internal const int ROTATION_4_0 = 41, ROTATION_4_1 = 9, ROTATION_4_2 = 37, ROTATION_4_3 = 31;
			internal const int ROTATION_4_4 = 12, ROTATION_4_5 = 47, ROTATION_4_6 = 44, ROTATION_4_7 = 30;
			internal const int ROTATION_5_0 = 16, ROTATION_5_1 = 34, ROTATION_5_2 = 56, ROTATION_5_3 = 51;
			internal const int ROTATION_5_4 = 4, ROTATION_5_5 = 53, ROTATION_5_6 = 42, ROTATION_5_7 = 41;
			internal const int ROTATION_6_0 = 31, ROTATION_6_1 = 44, ROTATION_6_2 = 47, ROTATION_6_3 = 46;
			internal const int ROTATION_6_4 = 19, ROTATION_6_5 = 42, ROTATION_6_6 = 44, ROTATION_6_7 = 25;
			internal const int ROTATION_7_0 = 9, ROTATION_7_1 = 48, ROTATION_7_2 = 35, ROTATION_7_3 = 52;
			internal const int ROTATION_7_4 = 23, ROTATION_7_5 = 31, ROTATION_7_6 = 37, ROTATION_7_7 = 20;

			public Threefish1024Cipher(long[] kw, long[] t) : base(kw, t)
			{
			}
