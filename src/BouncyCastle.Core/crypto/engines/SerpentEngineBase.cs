...
namespace org.bouncycastle.crypto.engines
{
	...
	public abstract class SerpentEngineBase : BlockCipher
	{
		...
		protected internal bool encrypting;
		protected internal int[] wKey;

		protected internal int X0, X1, X2, X3; // registers
		...
		protected internal static int rotateLeft(int x, int bits)
		{
			return (x << bits) | ((int)((uint)x >> -bits));
		}

		protected internal static int rotateRight(int x, int bits)
		{
		...
		/// </summary>
		public void sb0(int a, int b, int c, int d)
		{
			int t1 = a ^ d;
			int t3 = c ^ t1;
			int t4 = b ^ t3;
		...
		/// </summary>
		public void ib0(int a, int b, int c, int d)
		{
			int t1 = ~a;
			int t2 = a ^ b;
			int t4 = d ^ (t1 | t2);
		...
		/// </summary>
		public void sb1(int a, int b, int c, int d)
		{
			int t2 = b ^ (~a);
			int t5 = c ^ (a | t2);
			X2 = d ^ t5;
		...
		/// </summary>
		public void ib1(int a, int b, int c, int d)
		{
			int t1 = b ^ d;
			int t3 = a ^ (b & t1);
			int t4 = t1 ^ t3;
		...
		/// </summary>
		public void sb2(int a, int b, int c, int d)
		{
			int t1 = ~a;
			int t2 = b ^ d;
			int t3 = c & t1;
		...
		/// </summary>
		public void ib2(int a, int b, int c, int d)
		{
			int t1 = b ^ d;
			int t2 = ~t1;
			int t3 = a ^ c;
		...
		/// </summary>
		public void sb3(int a, int b, int c, int d)
		{
			int t1 = a ^ b;
			int t2 = a & c;
			int t3 = a | d;
		...
		/// </summary>
		public void ib3(int a, int b, int c, int d)
		{
			int t1 = a | b;
			int t2 = b ^ c;
			int t3 = b & t2;
		...
		/// </summary>
		public void sb4(int a, int b, int c, int d)
		{
			int t1 = a ^ d;
			int t2 = d & t1;
			int t3 = c ^ t2;
		...
		/// </summary>
		public void ib4(int a, int b, int c, int d)
		{
			int t1 = c | d;
			int t2 = a & t1;
			int t3 = b ^ t2;
		...
		/// </summary>
		public void sb5(int a, int b, int c, int d)
		{
			int t1 = ~a;
			int t2 = a ^ b;
			int t3 = a ^ d;
		...
		/// </summary>
		public void ib5(int a, int b, int c, int d)
		{
			int t1 = ~c;
			int t2 = b & t1;
			int t3 = d ^ t2;
		...
		/// </summary>
		public void sb6(int a, int b, int c, int d)
		{
			int t1 = ~a;
			int t2 = a ^ d;
			int t3 = b ^ t2;
		...
		/// </summary>
		public void ib6(int a, int b, int c, int d)
		{
			int t1 = ~a;
			int t2 = a ^ b;
			int t3 = c ^ t2;
		...
		/// </summary>
		public void sb7(int a, int b, int c, int d)
		{
			int t1 = b ^ c;
			int t2 = c & t1;
			int t3 = d ^ t2;
		...
		/// </summary>
		public void ib7(int a, int b, int c, int d)
		{
			int t3 = c | (a & b);
			int t4 = d & (a | b);
			X3 = t3 ^ t4;
		...
		public abstract int[] makeWorkingKey(byte[] key);

		public abstract void encryptBlock(byte[] input, int inOff, byte[] output, int outOff);

		public abstract void decryptBlock(byte[] input, int inOff, byte[] output, int outOff);
	}
