...
namespace org.bouncycastle.crypto.engines
{
	...
	/// An RC6 engine.
	/// </summary>
	public class RC6Engine : BlockCipher
	{
		...
		public virtual void init(bool forEncryption, CipherParameters @params)
		{
			...
			{
				throw new IllegalArgumentException("invalid parameter passed to RC6 init - " + @params.GetType().getName());
			}
