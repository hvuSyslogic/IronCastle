...
namespace org.bouncycastle.crypto.engines
{
	...
	/// </para>
	/// </summary>
	public class RC532Engine : BlockCipher
	{
		/*
		...
		public virtual void init(bool forEncryption, CipherParameters @params)
		{
			...
			{
				throw new IllegalArgumentException("invalid parameter passed to RC532 init - " + @params.GetType().getName());
			}
		...
		/// <param name="y">    number of bits to rotate % 32 </param>
		private int rotateLeft(int x, int y)
		{
			return ((x << (y & (32 - 1))) | ((int)((uint)x >> (32 - (y & (32 - 1))))));
		}
		...
		{
			return (((int)((uint)x >> (y & (32 - 1)))) | (x << (32 - (y & (32 - 1)))));
		}
