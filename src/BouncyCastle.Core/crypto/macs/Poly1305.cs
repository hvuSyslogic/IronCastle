...
namespace org.bouncycastle.crypto.macs
{
	...
	public class Poly1305 : Mac
	{
		...
		/// <summary>
		/// Polynomial key </summary>
		private int r0, r1, r2, r3, r4;

		/// <summary>
		/// Precomputed 5 * r[1..4] </summary>
		...
		/// <summary>
		/// Polynomial accumulator </summary>
		...
		private void setKey(byte[] key, byte[] nonce)
		{
			...
			r0 = t0 & 0x03FFFFFF;
			r1 = (((int)((uint)t0 >> 26)) | (t1 << 6)) & 0x03FFFF03;
			r2 = (((int)((uint)t1 >> 20)) | (t2 << 12)) & 0x03FFC0FF;
			r3 = (((int)((uint)t2 >> 14)) | (t3 << 18)) & 0x03F03FFF;
			r4 = ((int)((uint)t3 >> 8)) & 0x000FFFFF;
		...
		private void processBlock()
		{
			...
			h0 += (int)(t0 & 0x3ffffff);
			h1 += (int)(((long)((ulong)((t1 << 32) | t0) >> 26)) & 0x3ffffff);
			h2 += (int)(((long)((ulong)((t2 << 32) | t1) >> 20)) & 0x3ffffff);
			h3 += (int)(((long)((ulong)((t3 << 32) | t2) >> 14)) & 0x3ffffff);
			h4 += (int)((long)((ulong)t3 >> 8));
			...
			tp1 += ((long)((ulong)tp0 >> 26));
			h1 = (int)tp1 & 0x3ffffff;
			tp2 += ((long)((ulong)tp1 >> 26));
			h2 = (int)tp2 & 0x3ffffff;
			tp3 += ((long)((ulong)tp2 >> 26));
			h3 = (int)tp3 & 0x3ffffff;
			tp4 += ((long)((ulong)tp3 >> 26));
			h4 = (int)tp4 & 0x3ffffff;
			h0 += (int)((long)((ulong)tp4 >> 26)) * 5;
			h1 += ((int)((uint)h0 >> 26));
			h0 &= 0x3ffffff;
		}
		...
		public virtual int doFinal(byte[] @out, int outOff)
		{
			...
			f1 = ((((int)((uint)h1 >> 6)) | (h2 << 20)) & 0xffffffffl) + (0xffffffffL & k1);
			f2 = ((((int)((uint)h2 >> 12)) | (h3 << 14)) & 0xffffffffl) + (0xffffffffL & k2);
			f3 = ((((int)((uint)h3 >> 18)) | (h4 << 8)) & 0xffffffffl) + (0xffffffffL & k3);
