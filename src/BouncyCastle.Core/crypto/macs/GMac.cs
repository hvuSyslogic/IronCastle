...
//ORIGINAL LINE: public GMac(final org.bouncycastle.crypto.modes.GCMBlockCipher cipher)
		...
		///            the cipher to be used in GCM mode to generate the MAC. </param>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not available in .NET:
//ORIGINAL LINE: public GMac(final org.bouncycastle.crypto.modes.GCMBlockCipher cipher, final int macSizeBits)
