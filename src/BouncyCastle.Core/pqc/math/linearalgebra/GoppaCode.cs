...
namespace org.bouncycastle.pqc.math.linearalgebra
{
	...
	/// <seealso cref= PolynomialGF2mSmallM </seealso>
	public sealed class GoppaCode
	{
		...
		/// </summary>
		/// <seealso cref= GF2Matrix </seealso>
		/// <seealso cref= Permutation </seealso>
		public class MaMaPe
		{
			...
			public virtual GF2Matrix getFirstMatrix()
			{
				return s;
			}

			/// <returns> the second matrix </returns>
			public virtual GF2Matrix getSecondMatrix()
			{
				return h;
			}

			/// <returns> the permutation </returns>
			public virtual Permutation getPermutation()
			{
				return p;
			}
		}
		...
		public class MatrixSet
		{
			...
			/// <param name="setJ"> the set of indices such that the submatrix of the
			///             generator matrix consisting of the specified columns
			///             is the identity </param>
			...
			/// <returns> the set of indices such that the submatrix of the generator
			///         matrix consisting of the specified columns is the identity </returns>
			public virtual int[] getSetJ()
			{
				return setJ;
			}
		}
		...
		/// <param name="field">        the finite field </param>
		/// <param name="gp">           the irreducible Goppa polynomial </param>
		/// <param name="sqRootMatrix"> the matrix for computing square roots in
