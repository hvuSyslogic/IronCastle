...
namespace org.bouncycastle.pqc.math.ntru.polynomial
{
	...
	/// </summary>
	public class IntegerPolynomial : Polynomial
	{
		...
		public virtual byte[] toBinary3Sves()
		{
		...
		/// </summary>
		/// <returns> the encoded polynomial </returns>
		public virtual byte[] toBinary3Tight()
		{
		...
		/// <param name="q"> </param>
		/// <returns> the encoded polynomial </returns>
		public virtual byte[] toBinary(int q)
		{
		...
		/// </summary>
		public virtual void modCenter(int modulus)
		{
			mod(modulus);
		...
		/// </summary>
		/// <param name="q"> a modulus </param>
		public virtual void shiftGap(int q)
		{
			modCenter(q);
