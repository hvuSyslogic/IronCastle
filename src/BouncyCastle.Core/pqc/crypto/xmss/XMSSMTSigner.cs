...
namespace org.bouncycastle.pqc.crypto.xmss
{
	...
	/// </summary>
	public class XMSSMTSigner : StateAwareMessageSigner
	{
...
//ORIGINAL LINE: final int xmssHeight = xmssParams.getHeight();
			...
			byte[] concatenated = Arrays.concatenate(random, privateKey.getRoot(), XMSSUtil.toBytesBigEndian(globalIndex, @params.getDigestSize()));
