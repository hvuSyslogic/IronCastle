...
namespace org.bouncycastle.pqc.crypto.xmss
{
	...
	/// XMSS^MT Public Key.
	/// </summary>
	public sealed class XMSSMTPublicKeyParameters : AsymmetricKeyParameter, XMSSStoreableObjectInterface
	{
		...
		private XMSSMTPublicKeyParameters(Builder builder) : base(false)
		{
		...
		public class Builder
		{
			...
			public virtual XMSSMTPublicKeyParameters build()
			{
