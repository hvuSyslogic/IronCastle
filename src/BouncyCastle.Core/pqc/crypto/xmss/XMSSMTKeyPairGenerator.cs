...
namespace org.bouncycastle.pqc.crypto.xmss
{
	...
	/// </summary>
	public sealed class XMSSMTKeyPairGenerator
	{
		...
		public AsymmetricCipherKeyPair generateKeyPair()
		{
			...
			OTSHashAddress otsHashAddress = (OTSHashAddress)(new OTSHashAddress.Builder()).withLayerAddress(rootLayerIndex).build();
			...
			publicKey = (new XMSSMTPublicKeyParameters.Builder(@params)).withRoot(root.getValue()).withPublicSeed(privateKey.getPublicSeed()).build();
