...
namespace org.bouncycastle.pqc.crypto.qtesla
{
	...
	public class Sample
	{
		...
		/// <param name="seed">                        Kappa-Bit Seed </param>
		/// <param name="seedOffset">                    Starting Point of the Kappa-Bit Seed </param>
		/// <param name="nonce">                        Domain Separator for Error Polynomial and Secret Polynomial
		/// </param>
		/// <returns> none
		/// ********************************************************************************************************************* </returns>
		public static void polynomialGaussSamplerI(int[] data, int dataOffset, byte[] seed, int seedOffset, int nonce)
		{
			...
			byte[] seedExpander = new byte[Parameter.N_I * (sizeof(long) * 8) / Byte.SIZE];
			...
			HashUtils.customizableSecureHashAlgorithmKECCAK128Simple(seedExpander, 0, Parameter.N_I * (sizeof(long) * 8) / Byte.SIZE, domainSeparator++, seed, seedOffset, Polynomial.RANDOM);
			...
			for (index = 0; index < Parameter.N_I; index++)
			{
				...
				do
				{
					...
					randomBit = CommonFunction.load64(seedExpander, (j++) * (sizeof(long) * 8) / Byte.SIZE);
					bitRemained = 64;
					...
					do
					{
						...
						do
						{
							...
							r = CommonFunction.load64(seedExpander, (j++) * (sizeof(long) * 8) / Byte.SIZE);
							s = CommonFunction.load64(seedExpander, (j++) * (sizeof(long) * 8) / Byte.SIZE);
						...
						buffer = CommonFunction.load64(seedExpander, (j++) * (sizeof(long) * 8) / Byte.SIZE);
		...
		public static void polynomialGaussSamplerIP(long[] data, int dataOffset, byte[] seed, int seedOffset, int nonce)
		{
			...
			byte[] seedExpander = new byte[Parameter.N_I_P * (sizeof(long) * 8) / Byte.SIZE];
			short domainSeparator = (short)(nonce << 8);
			int index;
			int j = 0;
			long k;
			...
			HashUtils.customizableSecureHashAlgorithmKECCAK128Simple(seedExpander, 0, Parameter.N_I_P * (sizeof(long) * 8) / Byte.SIZE, domainSeparator++, seed, seedOffset, Polynomial.RANDOM);
		...
		/// <param name="n">                            Polynomial Degree </param>
		/// <param name="xi"> </param>
		/// <param name="exponentialDistribution">        Exponential Distribution Table
		/// </param>
		/// <returns> none
		/// ****************************************************************************************************************************************************************************** </returns>
		public static void polynomialGaussSamplerIII(int[] data, int dataOffset, byte[] seed, int seedOffset, int nonce, int n, double xi, double[][] exponentialDistribution)
		{
			...
			byte[] seedExpander = new byte[n * (sizeof(long) * 8) / Byte.SIZE];
			short domainSeparator = (short)(nonce << 8);
			int index;
			int j = 0;
			long k;
			...
			HashUtils.customizableSecureHashAlgorithmKECCAK256Simple(seedExpander, 0, n * (sizeof(long) * 8) / Byte.SIZE, domainSeparator++, seed, seedOffset, Polynomial.RANDOM);
				...
				do
				{
					...
					do
					{
						...
						do
						{
							...
							r = CommonFunction.load64(seedExpander, (j++) * (sizeof(long) * 8) / Byte.SIZE);
							s = CommonFunction.load64(seedExpander, (j++) * (sizeof(long) * 8) / Byte.SIZE);
							t = CommonFunction.load64(seedExpander, (j++) * (sizeof(long) * 8) / Byte.SIZE);
		...
		public static void polynomialGaussSamplerIIIP(long[] data, int dataOffset, byte[] seed, int seedOffset, int nonce)
		{
			...
			byte[] seedExpander = new byte[Parameter.N_III_P * (sizeof(long) * 8) / Byte.SIZE];
			short domainSeparator = (short)(nonce << 8);
			int index;
			int j = 0;
			long k;
			...
			HashUtils.customizableSecureHashAlgorithmKECCAK256Simple(seedExpander, 0, Parameter.N_III_P * (sizeof(long) * 8) / Byte.SIZE, domainSeparator++, seed, seedOffset, Polynomial.RANDOM);
