namespace org.bouncycastle.pqc.crypto.rainbow.util
{
	...
	public class GF2Field
	{
		...
		/// <returns> the sum of the two elements x and y in GF2^8 </returns>
		...
		/// <returns> the multiplicative inverse of the given element, in case it
		///         exists or 0, otherwise </returns>
		...
		/// <returns> the product of the two input elements in GF2^8. </returns>
		...
		/// <returns> exps-value, corresponding to the input </returns>
		...
		/// <returns> logs-value, corresponding to the input </returns>
