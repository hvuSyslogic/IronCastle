...
{
	public class RainbowPrivateKeyParameters : RainbowKeyParameters
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		public RainbowPrivateKeyParameters(short[][] A1inv, short[] b1, short[][] A2inv, short[] b2, int[] vi, Layer[] layers) : base(true, vi[vi.Length - 1] - vi[0])
		{
