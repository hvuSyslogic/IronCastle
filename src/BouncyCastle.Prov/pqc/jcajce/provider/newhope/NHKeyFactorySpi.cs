...
namespace org.bouncycastle.pqc.jcajce.provider.newhope
{
	...
	public class NHKeyFactorySpi : KeyFactorySpi, AsymmetricKeyInfoConverter
	{
		...
		{
			if (key is BCNHPrivateKey || key is BCNHPublicKey)
			{
				return key;
			}
