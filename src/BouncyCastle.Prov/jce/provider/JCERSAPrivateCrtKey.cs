...
namespace org.bouncycastle.jce.provider
{
	...
	/// </summary>
	public class JCERSAPrivateCrtKey : JCERSAPrivateKey, RSAPrivateCrtKey
	{
		...
		public JCERSAPrivateCrtKey(RSAPrivateCrtKeyParameters key) : base(key)
		{
		...
		public JCERSAPrivateCrtKey(RSAPrivateCrtKeySpec spec)
		{
		...
		public JCERSAPrivateCrtKey(RSAPrivateCrtKey key)
		{
		...
		/// </summary>
		public JCERSAPrivateCrtKey(PrivateKeyInfo info) : this(RSAPrivateKey.getInstance(info.parsePrivateKey()))
		{
		}
		...
		/// </summary>
		public JCERSAPrivateCrtKey(RSAPrivateKey key)
		{
			this.modulus = key.getModulus();
			this.publicExponent = key.getPublicExponent();
			this.privateExponent = key.getPrivateExponent();
