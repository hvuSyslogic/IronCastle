...
namespace org.bouncycastle.jcajce.provider.asymmetric
{
	...
	using DSAUtil = org.bouncycastle.jcajce.provider.asymmetric.dsa.DSAUtil;
	using KeyFactorySpi = org.bouncycastle.jcajce.provider.asymmetric.dsa.KeyFactorySpi;
	...
	public class DSA
	{
		private const string PREFIX = "org.bouncycastle.jcajce.provider.asymmetric" + ".dsa.";
		...
		public class Mappings : AsymmetricAlgorithmProvider
		{
			...
			public override void configure(ConfigurableProvider provider)
			{
				...
				addSignatureAlgorithm(provider, "SHA224", "DSA", PREFIX + "DSASigner$dsa224", NISTObjectIdentifiers_Fields.dsa_with_sha224);
				addSignatureAlgorithm(provider, "SHA256", "DSA", PREFIX + "DSASigner$dsa256", NISTObjectIdentifiers_Fields.dsa_with_sha256);
				addSignatureAlgorithm(provider, "SHA384", "DSA", PREFIX + "DSASigner$dsa384", NISTObjectIdentifiers_Fields.dsa_with_sha384);
				addSignatureAlgorithm(provider, "SHA512", "DSA", PREFIX + "DSASigner$dsa512", NISTObjectIdentifiers_Fields.dsa_with_sha512);

				addSignatureAlgorithm(provider, "SHA3-224", "DSA", PREFIX + "DSASigner$dsaSha3_224", NISTObjectIdentifiers_Fields.id_dsa_with_sha3_224);
				addSignatureAlgorithm(provider, "SHA3-256", "DSA", PREFIX + "DSASigner$dsaSha3_256", NISTObjectIdentifiers_Fields.id_dsa_with_sha3_256);
				addSignatureAlgorithm(provider, "SHA3-384", "DSA", PREFIX + "DSASigner$dsaSha3_384", NISTObjectIdentifiers_Fields.id_dsa_with_sha3_384);
				addSignatureAlgorithm(provider, "SHA3-512", "DSA", PREFIX + "DSASigner$dsaSha3_512", NISTObjectIdentifiers_Fields.id_dsa_with_sha3_512);
