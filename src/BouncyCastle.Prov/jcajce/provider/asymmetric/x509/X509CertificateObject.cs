...
namespace org.bouncycastle.jcajce.provider.asymmetric.x509
{
	...
	public class X509CertificateObject : X509Certificate, PKCS12BagAttributeCarrier
	{
		...
		public X509CertificateObject(JcaJceHelper bcHelper, Certificate c)
		{
		...
		/// </summary>
		/// <returns> the pre-JDK 1.8 hashcode calculation. </returns>
		public virtual int originalHashCode()
		{
			try
			{
				int hashCode = 0;
