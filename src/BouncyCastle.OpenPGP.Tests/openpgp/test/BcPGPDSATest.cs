...
namespace org.bouncycastle.openpgp.test
{
	...
	public class BcPGPDSATest : SimpleTest
	{
		...
		public virtual void generateTest(PGPSecretKeyRing sKey, PGPPublicKey pgpPubKey, PGPPrivateKey pgpPrivKey)
		{
			...
			PGPSignatureGenerator sGen = new PGPSignatureGenerator(new BcPGPContentSignerBuilder(PublicKeyAlgorithmTags_Fields.DSA, HashAlgorithmTags_Fields.SHA1));
