...
namespace org.bouncycastle.openpgp.test
{
	...
	using BcPBEDataDecryptorFactory = org.bouncycastle.openpgp.@operator.bc.BcPBEDataDecryptorFactory;
	using BcPBEKeyEncryptionMethodGenerator = org.bouncycastle.openpgp.@operator.bc.BcPBEKeyEncryptionMethodGenerator;
	using BcPBESecretKeyDecryptorBuilder = org.bouncycastle.openpgp.@operator.bc.BcPBESecretKeyDecryptorBuilder;
	using BcPBESecretKeyEncryptorBuilder = org.bouncycastle.openpgp.@operator.bc.BcPBESecretKeyEncryptorBuilder;
	...
	public class BcPGPRSATest : SimpleTest
	{
		...
		private void mixedTest(PGPPrivateKey pgpPrivKey, PGPPublicKey pgpPubKey)
		{
			...
			PGPEncryptedDataGenerator encGen = new PGPEncryptedDataGenerator((new BcPGPDataEncryptorBuilder(SymmetricKeyAlgorithmTags_Fields.AES_128)).setWithIntegrityPacket(true).setSecureRandom(new SecureRandom()));
		...
		private void embeddedJpegTest()
		{
			...
			PGPSignatureGenerator sGen = new PGPSignatureGenerator(new BcPGPContentSignerBuilder(PublicKeyAlgorithmTags_Fields.RSA_GENERAL, HashAlgorithmTags_Fields.SHA1));
		...
		private void sigsubpacketTest()
		{
			...
			PGPKeyRingGenerator keyRingGen = new PGPKeyRingGenerator(PGPSignature.POSITIVE_CERTIFICATION, sgnKeyPair, identity, (new BcPGPDigestCalculatorProvider()).get(HashAlgorithmTags_Fields.SHA1), hashedPcks, unhashedPcks, new BcPGPContentSignerBuilder(PGPPublicKey.RSA_GENERAL, HashAlgorithmTags_Fields.SHA1), (new BcPBESecretKeyEncryptorBuilder(PGPEncryptedData.AES_256)).build(passPhrase));
		...
		public override void performTest()
		{
			...
			cPk = new PGPEncryptedDataGenerator((new BcPGPDataEncryptorBuilder(SymmetricKeyAlgorithmTags_Fields.CAST5)).setSecureRandom(new SecureRandom()));
			...
			PGPSecretKey secretKey = new PGPSecretKey(PGPSignature.DEFAULT_CERTIFICATION, new BcPGPKeyPair(PublicKeyAlgorithmTags_Fields.RSA_GENERAL, kp, DateTime.Now), "fred", null, null, new BcPGPContentSignerBuilder(PublicKeyAlgorithmTags_Fields.RSA_GENERAL, HashAlgorithmTags_Fields.SHA1), (new BcPBESecretKeyEncryptorBuilder(SymmetricKeyAlgorithmTags_Fields.CAST5)).build(passPhrase));
			...
			// use of PGPKeyPair
			//
			PGPKeyPair pgpKp = new BcPGPKeyPair(PGPPublicKey.RSA_GENERAL, kp, DateTime.Now);
			...
			secretKey = new PGPSecretKey(PGPSignature.DEFAULT_CERTIFICATION, new BcPGPKeyPair(PublicKeyAlgorithmTags_Fields.RSA_GENERAL, kp, DateTime.Now), "fred", null, null, new BcPGPContentSignerBuilder(PublicKeyAlgorithmTags_Fields.RSA_GENERAL, HashAlgorithmTags_Fields.SHA1), (new BcPBESecretKeyEncryptorBuilder(SymmetricKeyAlgorithmTags_Fields.AES_256)).build(passPhrase));
			...
			sGen = new PGPSignatureGenerator(new BcPGPContentSignerBuilder(PublicKeyAlgorithmTags_Fields.RSA_GENERAL, HashAlgorithmTags_Fields.SHA1));
