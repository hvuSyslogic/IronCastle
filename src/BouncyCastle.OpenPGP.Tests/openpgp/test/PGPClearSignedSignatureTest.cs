namespace org.bouncycastle.openpgp.test
{
	...
	public class PGPClearSignedSignatureTest : SimpleTest
	{
		...
		private void messageTest(string message, string type)
		{
		...
		private PGPSecretKey readSecretKey(InputStream @in)
		{
		...
		private void generateTest(string message, string type)
		{
			...
			messageTest(StringHelper.NewString(bOut.toByteArray()), type);
		}
