...
namespace org.bouncycastle.openpgp.test
{
	...
	using JcaPGPPublicKeyRingCollection = org.bouncycastle.openpgp.jcajce.JcaPGPPublicKeyRingCollection;
	using JcaPGPSecretKeyRingCollection = org.bouncycastle.openpgp.jcajce.JcaPGPSecretKeyRingCollection;
	...
	using JcaPGPPrivateKey = org.bouncycastle.openpgp.@operator.jcajce.JcaPGPPrivateKey;
	...
	public class PGPKeyRingTest : SimpleTest
	{
		...
		public virtual void test2()
		{
			...
			while (rIt.hasNext())
			{
				...
				while (it.hasNext())
				{
					...
					if (k.getKeyID() == -4049084404703773049L || k.getKeyID() == -1413891222336124627L)
					{
						k.extractPrivateKey((new JcePBESecretKeyDecryptorBuilder()).setProvider("BC").build(sec2pass1));
					}
					else if (k.getKeyID() == -6498553574938125416L || k.getKeyID() == 59034765524361024L)
					{
		...
		public virtual void shouldStripPreserveTrustPackets()
		{
			JcaPGPPublicKeyRingCollection pubRings = new JcaPGPPublicKeyRingCollection(pub2);
		...
		public virtual void revocationTest()
		{
		...
		public virtual void generateTest()
		{
			...
			PGPKeyRingGenerator keyRingGen = new PGPKeyRingGenerator(PGPSignature.POSITIVE_CERTIFICATION, dsaKeyPair, "test", sha1Calc, null, null, new JcaPGPContentSignerBuilder(PGPPublicKey.DSA, HashAlgorithmTags_Fields.SHA1), (new JcePBESecretKeyEncryptorBuilder(PGPEncryptedData.AES_256)).setProvider("BC").build(passPhrase));
			...
			while (sIt.hasNext())
			{
				...
				if (sig.getKeyID() == vKey.getKeyID() && sig.getSignatureType() == PGPSignature.SUBKEY_BINDING)
				{
		...
		private void insertMasterTest()
		{
			...
			PGPKeyPair rsaKeyPair1 = new JcaPGPKeyPair(PGPPublicKey.RSA_GENERAL, rsaKp, DateTime.Now);
							  rsaKp = rsaKpg.generateKeyPair();
			PGPKeyPair rsaKeyPair2 = new JcaPGPKeyPair(PGPPublicKey.RSA_GENERAL, rsaKp, DateTime.Now);
			PGPDigestCalculator sha1Calc = (new JcaPGPDigestCalculatorProviderBuilder()).build().get(HashAlgorithmTags_Fields.SHA1);
			PGPKeyRingGenerator keyRingGen = new PGPKeyRingGenerator(PGPSignature.POSITIVE_CERTIFICATION, rsaKeyPair1, "test", sha1Calc, null, null, new JcaPGPContentSignerBuilder(PGPPublicKey.RSA_SIGN, HashAlgorithmTags_Fields.SHA1), (new JcePBESecretKeyEncryptorBuilder(PGPEncryptedData.AES_256)).setProvider("BC").build(passPhrase));
			PGPSecretKeyRing secRing1 = keyRingGen.generateSecretKeyRing();
			PGPPublicKeyRing pubRing1 = keyRingGen.generatePublicKeyRing();
			keyRingGen = new PGPKeyRingGenerator(PGPSignature.POSITIVE_CERTIFICATION, rsaKeyPair2, "test", sha1Calc, null, null, new JcaPGPContentSignerBuilder(PGPPublicKey.RSA_SIGN, HashAlgorithmTags_Fields.SHA1), (new JcePBESecretKeyEncryptorBuilder(PGPEncryptedData.AES_256)).setProvider("BC").build(passPhrase));
		...
		public virtual void generateSha1Test()
		{
			char[] passPhrase = "hello".ToCharArray();
			KeyPairGenerator dsaKpg = KeyPairGenerator.getInstance("DSA", "BC");
		...
		private void rewrapTest()
		{
			...
			JcaPGPSecretKeyRingCollection privRings = new JcaPGPSecretKeyRingCollection(new ByteArrayInputStream(rewrapKey));
			...
			if (rIt.hasNext())
			{
				...
				while (it.hasNext())
				{
					...
					pgpKey = PGPSecretKey.copyWithNewPassword(pgpKey, (new JcePBESecretKeyDecryptorBuilder((new JcaPGPDigestCalculatorProviderBuilder()).setProvider("BC").build())).setProvider("BC").build(rewrapPass), null);
				...
				while (it.hasNext())
				{
					...
					// re-encrypt the key with an empty password
					pgpPriv = PGPSecretKeyRing.removeSecretKey(pgpPriv, pgpKey);
					pgpKey = PGPSecretKey.copyWithNewPassword(pgpKey, null, (new JcePBESecretKeyEncryptorBuilder(SymmetricKeyAlgorithmTags_Fields.CAST5)).setProvider("BC").build(newPass));
					pgpPriv = PGPSecretKeyRing.insertSecretKey(pgpPriv, pgpKey);
		...
		{
			// Read the secret key rings
			JcaPGPSecretKeyRingCollection privRings = new JcaPGPSecretKeyRingCollection(new ByteArrayInputStream(privv3));
			char[] newPass = "fred".ToCharArray();
			...
			if (rIt.hasNext())
			{
				...
				while (it.hasNext())
				{
					...
					pgpKey = PGPSecretKey.copyWithNewPassword(pgpKey, (new JcePBESecretKeyDecryptorBuilder((new JcaPGPDigestCalculatorProviderBuilder()).setProvider("BC").build())).setProvider("BC").build(v3KeyPass), null);
					pgpPriv = PGPSecretKeyRing.insertSecretKey(pgpPriv, pgpKey);
				...
				while (it.hasNext())
				{
					...
					// re-encrypt the key with an empty password
					pgpPriv = PGPSecretKeyRing.removeSecretKey(pgpPriv, pgpKey);
					pgpKey = PGPSecretKey.copyWithNewPassword(pgpKey, null, (new JcePBESecretKeyEncryptorBuilder(SymmetricKeyAlgorithmTags_Fields.CAST5, (new JcaPGPDigestCalculatorProviderBuilder()).setProvider("BC").build().get(HashAlgorithmTags_Fields.MD5))).setProvider("BC").build(newPass));
					pgpPriv = PGPSecretKeyRing.insertSecretKey(pgpPriv, pgpKey);
		...
		private void rewrapTestMD5()
		{
			...
			if (rIt.hasNext())
			{
				...
				while (it.hasNext())
				{
					...
					// re-encrypt the key with an empty password
					pgpPriv = PGPSecretKeyRing.removeSecretKey(pgpPriv, pgpKey);
					pgpKey = PGPSecretKey.copyWithNewPassword(pgpKey, (new JcePBESecretKeyDecryptorBuilder(calcProvider)).setProvider("BC").build(rewrapPass), null);
					pgpPriv = PGPSecretKeyRing.insertSecretKey(pgpPriv, pgpKey);
				...
				while (it.hasNext())
				{
					...
					// re-encrypt the key with an empty password
					pgpPriv = PGPSecretKeyRing.removeSecretKey(pgpPriv, pgpKey);
					pgpKey = PGPSecretKey.copyWithNewPassword(pgpKey, null, (new JcePBESecretKeyEncryptorBuilder(SymmetricKeyAlgorithmTags_Fields.CAST5, calcProvider.get(HashAlgorithmTags_Fields.MD5))).setProvider("BC").build(newPass));
					pgpPriv = PGPSecretKeyRing.insertSecretKey(pgpPriv, pgpKey);
		...
		private void testUmlaut()
		{
			...
			PGPDigestCalculator sha1Calc = (new JcaPGPDigestCalculatorProviderBuilder()).build().get(HashAlgorithmTags_Fields.SHA1);
			PGPKeyRingGenerator keyRingGen = new PGPKeyRingGenerator(PGPSignature.POSITIVE_CERTIFICATION, rsaKeyPair1, userID, sha1Calc, null, null, new JcaPGPContentSignerBuilder(PGPPublicKey.RSA_SIGN, HashAlgorithmTags_Fields.SHA1), (new JcePBESecretKeyEncryptorBuilder(PGPEncryptedData.AES_256)).setProvider("BC").build(passPhrase));
		...
		private void testExpiryDate()
		{
			...
			for (Iterator it = pgpRingCollection.getKeyRings(); it.hasNext();)
			{
				...
				for (Iterator rit = pgpRing.getPublicKeys(); rit.hasNext();)
				{
					...
					else if (unchecked((long)0x89FCFA4B23363333L) == pubKey.getKeyID())
					{
		...
		public virtual void testNoExportPrivateKey()
		{
			...
			PGPPublicKey pubKey = converter.getPGPPublicKey(PGPPublicKey.RSA_GENERAL, kp.getPublic(), DateTime.Now);
		...
		{
			PGPDigestCalculator sha1Calc = (new JcaPGPDigestCalculatorProviderBuilder()).build().get(HashAlgorithmTags_Fields.SHA1);
			PGPKeyRingGenerator keyRingGen = new PGPKeyRingGenerator(PGPSignature.POSITIVE_CERTIFICATION, keyPair, "test", sha1Calc, null, null, new JcaPGPContentSignerBuilder(PGPPublicKey.RSA_SIGN, HashAlgorithmTags_Fields.SHA1), null);
		...
		public virtual void testNullEncryption()
		{
			...
			PGPDigestCalculator calculator = (new JcaPGPDigestCalculatorProviderBuilder()).setProvider(new BouncyCastleProvider()).build().get(HashAlgorithmTags_Fields.SHA1);

			PGPKeyPair pgpPair = new JcaPGPKeyPair(PGPPublicKey.RSA_GENERAL, rsaPair, DateTime.Now);

			PGPSignatureSubpacketGenerator subpackets = new PGPSignatureSubpacketGenerator();

			// Key flags
			subpackets.setKeyFlags(true, KeyFlags.CERTIFY_OTHER | KeyFlags.SIGN_DATA | KeyFlags.ENCRYPT_COMMS | KeyFlags.ENCRYPT_STORAGE | KeyFlags.AUTHENTICATION);

		   // Encryption Algorithms
		   subpackets.setPreferredSymmetricAlgorithms(true, new int[]{SymmetricKeyAlgorithmTags_Fields.AES_256, SymmetricKeyAlgorithmTags_Fields.AES_192, SymmetricKeyAlgorithmTags_Fields.AES_128, SymmetricKeyAlgorithmTags_Fields.TRIPLE_DES});

			// Hash Algorithms
			subpackets.setPreferredHashAlgorithms(true, new int[] {HashAlgorithmTags_Fields.SHA512, HashAlgorithmTags_Fields.SHA384, HashAlgorithmTags_Fields.SHA256, HashAlgorithmTags_Fields.SHA224, HashAlgorithmTags_Fields.SHA1});

			// Compression Algorithms
			subpackets.setPreferredCompressionAlgorithms(true, new int[] {CompressionAlgorithmTags_Fields.ZLIB, CompressionAlgorithmTags_Fields.BZIP2, CompressionAlgorithmTags_Fields.ZIP});

			// Modification Detection
			subpackets.setFeature(true, Features.FEATURE_MODIFICATION_DETECTION);

			PGPContentSignerBuilder signer = new JcaPGPContentSignerBuilder(pgpPair.getPublicKey().getAlgorithm(), HashAlgorithmTags_Fields.SHA256);

			PGPKeyRingGenerator ringGenerator = new PGPKeyRingGenerator(PGPSignature.POSITIVE_CERTIFICATION, pgpPair, "xmpp:juliet@capulet.lit", calculator, subpackets.generate(), null, signer, null);
			int length1 = ringGenerator.generateSecretKeyRing().getEncoded().Length;
			ringGenerator = new PGPKeyRingGenerator(PGPSignature.POSITIVE_CERTIFICATION, pgpPair, "xmpp:juliet@capulet.lit", null, subpackets.generate(), null, signer, null);
		...
		{
			ArmoredInputStream aIn = new ArmoredInputStream(this.GetType().getResourceAsStream("eddsa-pub-keyring.asc"));
		...
		public virtual void testShouldProduceSubkeys()
		{
			...
			PGPKeyPair pgpMasterKey = new JcaPGPKeyPair(PublicKeyAlgorithmTags_Fields.ECDSA, pair, DateTime.Now);

			PGPSignatureSubpacketGenerator subPackets = new PGPSignatureSubpacketGenerator();
			subPackets.setKeyFlags(false, KeyFlags.AUTHENTICATION & KeyFlags.CERTIFY_OTHER & KeyFlags.SIGN_DATA);
			subPackets.setPreferredSymmetricAlgorithms(false, new int[]{SymmetricKeyAlgorithmTags_Fields.AES_256, SymmetricKeyAlgorithmTags_Fields.AES_192, SymmetricKeyAlgorithmTags_Fields.AES_128});
			subPackets.setPreferredHashAlgorithms(false, new int[]{HashAlgorithmTags_Fields.SHA512, HashAlgorithmTags_Fields.SHA384, HashAlgorithmTags_Fields.SHA256, HashAlgorithmTags_Fields.SHA224});
			subPackets.setPreferredCompressionAlgorithms(false, new int[]{CompressionAlgorithmTags_Fields.ZLIB, CompressionAlgorithmTags_Fields.BZIP2, CompressionAlgorithmTags_Fields.ZIP, CompressionAlgorithmTags_Fields.UNCOMPRESSED});
			...
			pair = generator.generateKeyPair();
			PGPKeyPair pgpSubKey = new JcaPGPKeyPair(PublicKeyAlgorithmTags_Fields.ECDH, pair, DateTime.Now);

			// Assemble key

			PGPDigestCalculator calculator = (new JcaPGPDigestCalculatorProviderBuilder()).setProvider(BouncyCastleProvider.PROVIDER_NAME).build().get(HashAlgorithmTags_Fields.SHA1);

			PGPContentSignerBuilder signerBuilder = (new JcaPGPContentSignerBuilder(pgpMasterKey.getPublicKey().getAlgorithm(), HashAlgorithmTags_Fields.SHA512)).setProvider(BouncyCastleProvider.PROVIDER_NAME);

			PGPKeyRingGenerator pgpGenerator = new PGPKeyRingGenerator(PGPSignature.POSITIVE_CERTIFICATION, pgpMasterKey, "alice@wonderland.lit", calculator, subPackets.generate(), null, signerBuilder, null);
