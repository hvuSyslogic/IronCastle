namespace org.bouncycastle.openpgp.test
{
	...
	public class PGPArmoredTest : SimpleTest
	{
		...
		private int markerCount(byte[] data)
		{
			int ind = 0;
			int matches = 0;
