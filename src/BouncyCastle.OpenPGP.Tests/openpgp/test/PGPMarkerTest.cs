	...
	public class PGPMarkerTest : Test
	{
		...
		public virtual TestResult perform()
		{
			try
			{
				...
				if (pgpFact.nextObject() is PGPMarker)
				{
					if (pgpFact.nextObject() is PGPEncryptedDataList)
					{
