...
namespace org.bouncycastle.openpgp.test
{
	...
	using BcPGPKeyConverter = org.bouncycastle.openpgp.@operator.bc.BcPGPKeyConverter;
	...
	public class BcPGPDSAElGamalTest : SimpleTest
	{
		...
		public override void performTest()
		{
			try
			{
				...
				PGPEncryptedDataGenerator cPk = new PGPEncryptedDataGenerator((new BcPGPDataEncryptorBuilder(SymmetricKeyAlgorithmTags_Fields.TRIPLE_DES)).setSecureRandom(new SecureRandom()));
				...
				for (int pSize = 257; pSize < 264; ++pSize)
				{
					...
					cPk = new PGPEncryptedDataGenerator((new BcPGPDataEncryptorBuilder(SymmetricKeyAlgorithmTags_Fields.CAST5)).setSecureRandom(random));
