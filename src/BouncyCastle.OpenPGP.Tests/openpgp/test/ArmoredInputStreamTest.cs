namespace org.bouncycastle.openpgp.test
{
	...
	public class ArmoredInputStreamTest : SimpleTest
	{
		...
		public override void performTest()
		{
			try
			{
				PGPObjectFactory pgpObjectFactoryOfTestFile = new PGPObjectFactory(new ArmoredInputStream(new ByteArrayInputStream(bogusData)), new JcaKeyFingerprintCalculator());
