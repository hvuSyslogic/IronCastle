...
namespace org.bouncycastle.jce.provider.test
{
	...
	/// </summary>
	public class AESTest : BaseBlockCipherTest
	{
		...
		private void test(int strength, byte[] keyBytes, byte[] input, byte[] output)
		{
			...
			{
				fail("AES failed encryption - expected " + StringHelper.NewString(Hex.encode(output)) + " got " + StringHelper.NewString(Hex.encode(bytes)));
			}
			...
			{
				fail("AES failed decryption - expected " + StringHelper.NewString(Hex.encode(input)) + " got " + StringHelper.NewString(Hex.encode(bytes)));
			}
		}
		...
		private void gcmTest()
		{
			...
			byte[] C = Hex.decode("522dc1f099567d07f47f37a32a84427d" + "643a8cdcbfe5c0c97598a2bd2555d1aa" + "8cb08e48590dbb3da7b08b1056828838" + "c5f61e6393ba7a0abcc9f662898015ad" + T);
		...
		public override void performTest()
		{
			...
			string[] oids = new string[] {NISTObjectIdentifiers_Fields.id_aes128_ECB.getId(), NISTObjectIdentifiers_Fields.id_aes128_CBC.getId(), NISTObjectIdentifiers_Fields.id_aes128_OFB.getId(), NISTObjectIdentifiers_Fields.id_aes128_CFB.getId(), NISTObjectIdentifiers_Fields.id_aes192_ECB.getId(), NISTObjectIdentifiers_Fields.id_aes192_CBC.getId(), NISTObjectIdentifiers_Fields.id_aes192_OFB.getId(), NISTObjectIdentifiers_Fields.id_aes192_CFB.getId(), NISTObjectIdentifiers_Fields.id_aes256_ECB.getId(), NISTObjectIdentifiers_Fields.id_aes256_CBC.getId(), NISTObjectIdentifiers_Fields.id_aes256_OFB.getId(), NISTObjectIdentifiers_Fields.id_aes256_CFB.getId()};
			...
			string[] wrapOids = new string[] {NISTObjectIdentifiers_Fields.id_aes128_wrap.getId(), NISTObjectIdentifiers_Fields.id_aes192_wrap.getId(), NISTObjectIdentifiers_Fields.id_aes256_wrap.getId()};

			wrapOidTest(wrapOids, "AESWrap");

			wrapOids = new string[] {NISTObjectIdentifiers_Fields.id_aes128_wrap_pad.getId(), NISTObjectIdentifiers_Fields.id_aes192_wrap_pad.getId(), NISTObjectIdentifiers_Fields.id_aes256_wrap_pad.getId()};
