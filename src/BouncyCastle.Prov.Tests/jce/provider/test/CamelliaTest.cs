...
namespace org.bouncycastle.jce.provider.test
{
	...
	/// </summary>
	public class CamelliaTest : BaseBlockCipherTest
	{
		internal static string[] cipherTests = new string[] {"128", "0123456789abcdeffedcba9876543210", "0123456789abcdeffedcba9876543210", "67673138549669730857065648eabe43", "192", "0123456789abcdeffedcba98765432100011223344556677", "0123456789abcdeffedcba9876543210", "b4993401b3e996f84ee5cee7d79b09b9", "256", "0123456789abcdeffedcba987654321000112233445566778899aabbccddeeff", "0123456789abcdeffedcba9876543210", "9acc237dff16d76c20ef7c919e3a7509"};

		public CamelliaTest() : base("Camellia")
		{
		}
		...
		public virtual void test(int strength, byte[] keyBytes, byte[] input, byte[] output)
		{
			...
			{
				fail("Camellia failed encryption - expected " + StringHelper.NewString(Hex.encode(output)) + " got " + StringHelper.NewString(Hex.encode(bytes)));
			}
			...
			{
				fail("Camellia failed decryption - expected " + StringHelper.NewString(Hex.encode(input)) + " got " + StringHelper.NewString(Hex.encode(bytes)));
			}
		}
		...
		public override void performTest()
		{
			...
			string[] oids = new string[] {NTTObjectIdentifiers_Fields.id_camellia128_cbc.getId(), NTTObjectIdentifiers_Fields.id_camellia192_cbc.getId(), NTTObjectIdentifiers_Fields.id_camellia256_cbc.getId()};
			...
			string[] wrapOids = new string[] {NTTObjectIdentifiers_Fields.id_camellia128_wrap.getId(), NTTObjectIdentifiers_Fields.id_camellia192_wrap.getId(), NTTObjectIdentifiers_Fields.id_camellia256_wrap.getId()};
