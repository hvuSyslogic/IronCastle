...
namespace org.bouncycastle.jce.provider.test
{
	...
	public class DHTest : SimpleTest
	{
		...
		private byte[] oldPubEnc = Base64.decode("MIIBnzCCARQGByqGSM4+AgEwggEHAoGBAPxSrN417g43VAM9sZRf1dt6AocAf7D6" + "WVCtqEDcBJrMzt63+g+BNJzhXVtbZ9kp9vw8L/0PHgzv0Ot/kOLX7Khn+JalOECW" + "YlkyBhmOVbjR79TY5u2GAlvG6pqpizieQNBCEMlUuYuK1Iwseil6VoRuA13Zm7uw" + "WO1eZmaJtY7LAoGAQaPRCFKM5rEdkMrV9FNzeSsYRs8m3DqPnnJHpuySpyO9wUcX" + "OOJcJY5qvHbDO5SxHXu/+bMgXmVT6dXI5o0UeYqJR7fj6pR4E6T0FwG55RFr5Ok4" + "3C4cpXmaOu176SyWuoDqGs1RDGmYQjwbZUi23DjaaTFUly9LCYXMliKrQfEDgYQA" + "AoGAQUGCBN4TaBw1BpdBXdTvTfCU69XDB3eyU2FOBE3UWhpx9D8XJlx4f5DpA4Y6" + "6sQMuCbhfmjEph8W7/sbMurM/awR+PSR8tTY7jeQV0OkmAYdGK2nzh0ZSifMO1oE" + "NNhN2O62TLs67msxT28S4/S89+LMtc98mevQ2SX+JF3wEVU=");

		// bogus key with full PKCS parameter set
		private byte[] oldFullParams = Base64.decode("MIIBIzCCARgGByqGSM4+AgEwggELAoGBAP1/U4EddRIpUt9KnC7s5Of2EbdSPO9E" + "AMMeP4C2USZpRV1AIlH7WT2NWPq/xfW6MPbLm1Vs14E7gB00b/JmYLdrmVClpJ+f" + "6AR7ECLCT7up1/63xhv4O1fnxqimFQ8E+4P208UewwI1VBNaFpEy9nXzrith1yrv" + "8iIDGZ3RSAHHAoGBAPfhoIXWmz3ey7yrXDa4V7l5lK+7+jrqgvlXTAs9B4JnUVlX" + "jrrUWU/mcQcQgYC0SRZxI+hMKBYTt88JMozIpuE8FnqLVHyNKOCjrh4rs6Z1kW6j" + "fwv6ITVi8ftiegEkO8yk8b6oUZCJqIPf4VrlnwaSi2ZegHtVJWQBTDv+z0kqAgFk" + "AwUAAgIH0A==");

		private byte[] samplePubEnc = Base64.decode("MIIBpjCCARsGCSqGSIb3DQEDATCCAQwCgYEA/X9TgR11EilS30qcLuzk5/YRt1I8" + "70QAwx4/gLZRJmlFXUAiUftZPY1Y+r/F9bow9subVWzXgTuAHTRv8mZgt2uZUKWk" + "n5/oBHsQIsJPu6nX/rfGG/g7V+fGqKYVDwT7g/bTxR7DAjVUE1oWkTL2dfOuK2HX" + "Ku/yIgMZndFIAccCgYEA9+GghdabPd7LvKtcNrhXuXmUr7v6OuqC+VdMCz0HgmdR" + "WVeOutRZT+ZxBxCBgLRJFnEj6EwoFhO3zwkyjMim4TwWeotUfI0o4KOuHiuzpnWR" + "bqN/C/ohNWLx+2J6ASQ7zKTxvqhRkImog9/hWuWfBpKLZl6Ae1UlZAFMO/7PSSoC" + "AgIAA4GEAAKBgEIiqxoUW6E6GChoOgcfNbVFclW91ITf5MFSUGQwt2R0RHoOhxvO" + "lZhNs++d0VPATLAyXovjfgENT9SGCbuZttYcqqLdKTbMXBWPek+rfnAl9E4iEMED" + "IDd83FJTKs9hQcPAm7zmp0Xm1bGF9CbUFjP5G02265z7eBmHDaT0SNlB");
		...
		private void testGP(string algName, int size, int privateValueSize, BigInteger g, BigInteger p)
		{
			...
			if (aKeyPair.getPublic().GetHashCode() != pubKey.GetHashCode())
			{
			...
			if (aKeyPair.getPrivate().GetHashCode() != privKey.GetHashCode())
			{
				fail("hashCode test failed");
			}
			...
			{
				isTrue("no KDF specified for UserKeyingMaterialSpec".Equals(e.Message));
			}
		}
		...
		private void testExplicitWrapping(int size, int privateValueSize, BigInteger g, BigInteger p)
		{
			DHParameterSpec dhParams = new DHParameterSpec(p, g, privateValueSize);
			...
			SecretKey k1 = aKeyAgree.generateSecret(PKCSObjectIdentifiers_Fields.id_alg_CMS3DESwrap.getId());
			SecretKey k2 = bKeyAgree.generateSecret(PKCSObjectIdentifiers_Fields.id_alg_CMS3DESwrap.getId());
		...
		private void testRandom(int size)
		{
			...
			DHParameterSpec dhP = (DHParameterSpec)@params.getParameterSpec(typeof(DHParameterSpec));

			testGP("DH", size, 0, dhP.getG(), dhP.getP());
		}

		private void testDefault(int privateValueSize, BigInteger g, BigInteger p)
		{
			DHParameterSpec dhParams = new DHParameterSpec(p, g, privateValueSize);
			string algName = "DH";
			int size = p.bitLength();

			(new BouncyCastleProvider()).setParameter(ConfigurableProvider_Fields.DH_DEFAULT_PARAMS, dhParams);
			...
			(new BouncyCastleProvider()).setParameter(ConfigurableProvider_Fields.DH_DEFAULT_PARAMS, null);
		...
		private void testECDH(string algorithm)
		{
			...
			{
				JavaSystem.@out.println(" expected " + pubKey.getW().getAffineX() + " got " + ((ECPublicKey)aKeyPair.getPublic()).getW().getAffineX());
				JavaSystem.@out.println(" expected " + pubKey.getW().getAffineY() + " got " + ((ECPublicKey)aKeyPair.getPublic()).getW().getAffineY());
		...
		private void testMinSpecValue()
		{
			...
			{
				isTrue("unsafe p value so small specific l required".Equals(e.Message));
			}
		...
		private void testDHUnifiedTestVector1()
		{
			...
			DHParameterSpec dhSpec = new DHParameterSpec(new BigInteger("", 16), new BigInteger("", 16));

			KeyPair U1 = new KeyPair(dhKeyFact.generatePublic(new DHPublicKeySpec(new BigInteger("", 16), dhSpec.getP(), dhSpec.getG())), dhKeyFact.generatePrivate(new DHPrivateKeySpec(new BigInteger("95fc47b3c755935a5babce2738d70557a43ded59c2ef8926a04e402cdb0c97b8", 16), dhSpec.getP(), dhSpec.getG())));

			KeyPair U2 = new KeyPair(dhKeyFact.generatePublic(new DHPublicKeySpec(new BigInteger("", 16), dhSpec.getP(), dhSpec.getG())), dhKeyFact.generatePrivate(new DHPrivateKeySpec(new BigInteger("6044f14699de46fe870688b27d5644a78da6e0758f2c999cc5e6d80a69220e2e", 16), dhSpec.getP(), dhSpec.getG())));

			KeyPair V1 = new KeyPair(dhKeyFact.generatePublic(new DHPublicKeySpec(new BigInteger("", 16), dhSpec.getP(), dhSpec.getG())), dhKeyFact.generatePrivate(new DHPrivateKeySpec(new BigInteger("133a7729c7f1c1872438738edfa44d4cf44d3356d47b73b62eab45853ebdc66d", 16), dhSpec.getP(), dhSpec.getG())));

			KeyPair V2 = new KeyPair(dhKeyFact.generatePublic(new DHPublicKeySpec(new BigInteger("", 16), dhSpec.getP(), dhSpec.getG())), dhKeyFact.generatePrivate(new DHPrivateKeySpec(new BigInteger("412a15e0866572a825219d3eaf9a4d6c0ed855180e5bdabc90f6d1a2354c3964", 16), dhSpec.getP(), dhSpec.getG())));

			byte[] x = calculateUnifiedAgreement("DHUwithSHA256CKDF", "AES[128]", U1, U2, V1, V2, Hex.decode("a1b2c3d4e543415653696412daed24199775845035176e67b0ace1b413e0"));

			if (x == null || !areEqual(Hex.decode("24a246e6cbaae19e4e8bffbe3167fbbc"), x))
			{
		...
		private void testECUnifiedTestVector1()
		{
			...
			ECParameterSpec ecSpec = new ECParameterSpec(ecCurve, new ECPoint(namedSpec.getG().getAffineXCoord().toBigInteger(), namedSpec.getG().getAffineYCoord().toBigInteger()), namedSpec.getN(), namedSpec.getH().intValue());

			KeyPair U1 = new KeyPair(ecKeyFact.generatePublic(new ECPublicKeySpec(ECPointUtil.decodePoint(ecCurve, Hex.decode("040784e946ef1fae0cfe127042a310a018ba639d3f6b41f265904f0a7b21b7953efe638b45e6c0c0d34a883a510ce836d143d831daa9ce8a12")), ecSpec)), ecKeyFact.generatePrivate(new ECPrivateKeySpec(new BigInteger("86d1735ca357890aeec8eccb4859275151356ecee9f1b2effb76b092", 16), ecSpec)));

			KeyPair U2 = new KeyPair(ecKeyFact.generatePublic(new ECPublicKeySpec(ECPointUtil.decodePoint(ecCurve, Hex.decode("04b33713dc0d56215be26ee6c5e60ad36d12e02e78529ae3ff07873c6b39598bda41c1cf86ee3981f40e102333c15fef214bda034291c1aca6")), ecSpec)), ecKeyFact.generatePrivate(new ECPrivateKeySpec(new BigInteger("764010b3137ef8d34a3552955ada572a4fa1bb1f5289f27c1bf18344", 16), ecSpec)));

			KeyPair V1 = new KeyPair(ecKeyFact.generatePublic(new ECPublicKeySpec(ECPointUtil.decodePoint(ecCurve, Hex.decode("0484c22d9575d09e280613c8758467f84869c6eede4f6c1b644517d6a72c4fc5c68fa12b4c259032fc5949c630259948fca38fb3342d9cb0a8")), ecSpec)), ecKeyFact.generatePrivate(new ECPrivateKeySpec(new BigInteger("e37964e391f5058fb43435352a9913438a1ec10831f755273285230a", 16), ecSpec)));

			KeyPair V2 = new KeyPair(ecKeyFact.generatePublic(new ECPublicKeySpec(ECPointUtil.decodePoint(ecCurve, Hex.decode("044b917e9ce693b277c8095e535ea81c2dea089446a8c55438eda750fb6170c85b86390481fff2dff94b7dff3e42d35ff623921cb558967b48")), ecSpec)), ecKeyFact.generatePrivate(new ECPrivateKeySpec(new BigInteger("ab40d67f59ba7265d8ad33ade8f704d13a7ba2298b69172a7cd02515", 16), ecSpec)));

			byte[] x = calculateUnifiedAgreement("ECCDHUwithSHA224CKDF", "AES[128]", U1, U2, V1, V2, Hex.decode("a1b2c3d4e54341565369643dba868da77897b6552f6f767ad873b232aa4a810a91863ec3dc86db53359a772dd76933"));

			if (x == null || !areEqual(Hex.decode("63b7ba5699927cb08e058b76af7fc0b0"), x))
			{
		...
		private void testECUnifiedTestVector2()
		{
			...
			KeyPair U1 = new KeyPair(ecKeyFact.generatePublic(new ECPublicKeySpec(ECPointUtil.decodePoint(ecCurve, Hex.decode("047581b35964a983414ebdd56f4ebb1ddcad10881b200666a51ae41306e1ecf1db368468a5e8a65ca10ccea526472c8982db68316c468800e171c11f4ee694fce4")), ecSpec)), ecKeyFact.generatePrivate(new ECPrivateKeySpec(new BigInteger("2eb7ef76d4936123b6f13035045aedf45c1c7731f35d529d25941926b5bb38bb", 16), ecSpec)));

			KeyPair U2 = new KeyPair(ecKeyFact.generatePublic(new ECPublicKeySpec(ECPointUtil.decodePoint(ecCurve, Hex.decode("045b1e4cdeb0728333c0a51631b1a75269e4878d10732f4cb94d600483db4bd9ee625c374592c3db7e9f8b4f2c91a0098a158bc37b922e4243bd9cbdefe67d6ab0")), ecSpec)), ecKeyFact.generatePrivate(new ECPrivateKeySpec(new BigInteger("78acde388a022261767e6b3dd6dd016c53b70a084260ec87d395aec761c082de", 16), ecSpec)));

			KeyPair V1 = new KeyPair(ecKeyFact.generatePublic(new ECPublicKeySpec(ECPointUtil.decodePoint(ecCurve, Hex.decode("04e4916d616803ff1bd9569f35b7d06f792f19c1fb4e6fa916d686c027a17d8dffd570193d8e101624ac2ea0bcb762d5613f05452670f09af66ef70861fb528868")), ecSpec)), ecKeyFact.generatePrivate(new ECPrivateKeySpec(new BigInteger("9c85898640a1b1de8ce7f557492dc1460530b9e17afaaf742eb953bb644e9c5a", 16), ecSpec)));

			KeyPair V2 = new KeyPair(ecKeyFact.generatePublic(new ECPublicKeySpec(ECPointUtil.decodePoint(ecCurve, Hex.decode("04d1cd23c29d0fc865c316d44a1fd5adb6605ee47c9ddfec3a9b0a5e532d52704e74ff5d149aeb50856fefb38d5907b6dbb580fe6dc166bcfcbee4eb376d77e95c")), ecSpec)), ecKeyFact.generatePrivate(new ECPrivateKeySpec(new BigInteger("d6e11d5d3b85b201b8f4c12dadfad3000e267961a806a0658a2b859d44389599", 16), ecSpec)));

			byte[] x = calculateUnifiedAgreement("ECCDHUwithSHA256CKDF", "AES[128]", U1, U2, V1, V2, Hex.decode("a1b2c3d4e54341565369649018558dc958160b4b1d240d06ea07c6f321a752496c1a3ff45cbb4b43507c6fe1997d1d"));

			if (x == null || !areEqual(Hex.decode("221d252072d6f85b8298eab6fc38634e"), x))
			{
		...
		private void testECUnifiedTestVector3()
		{
			...
			KeyPair U1 = new KeyPair(ecKeyFact.generatePublic(new ECPublicKeySpec(ECPointUtil.decodePoint(ecCurve, Hex.decode("04030f136fa7fef90d185655ed1c6d46bacdb82001714e682cc80ca6b2d7c62e2f2e19d11755dba4aafd7e1ee5fda3e5f4d0af9a3ad773c38a")), ecSpec)), ecKeyFact.generatePrivate(new ECPrivateKeySpec(new BigInteger("6fc464c741f52b2a2e4cde35673b87fdd0f52caf4e716230b11570ba", 16), ecSpec)));

			KeyPair V1 = new KeyPair(ecKeyFact.generatePublic(new ECPublicKeySpec(ECPointUtil.decodePoint(ecCurve, Hex.decode("048f87f5f8a632c9a3348ea85b596c01c12ca29ca71583dcdc27ff9766351416a707b95fae67d56be5119b460a446b6a02db20a13bbc8ed13b")), ecSpec)), ecKeyFact.generatePrivate(new ECPrivateKeySpec(new BigInteger("f5cb57a08a6949d3f2c2cc02e7c2252cecb3ebb8b3572943ceb407c7", 16), ecSpec)));

			KeyPair V2 = new KeyPair(ecKeyFact.generatePublic(new ECPublicKeySpec(ECPointUtil.decodePoint(ecCurve, Hex.decode("046fcc7d01f905b279e9413645d24cc30d293b98b0ea7bfe87124e4951eba04a74817f596a67c0bfe3b4f4cee99537a2ac1c6470dd006be8ca")), ecSpec)), ecKeyFact.generatePrivate(new ECPrivateKeySpec(new BigInteger("505b6f372725e293cda07bf0dd14dabe2faf0edaa5ab1c7d187a6138", 16), ecSpec)));

			byte[] x = calculateUnifiedAgreement("ECCDHUwithSHA224CKDF", "AES[128]", U1, U1, V1, V2, Hex.decode("a1b2c3d4e5434156536964b62d3197031c27af0e3b45228a8768efcc0b39a375f8f61852f8765b80c067eed4e4db30"));

			if (x == null || !areEqual(Hex.decode("0c96fa268b89cf664392621ad5e174a6"), x))
			{
				fail("EC unified Test Vector #3 agreement failed, got: " + Hex.toHexString(x));
			}
		}

		private byte[] calculateUnifiedAgreement(string alg, string keyAlg, KeyPair U1, KeyPair U2, KeyPair V1, KeyPair V2, byte[] oi)
		{
		...
		private void testExceptions()
		{
			...
			{
				isTrue("wrong message: " + e.Message, "invalid KeySpec: Point not on curve".Equals(e.Message));
			}
			catch (java.security.InvalidKeyException e)
			{
				isTrue("wrong message: " + e.Message, "calculation failed: Invalid point".Equals(e.Message));
			}
		...
		private void testSmallSecret()
		{
			...
			DHPrivateKeySpec aPrivSpec = new DHPrivateKeySpec(new BigInteger("30a6ea4e2240a42867ad98bd3adbfd5b81aba48bd930f20a595983d807566f7cba4e766951efef2c6c0c1be3823f63d66e12c2a091d5ff3bbeb1ea6e335d072d", 16), p, g);
			DHPublicKeySpec aPubSpec = new DHPublicKeySpec(new BigInteger("694dfea1bfc8897e2fcbfd88033ab34f4581892d7d5cc362dc056e3d43955accda12222bd651ca31c85f008a05dea914de68828dfd83a54a340fa84f3bbe6caf", 16), p, g);

			DHPrivateKeySpec bPrivSpec = new DHPrivateKeySpec(new BigInteger("775b1e7e162190700e2212dd8e4aaacf8a2af92c9c108b81d5bf9a14548f494eaa86a6c4844b9512eb3e3f2f22ffec44c795c813edfea13f075b99bbdebb34bd", 16), p, g);

			DHPublicKeySpec bPubSpec = new DHPublicKeySpec(new BigInteger("d8ddd4ff9246635eadbfa0bc2ef06d98a329b6e8cd2d1435d7b4921467570e697c9a9d3c172c684626a9d2b6b2fa0fc725d5b91f9a9625b717a4169bc714b064", 16), p, g);
		...
		private void testConfig()
		{
			...
			prov.setParameter(ConfigurableProvider_Fields.DH_DEFAULT_PARAMS, dhSpec512);
			...
			prov.setParameter(ConfigurableProvider_Fields.DH_DEFAULT_PARAMS, new DHParameterSpec[]{dhSpec512, dhSpec640, dhSpec1024});
			...
			prov.setParameter(ConfigurableProvider_Fields.DH_DEFAULT_PARAMS, null);
			...
			prov.setParameter(ConfigurableProvider_Fields.THREAD_LOCAL_DH_DEFAULT_PARAMS, dhSpec512);
			...
			prov.setParameter(ConfigurableProvider_Fields.THREAD_LOCAL_DH_DEFAULT_PARAMS, new DHParameterSpec[]{dhSpec512, dhSpec640, dhSpec1024});
			...
			prov.setParameter(ConfigurableProvider_Fields.THREAD_LOCAL_DH_DEFAULT_PARAMS, null);
		...
		internal const string MESSAGE = "Hello";

		internal const string PROVIDER_NAME = "BC";
		...
		public virtual void setUp()
		{
			...
			JavaSystem.@out.println("WARNING: Using BouncyCastleProvider");
		}

		public virtual DHParameterSpec ike2048()
		{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.math.BigInteger p = new java.math.BigInteger("ffffffffffffffffc90fdaa22168c234c4c6628b80dc1cd129024e088a67cc74" + "020bbea63b139b22514a08798e3404ddef9519b3cd3a431b302b0a6df25f1437" + "4fe1356d6d51c245e485b576625e7ec6f44c42e9a637ed6b0bff5cb6f406b7ed" + "ee386bfb5a899fa5ae9f24117c4b1fe649286651ece45b3dc2007cb8a163bf05" + "98da48361c55d39a69163fa8fd24cf5f83655d23dca3ad961c62f356208552bb" + "9ed529077096966d670c354e4abc9804f1746c08ca18217c32905e462e36ce3b" + "e39e772c180e86039b2783a2ec07a28fb5c55df06f4c52c9de2bcbf695581718" + "3995497cea956ae515d2261898fa051015728e5a8aacaa68ffffffffffffffff", 16);
			BigInteger p = new BigInteger("ffffffffffffffffc90fdaa22168c234c4c6628b80dc1cd129024e088a67cc74" + "020bbea63b139b22514a08798e3404ddef9519b3cd3a431b302b0a6df25f1437" + "4fe1356d6d51c245e485b576625e7ec6f44c42e9a637ed6b0bff5cb6f406b7ed" + "ee386bfb5a899fa5ae9f24117c4b1fe649286651ece45b3dc2007cb8a163bf05" + "98da48361c55d39a69163fa8fd24cf5f83655d23dca3ad961c62f356208552bb" + "9ed529077096966d670c354e4abc9804f1746c08ca18217c32905e462e36ce3b" + "e39e772c180e86039b2783a2ec07a28fb5c55df06f4c52c9de2bcbf695581718" + "3995497cea956ae515d2261898fa051015728e5a8aacaa68ffffffffffffffff", 16);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.math.BigInteger g = new java.math.BigInteger("2");
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.math.BigInteger p = params.getP();
			BigInteger p = @params.getP();
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.math.BigInteger g = params.getG();
			BigInteger g = @params.getG();
			keyGen.initialize(@params);
			PrivateKey priv = keyGen.generateKeyPair().getPrivate();
			KeyAgreement ka = KeyAgreement.getInstance("DH", "BC");
			BigInteger[] weakPublicKeys = new BigInteger[] {BigInteger.ZERO, BigInteger.ONE, p.subtract(BigInteger.ONE), p, p.add(BigInteger.ONE), BigInteger.ONE.negate()};
			foreach (BigInteger weakKey in weakPublicKeys)
			{
				...
				{
					isTrue("wrong message (generate)", "invalid DH public key".Equals(ex.Message));
				}
				ka.init(priv);
				try
				{
					ka.doPhase(new DHPublicKeyAnonymousInnerClass(this, p, g)
				   , true);
					fail("Generated secrets with weak public key");
				}
				catch (GeneralSecurityException ex)
				{
					isTrue("wrong message (doPhase)", "Invalid DH PublicKey".Equals(ex.Message));
				}
			}
		}

		public class DHPublicKeyAnonymousInnerClass : DHPublicKey
		{
			private readonly DHTest outerInstance;

			private BigInteger p;
			private BigInteger g;

			public DHPublicKeyAnonymousInnerClass(DHTest outerInstance, BigInteger p, BigInteger g)
			{
		...
		private SecretKey mqvGenerateAESKey(PrivateKey aPriv, PublicKey aPubEph, PrivateKey aPrivEph, PublicKey bPub, PublicKey bPubEph, byte[] keyMaterial)
		{
		...
		private void mqvTest()
		{
			...
			SecretKey aKey = mqvGenerateAESKey(aKpS.getPrivate(), aKpE.getPublic(), aKpE.getPrivate(), bKpS.getPublic(), bKpE.getPublic(), keyMaterial);
			SecretKey bKey = mqvGenerateAESKey(bKpS.getPrivate(), bKpE.getPublic(), bKpE.getPrivate(), aKpS.getPublic(), aKpE.getPublic(), keyMaterial);
			...
			aKey = mqvGenerateAESKey(kFact.generatePrivate(new PKCS8EncodedKeySpec(aKpS.getPrivate().getEncoded())), aKpE.getPublic(), aKpE.getPrivate(), bKpS.getPublic(), kFact.generatePublic(new X509EncodedKeySpec(bKpE.getPublic().getEncoded())), keyMaterial);
			bKey = mqvGenerateAESKey(bKpS.getPrivate(), bKpE.getPublic(), kFact.generatePrivate(new PKCS8EncodedKeySpec(bKpE.getPrivate().getEncoded())), aKpS.getPublic(), aKpE.getPublic(), keyMaterial);
		...
		private void generalKeyTest()
		{
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.security.KeyPairGenerator keyPairGenerator = java.security.KeyPairGenerator.getInstance("DH", "BC");
		...
		public override void performTest()
		{
			...
			testECDH("ECKAEGWITHSHA1KDF", "secp256r1", BSIObjectIdentifiers_Fields.ecka_eg_X963kdf_SHA1, "DESEDE", 192);
			testECDH("ECKAEGWITHSHA224KDF", "secp256r1", BSIObjectIdentifiers_Fields.ecka_eg_X963kdf_SHA224, "DESEDE", 192);
			testECDH("ECKAEGWITHSHA256KDF", "secp256r1", BSIObjectIdentifiers_Fields.ecka_eg_X963kdf_SHA256, "DESEDE", 192);
			testECDH("ECKAEGWITHSHA384KDF", "secp256r1", BSIObjectIdentifiers_Fields.ecka_eg_X963kdf_SHA384,"AES", 256);
			testECDH("ECKAEGWITHSHA512KDF", "secp256r1", BSIObjectIdentifiers_Fields.ecka_eg_X963kdf_SHA512,"DESEDE", 192);
			testECDH("ECKAEGWITHRIPEMD160KDF", "secp256r1", BSIObjectIdentifiers_Fields.ecka_eg_X963kdf_RIPEMD160, "AES", 256);
