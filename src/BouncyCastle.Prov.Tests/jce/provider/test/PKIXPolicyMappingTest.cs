...
namespace org.bouncycastle.jce.provider.test
{
	...
	{
		internal static X509V3CertificateGenerator v3CertGen = new X509V3CertificateGenerator();
		...
		/// TrustAnchor's Cert
		/// </summary>
		private X509Certificate createTrustCert(PublicKey pubKey, PrivateKey privKey)
		{
			...
			v3CertGen.setNotBefore(new DateTime(System.currentTimeMillis() - 1000L * 60 * 60 * 24 * 30));
			v3CertGen.setNotAfter(new DateTime(System.currentTimeMillis() + (1000L * 60 * 60 * 24 * 30)));
		...
		/// intermediate cert
		/// </summary>
		private X509Certificate createIntmedCert(PublicKey pubKey, PrivateKey caPrivKey, PublicKey caPubKey, CertificatePolicies policies, Hashtable policyMap)
		{
			string issuer = "C=JP, O=policyMappingAdditionalTest, OU=trustAnchor";
		...
		/// endEntity cert
		/// </summary>
		private X509Certificate createEndEntityCert(PublicKey pubKey, PrivateKey caPrivKey, PublicKey caPubKey, ASN1EncodableVector policies)
		{
		...
		private string testPolicies(int index, X509Certificate trustCert, X509Certificate intCert, X509Certificate endCert, Set requirePolicies, bool okay)
		{
	...
	//            {
	//                JavaSystem.@out.println("OK");
	//                JavaSystem.@out.println("policy: " + result.getPolicyTree());
	//            }
	//            else
	//            {
	//                JavaSystem.@out.println("OK: policy tree = null");
	//            }
		...
		public override void performTest()
		{
			...
			// ca keys
			//
			RSAPublicKeySpec caPubKeySpec = new RSAPublicKeySpec(new BigInteger("", 16), new BigInteger("11", 16));
