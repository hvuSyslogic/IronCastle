namespace org.bouncycastle.jce.provider.test
{
	...
	public class OpenSSHSpecTests : SimpleTest
	{
		private static readonly SecureRandom secureRandom = new SecureRandom();

		public virtual void testEncodingRSA()
		{
			...
			OpenSSHPublicKeySpec rcPublicKeySpec = kpf.getKeySpec(pk, typeof(OpenSSHPublicKeySpec));
			OpenSSHPrivateKeySpec rcPrivateSpec = kpf.getKeySpec(prk, typeof(OpenSSHPrivateKeySpec));
		...
		public virtual void testEncodingDSA()
		{
			...
			OpenSSHPublicKeySpec dsaPublicKeySpec = kpf.getKeySpec(pk, typeof(OpenSSHPublicKeySpec));
			OpenSSHPrivateKeySpec dsaPrivateSpec = kpf.getKeySpec(prk, typeof(OpenSSHPrivateKeySpec));
		...
		private void testEncodingECDSA()
		{
			...
			OpenSSHPublicKeySpec ecdsaPublicKeySpec = kpf.getKeySpec(pk, typeof(OpenSSHPublicKeySpec));
			OpenSSHPrivateKeySpec ecdsaPrivateSpec = kpf.getKeySpec(prk, typeof(OpenSSHPrivateKeySpec));
		...
		public virtual void testED25519()
		{
			...
			OpenSSHPublicKeySpec edDsaPublicKeySpec = kpf.getKeySpec(pk, typeof(OpenSSHPublicKeySpec));
			OpenSSHPrivateKeySpec edDsaPrivateKeySpec = kpf.getKeySpec(prk, typeof(OpenSSHPrivateKeySpec));
			...
			isTrue("EDPrivate key not same", Arrays.areEqual(Hex.decode(""), edDsaPrivateKeySpec.getEncoded()));
