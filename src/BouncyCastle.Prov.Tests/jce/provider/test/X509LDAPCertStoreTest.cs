namespace org.bouncycastle.jce.provider.test
{
	...
	public class X509LDAPCertStoreTest : SimpleTest
	{
		...
		private void certStoretest()
		{
			...
			// JavaSystem.@out.println(coll.toArray()[0]);
