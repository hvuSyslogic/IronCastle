...
namespace org.bouncycastle.jce.provider.test
{
	...
	public class SigTest : SimpleTest
	{
		/// <summary>
		/// signature with a "forged signature" (sig block not at end of plain text)
		/// </summary>
		private void testBadSig(PrivateKey priv, PublicKey pub)
		{
			...
			JavaSystem.arraycopy(sigHeader, 0, block, 0, sigHeader.Length);

			byte[] dig = sha1.digest();

			JavaSystem.arraycopy(dig, 0, block, sigHeader.Length, dig.Length);

			JavaSystem.arraycopy(sigHeader, 0, block, sigHeader.Length + dig.Length, sigHeader.Length);
		...
		public override void performTest()
		{
			...
			tryRsaPkcs15Sig("SHA224WithRSA", data, signingKey, verifyKey, PKCSObjectIdentifiers_Fields.sha224WithRSAEncryption, NISTObjectIdentifiers_Fields.id_sha224);
			tryRsaPkcs15Sig("SHA256WithRSA", data, signingKey, verifyKey, PKCSObjectIdentifiers_Fields.sha256WithRSAEncryption, NISTObjectIdentifiers_Fields.id_sha256);
			tryRsaPkcs15Sig("SHA384WithRSA", data, signingKey, verifyKey, PKCSObjectIdentifiers_Fields.sha384WithRSAEncryption, NISTObjectIdentifiers_Fields.id_sha384);
			tryRsaPkcs15Sig("SHA512WithRSA", data, signingKey, verifyKey, PKCSObjectIdentifiers_Fields.sha512WithRSAEncryption, NISTObjectIdentifiers_Fields.id_sha512);
			tryRsaPkcs15Sig("SHA512(224)WithRSA", data, signingKey, verifyKey, PKCSObjectIdentifiers_Fields.sha512_224WithRSAEncryption, NISTObjectIdentifiers_Fields.id_sha512_224);
			tryRsaPkcs15Sig("SHA512(256)WithRSA", data, signingKey, verifyKey, PKCSObjectIdentifiers_Fields.sha512_256WithRSAEncryption, NISTObjectIdentifiers_Fields.id_sha512_256);
			tryRsaPkcs15Sig("SHA224WithRSAEncryption", data, signingKey, verifyKey, PKCSObjectIdentifiers_Fields.sha224WithRSAEncryption, NISTObjectIdentifiers_Fields.id_sha224);
			tryRsaPkcs15Sig("SHA256WithRSAEncryption", data, signingKey, verifyKey, PKCSObjectIdentifiers_Fields.sha256WithRSAEncryption, NISTObjectIdentifiers_Fields.id_sha256);
			tryRsaPkcs15Sig("SHA384WithRSAEncryption", data, signingKey, verifyKey, PKCSObjectIdentifiers_Fields.sha384WithRSAEncryption, NISTObjectIdentifiers_Fields.id_sha384);
			tryRsaPkcs15Sig("SHA512WithRSAEncryption", data, signingKey, verifyKey, PKCSObjectIdentifiers_Fields.sha512WithRSAEncryption, NISTObjectIdentifiers_Fields.id_sha512);
			tryRsaPkcs15Sig("SHA512(224)WithRSAEncryption", data, signingKey, verifyKey, PKCSObjectIdentifiers_Fields.sha512_224WithRSAEncryption, NISTObjectIdentifiers_Fields.id_sha512_224);
			tryRsaPkcs15Sig("SHA512(256)WithRSAEncryption", data, signingKey, verifyKey, PKCSObjectIdentifiers_Fields.sha512_256WithRSAEncryption, NISTObjectIdentifiers_Fields.id_sha512_256);

			tryRsaPkcs15Sig("SHA3-224WithRSA", data, signingKey, verifyKey, NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_224, NISTObjectIdentifiers_Fields.id_sha3_224);
			tryRsaPkcs15Sig("SHA3-256WithRSA", data, signingKey, verifyKey, NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_256, NISTObjectIdentifiers_Fields.id_sha3_256);
			tryRsaPkcs15Sig("SHA3-384WithRSA", data, signingKey, verifyKey, NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_384, NISTObjectIdentifiers_Fields.id_sha3_384);
			tryRsaPkcs15Sig("SHA3-512WithRSA", data, signingKey, verifyKey, NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_512, NISTObjectIdentifiers_Fields.id_sha3_512);
			tryRsaPkcs15Sig("SHA3-224WithRSAEncryption", data, signingKey, verifyKey, NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_224, NISTObjectIdentifiers_Fields.id_sha3_224);
			tryRsaPkcs15Sig("SHA3-256WithRSAEncryption", data, signingKey, verifyKey, NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_256, NISTObjectIdentifiers_Fields.id_sha3_256);
			tryRsaPkcs15Sig("SHA3-384WithRSAEncryption", data, signingKey, verifyKey, NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_384, NISTObjectIdentifiers_Fields.id_sha3_384);
			tryRsaPkcs15Sig("SHA3-512WithRSAEncryption", data, signingKey, verifyKey, NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_512, NISTObjectIdentifiers_Fields.id_sha3_512);
