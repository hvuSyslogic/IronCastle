...
//ORIGINAL LINE: final javax.crypto.SecretKey secretKey = new javax.crypto.spec.SecretKeySpec(SECRET_KEY_1024, "Threefish-1024");
			SecretKey secretKey = new SecretKeySpec(SECRET_KEY_1024, "Threefish-1024");
