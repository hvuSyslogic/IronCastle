...
namespace org.bouncycastle.jcajce.provider.test
{
	...
	public class GeneralKeyTest : TestCase
	{
		...
		public virtual void testDH()
		{
			KeyPairGenerator kpGen = KeyPairGenerator.getInstance("DH", "BC");

			doBasicTest("DH", kpGen.generateKeyPair());

			byte[] encPub = Base64.decode("MIIDbzCCAmIGByqGSM4+AgEwggJVAoIBAQCVR1z12T5ZbD/NHZAq3QL0J/XzxyEDE7tF+01bsuX+HL1n" + "jNS73YTJg2vh8xwHd3Ja62wvw4uF9IB2+na82BRsyJpvsvcG3XGYmMIIPcjYlvhAYuLJyU0TewVKjYCWrbjVGVI5juyoUqCvEt+D5HWqZd" + "TsDDipVg1WYRhv+Yufyetg7uiwMDdrI2vHO+Os29dP1hwdJHX6MHe48IBGeIH/fhylb+4GbXlQat5R7btUQ6Vjkn28S6UgCGdGF1yIhZJe" + "vGTGFHkGdzSWmQy3FOxmcwTiYfruM7PL3wCODD+pBlDZfTkJySdb9KyG/8s9A+bfyK2lk0JC3W07zKKkBssLAoIBAELeu52ls9iMyVbgh4" + "fsPzoJu6X0i4iadKr1MXSqD75+PFuPzXpTvvVjsOmFYDKJYKlRf0AU0zJfx5Yr8eBJNw120TFKdhN+eS8/DbhZ0JXkpbkyAk8Hns8u8Jx5" + "dFKwdw4TUHgu1X3feUl53O8jy5bxgwYZZcTryTycccVrkllVp1+UzM8USaxD1YbQvu5DJRsLIoc0nWjeDRREA/E+gC9BRtiC4FevGbb2J1" + "xmdsj6DjyicToyV/0bJ9Bjn2leNH2NHPmsgZomypsEyw65t7A1mI0Vu6xlISpVI5z8flj6441yUKuZkf+8lxNAJf6M4ExDma2WVpvpGlRv" + "SXhpPHoCIQD4GDZoul/Fuwa1mB5ti3ldMLiXjUPKDsVy434Jk5qXczAnAyEAsLRBdgG1nLydisj5Ncra7E9fuy8jeFYJrkZnSNm1pTYCAg" + "HxA4IBBQACggEAQad+gehy9k1NNz8U5JHZIDvxm8v8RI9VLgggIr9nVs9Sxp5txpLNZ6SO0mh6U/BThwRXW1HvR6eR/WrtizfMQ/EZJdUT" + "8Tm5tEKEqA6gkTlyX/nLtsJWFuzLc6cYhdnCmP7tDWFBg7qhPqE6Aaj7E/IORPZXH/8NuE3XmhuRoba6x+u7wWMdEXhRYsIIH1xxCQuJCJ" + "/gIeDa+jtXckXQp/e4yUBB4yZ/GRxDiNfKP1A8m6Qqqf1g7zWN+r3gIEpB74pu6X4p/nyA3tqAI0rBao2rIPe7MaQtml6KsvH9MKaimGeC" + "BcmlncsqZZXbvFOYiu4fYKszqx+K7z8bWAuwzA==");
			byte[] encPriv = Base64.decode("MIIDcgIBADCCAmIGByqGSM4+AgEwggJVAoIBAQCVR1z12T5ZbD/NHZAq3QL0J/XzxyEDE7tF+01bsuX" + "+HL1njNS73YTJg2vh8xwHd3Ja62wvw4uF9IB2+na82BRsyJpvsvcG3XGYmMIIPcjYlvhAYuLJyU0TewVKjYCWrbjVGVI5juyoUqCvEt+D5" + "HWqZdTsDDipVg1WYRhv+Yufyetg7uiwMDdrI2vHO+Os29dP1hwdJ
", StringComparison.Ordinal));
			...
			assertTrue(priv.ToString().StartsWith("DSA Private Key [0d:64:94:81:01:3d:2d:30:82:00:4b:67:a1:23:45:56:fe:52:11:18]", StringComparison.Ordinal));
		...
		public virtual void testDstu4145()
		{
			ECDomainParameters ecDP = DSTU4145NamedCurves.getByOID(UAObjectIdentifiers_Fields.dstu4145le.branch("2.2"));
			ECCurve curve = ecDP.getCurve();

			// NOTE: For some reason this test uses an alternate base-point to the registry curve
			ecDP = new ECDomainParameters(curve, curve.createPoint(new BigInteger("BE6628EC3E67A91A4E470894FBA72B52C515F8AEE9", 16), new BigInteger("D9DEEDF655CF5412313C11CA566CDC71F4DA57DB45C", 16)), ecDP.getN(), ecDP.getH(), ecDP.getSeed());
			...
			byte[] encPub = Base64.decode("MIGMMG8GDSqGJAIBAQEBAwEBAQEwXjBcMA8CAgCtMAkCAQECAQICAQoCAQAEFhCFdsgEmdsvwW7d9oU7" + "uyePa2+0N9kCFggAAAAAAAAAAAAAGJtOZ2BuOCW7KDEEFgC+ZijsPmepGk5HCJT7pytSxRX4rukDGQAEFgojyiWbwNI5uQ/H6/7tj5c1iJ" + "6YMa4=");
			byte[] encPriv = Base64.decode("MIH1AgEAMG8GDSqGJAIBAQEBAwEBAQEwXjBcMA8CAgCtMAkCAQECAQICAQoCAQAEFhCFdsgEmdsvwW7" + "d9oU7uyePa2+0N9kCFggAAAAAAAAAAAAAGJtOZ2BuOCW7KDEEFgC+ZijsPmepGk5HCJT7pytSxRX4rukEfzB9AgEBBBYA8jtdMuBv99mSm" + "oocSNbxaJd+UvHioGAwXjBcMA8CAgCtMAkCAQECAQICAQoCAQAEFhCFdsgEmdsvwW7d9oU7uyePa2+0N9kCFggAAAAAAAAAAAAAGJtOZ2B" + "uOCW7KDEEFgC+ZijsPmepGk5HCJT7pytSxRX4ruk=");
			...
			assertTrue(pub.ToString().StartsWith("DSTU4145 Public Key [9c:8e:34:24:8c:80:da:36:e1:e6:c1:39:70:97:c8:31:24:f7:69:7d]", StringComparison.Ordinal));
			...
			assertTrue(priv.ToString().StartsWith("DSTU4145 Private Key [88:51:e7:8d:42:e9:ca:b6:3d:a8:51:de:06:b6:73:f0:11:f7:2d:18]", StringComparison.Ordinal));
		...
		public virtual void testGost3410()
		{
			...
			assertTrue(pub.ToString().StartsWith("GOST3410 Public Key [4f:4d:ab:ec:1d:f6:c6:aa:d2:f9:91:4d:44:3d:a7:d0:b9:77:e8:e0]", StringComparison.Ordinal));
			...
			assertTrue(priv.ToString().StartsWith("GOST3410 Private Key [4f:4d:ab:ec:1d:f6:c6:aa:d2:f9:91:4d:44:3d:a7:d0:b9:77:e8:e0]", StringComparison.Ordinal));
		...
		public virtual void testEC()
		{
			...
			assertTrue(pub.ToString().StartsWith("EC Public Key [0c:c4:d5:d1:c6:1f:6a:b6:0c:14:17:03:d3:00:7d:5a:98:a6:5b:41]", StringComparison.Ordinal));
			...
			assertTrue(priv.ToString().StartsWith("EC Private Key [0c:c4:d5:d1:c6:1f:6a:b6:0c:14:17:03:d3:00:7d:5a:98:a6:5b:41]", StringComparison.Ordinal));
		...
		public virtual void testEcgost3410()
		{
			...
			assertTrue(pub.ToString().StartsWith("ECGOST3410 Public Key [50:e7:1f:ce:03:88:cc:7a:6b:7b:3d:3a:72:89:62:23:76:c2:fa:e5]", StringComparison.Ordinal));
			...
			assertTrue(priv.ToString().StartsWith("ECGOST3410 Private Key [50:e7:1f:ce:03:88:cc:7a:6b:7b:3d:3a:72:89:62:23:76:c2:fa:e5]", StringComparison.Ordinal));
		...
		public virtual void testEcgost3410_2012()
		{
			...
			assertTrue(pub.ToString().StartsWith("ECGOST3410-2012 Public Key [01:66:a0:e4:29:12:09:bb:61:b4:fc:22:71:fe:ef:fa:dc:6a:82:d2]", StringComparison.Ordinal));
			...
			assertTrue(priv.ToString().StartsWith("ECGOST3410-2012 Private Key [01:66:a0:e4:29:12:09:bb:61:b4:fc:22:71:fe:ef:fa:dc:6a:82:d2]", StringComparison.Ordinal));
		...
		public virtual void testSM2()
		{
			...
			assertTrue(pub.ToString().StartsWith("EC Public Key [38:20:5a:95:6f:1d:6f:10:74:42:a0:a7:ee:d4:b8:83:6d:32:2f:e6]", StringComparison.Ordinal));
			...
			assertTrue(priv.ToString().StartsWith("EC Private Key [38:20:5a:95:6f:1d:6f:10:74:42:a0:a7:ee:d4:b8:83:6d:32:2f:e6]", StringComparison.Ordinal));
		...
		public virtual void testRSA()
		{
			KeyPairGenerator kpGen = KeyPairGenerator.getInstance("RSA", "BC");

			doBasicTest("RSA", kpGen.generateKeyPair());

			byte[] encPub = Base64.decode("MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAtU6SHvIgdoeKm9CueKoR+i13I4XZAzqPV+ba" + "dnUdrTlCziTNfbGdEVSRPkrdNcQzYegj68K1gHYT755dNtKAqnJH6k6oQfH083MT0eYbTni1sf3zNOY+Ns4zIym3zMBD5VQ6pzfSk9SZys" + "bohheEkMLLg6CYq4x1sxnsS1fa7X2mubKXmxoam5t0kztXPI0v7E6iYWYfiIIvEir6421zffk0gyznfLNP1HWSptcOgNNbRFyGvPh8ZFyw" + "roNATwfQFTEZ6pf3Fw7eMlMN0eDjvVib9v2iEL2DSDZxOHYm9kPF2ETJuRRoEq6JW2AKSs3yeTf8ubEZnueqIUW6lKFEdwIDAQAB");
			byte[] encPriv = Base64.decode(" MIIEvQIBADANBgkqhkiG9w0BAQEFAASCBKcwggSjAgEAAoIBAQC1TpIe8iB2h4qb0K54qhH6LXcjhd" + "kDOo9X5tp2dR2tOULOJM19sZ0RVJE+St01xDNh6CPrwrWAdhPvnl020oCqckfqTqhB8fTzcxPR5htOeLWx/fM05j42zjMjKbfMwEPlVDqn" + "N9KT1JnKxuiGF4SQwsuDoJirjHWzGexLV9rtfaa5spebGhqbm3STO1c8jS/sTqJhZh+Igi8SKvrjbXN9+TSDLOd8s0/UdZKm1w6A01tEXI" + "a8+HxkXLCug0BPB9AVMRnql/cXDt4yUw3R4OO9WJv2/aIQvYNINnE4dib2Q8XYRMm5FGgSrolbYApKzfJ5N/y5sRme56ohRbqUoUR3AgMB" + "AAECggEAFV6j6WLXgbD7HN9tWQqOoOKv+q9hgzhpQc6TbEfkjhDEN4Dt+YUwQqUpk2KGjTpJZh5S8YxbET+ZnPIZAYexI6XhpRPNUCyBFx" + "q2uNQ63rZqkAajHlaO+a23KEtX/xmgRwz09tWlC8iQse5c5MUr2lYjX6nTpNCi5M/G4qCBzOEByjxkKCXbgaTKsgLb7ax2CoC3BUbWjQnb" + "Q2V9tRImBX92b1NF0ER0Xovy7VH0rwrQnTEkD8U6OrRs+UAX+zCzkV69BJPou47s4jSdDksy5vhteVdx+HnucEeLgpJoqixiDWofZvX7+N" + "AsGs+e74bV/vQinuY6a1ILEH3g1+rhGQKBgQD1J7sUdmbXelGUys5rERdYP9xTNuyqV38DrgPDyE8pgpwrvM5gn1cRb8Wop6xOp/vVME8F" + "u9PE65+T5nRb8zEvypi+4mGsjksI7ZsQ4VqV7G1GfTT8QKjr+gEk7t+jN2ymL6lp2x+bbSHQniPP51FDl72RsKY0Pk4Iy9aMKbxXHwKBgQ" + "C9U8mqMveT8e+ztiVwUdM2AvQSv+WNyVD5q78db5mrxur20b8UU7cyDFJoH6Y72GT/sKuL4LSAD8ZrUg5rnZWtXP63WnAlRJaMI0d7McV7" + "OwsaByJVlI/Yq3OpC8x1+Pf1jy6HJzxFVmMMllYi63CzqPwIAgnGdHP4C/p/CmEfqQKBgG6ip4LsjCziPr7vZ4haBjcFWuETAGs/YUq/1W" + "MdmtwY3XG/m0NvpVNxJbqfMNuuY7AqRP9JbKCJ1VJhxlFYxvHSdGxwrbO545L75+cOTFssf4Q4LRlJ9PHJuYp5YuO9t4KoL8Rd5z21WnVT" + "aMYClmHysNJ27grVs1G06/YFP8HxAoGAKvFjT5CJ6Wu58+g/q69Tme+njs0p8zQTgt361mFm2LiguOUwUxr99YMn+egb230kw34+GtcX+e" + "gaGGOfU7eFqLHsMIh54WoiP50M7JuIcIAe74NovUKaMgoJjPFZKfUTwQX+BrfWit+iTcuXtAn1ITsWF3bm4rWtTDjjU4d2KikCgYEA7Zwj" + "/hGL7pmbDjfBK0aG+06JPQ1LHYVXHOUxco9eB1sgJXoxBjqoJPU0j7NCrn6i3tiDtLPYNAO9ehaRLucFk8FjthrewHmZY+x+nmzkEbMbi1" + "kDTIvY4pw5jn9k5CEBAe2MSymjzfPTWV2YhuG1Lu5ibSQ+LMMbUppniD9N2pA=");
			...
			assertTrue(pubString.StartsWith("RSA Public Key [33:25:14:cc:b5:ab:65:6d:70:d3:91:2b:7f:1f:de:c4:ec:04:2f:48],[56:66:d1:a4]", StringComparison.Ordinal));
			...
			assertTrue(privString.StartsWith("RSA Private CRT Key [33:25:14:cc:b5:ab:65:6d:70:d3:91:2b:7f:1f:de:c4:ec:04:2f:48],[56:66:d1:a4]", StringComparison.Ordinal));
			...
			assertEquals(priv.GetHashCode(), privKey.GetHashCode());

			string privKeyString = privKey.ToString();

			assertTrue(privKeyString.StartsWith("RSA Private Key [33:25:14:cc:b5:ab:65:6d:70:d3:91:2b:7f:1f:de:c4:ec:04:2f:48],[]", StringComparison.Ordinal));
		...
		private void doBasicTest(string algorithm, KeyPair kp)
		{
			...
			assertEquals(kp.getPublic().GetHashCode(), pub.GetHashCode());
			assertEquals(kp.getPrivate(), priv);
			assertEquals(kp.getPrivate().GetHashCode(), priv.GetHashCode());
		}
		...
		private void doSerialisationCheck(object o)
		{
			...
			assertEquals(o, read);
			assertEquals(o.GetHashCode(), read.GetHashCode());
		}
	}
