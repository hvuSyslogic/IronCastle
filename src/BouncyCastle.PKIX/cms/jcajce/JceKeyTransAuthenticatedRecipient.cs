namespace org.bouncycastle.cms.jcajce
{
	...
	/// extract the message.
	/// </summary>
	public class JceKeyTransAuthenticatedRecipient : JceKeyTransRecipient
	{
		public JceKeyTransAuthenticatedRecipient(PrivateKey recipientKey) : base(recipientKey)
		{
		}
...
//ORIGINAL LINE: final javax.crypto.Mac dataMac = contentHelper.createContentMac(secretKey, contentMacAlgorithm);
		...
		{
			private readonly JceKeyTransAuthenticatedRecipient outerInstance;

			private AlgorithmIdentifier contentMacAlgorithm;
			private Key secretKey;
			private Mac dataMac;

			public MacCalculatorAnonymousInnerClass(JceKeyTransAuthenticatedRecipient outerInstance, AlgorithmIdentifier contentMacAlgorithm, Key secretKey, Mac dataMac)
			{
