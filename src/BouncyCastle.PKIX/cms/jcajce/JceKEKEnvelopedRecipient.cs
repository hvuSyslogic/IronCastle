namespace org.bouncycastle.cms.jcajce
{
	...
	public class JceKEKEnvelopedRecipient : JceKEKRecipient
	{
		public JceKEKEnvelopedRecipient(SecretKey recipientKey) : base(recipientKey)
		{
		}
...
//ORIGINAL LINE: final javax.crypto.Cipher dataCipher = contentHelper.createContentCipher(secretKey, contentEncryptionAlgorithm);
		...
		{
			private readonly JceKEKEnvelopedRecipient outerInstance;

			private AlgorithmIdentifier contentEncryptionAlgorithm;
			private Cipher dataCipher;

			public InputDecryptorAnonymousInnerClass(JceKEKEnvelopedRecipient outerInstance, AlgorithmIdentifier contentEncryptionAlgorithm, Cipher dataCipher)
			{
