namespace org.bouncycastle.cms.jcajce
{
	...
	public class JcaSignerId : SignerId
	{
		/// <summary>
		...
		public JcaSignerId(X509Certificate certificate) : base(convertPrincipal(certificate.getIssuerX500Principal()), certificate.getSerialNumber(), CMSUtils.getSubjectKeyId(certificate))
		{
		}
		...
		public JcaSignerId(X500Principal issuer, BigInteger serialNumber) : base(convertPrincipal(issuer), serialNumber)
		{
		}
		...
		public JcaSignerId(X500Principal issuer, BigInteger serialNumber, byte[] subjectKeyId) : base(convertPrincipal(issuer), serialNumber, subjectKeyId)
		{
		}
