namespace org.bouncycastle.mime.encoding
{
	...
	/// </summary>
	public class QuotedPrintableInputStream : FilterInputStream
	{

		public QuotedPrintableInputStream(InputStream input) : base(input)
		{
		}

		public virtual int read(byte[] buf, int bufOff, int len)
		{
			int i = 0;
			while (i != len)
			{
