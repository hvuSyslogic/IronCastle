...
namespace org.bouncycastle.cert.test
{
	...
	using X509KeyUsage = org.bouncycastle.jce.X509KeyUsage;
	...
	using BouncyCastlePQCProvider = org.bouncycastle.pqc.jcajce.provider.BouncyCastlePQCProvider;
	...
	//            JavaSystem.@out.println(cert);
		...
		public virtual void checkNameCertificate(int id, byte[] bytes)
		{
			ByteArrayInputStream bIn;
			string dump = "";
		...
		public virtual void checkSelfSignedCertificateAndKey(int id, byte[] certBytes, string sigAlgorithm, byte[] keyBytes)
		{
			ByteArrayInputStream bIn;
			string dump = "";
		...
		public virtual void checkCreation1()
		{
			...
			X509v3CertificateBuilder certGen = new JcaX509v3CertificateBuilder(builder.build(), BigInteger.valueOf(1), new DateTime(System.currentTimeMillis() - 50000), new DateTime(System.currentTimeMillis() + 50000), builder.build(), pubKey);
			...
			certGen = new JcaX509v3CertificateBuilder(builder.build(), BigInteger.valueOf(1), new DateTime(System.currentTimeMillis() - 50000)
			...
			//
			sigGen = (new JcaContentSignerBuilder("MD5WithRSAEncryption")).setProvider(BC).build(privKey);
			X509v1CertificateBuilder certGen1 = new JcaX509v1CertificateBuilder(builder.build(), BigInteger.valueOf(1), new DateTime(System.currentTimeMillis() - 50000), new DateTime(System.currentTimeMillis() + 50000), builder.build(), pubKey);
	...
	//
			...
			SubjectPublicKeyInfo pubInfo = new SubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers_Fields.rsaEncryption, DERNull.INSTANCE), new RSAPublicKey(lwPubKey.getModulus(), lwPubKey.getExponent()));
		...
		public virtual void checkCreation2()
		{
			...
			JcaX509v3CertificateBuilder certGen = new JcaX509v3CertificateBuilder(builder.build(), BigInteger.valueOf(1), new DateTime(System.currentTimeMillis() - 50000), new DateTime(System.currentTimeMillis() + 50000), builder.build(), pubKey);
			...
			JcaX509v1CertificateBuilder certGen1 = new JcaX509v1CertificateBuilder(builder.build(), BigInteger.valueOf(1), new DateTime(System.currentTimeMillis() - 50000), new DateTime(System.currentTimeMillis() + 50000), builder.build(), pubKey);
			...
			try
			{
				certGen1 = new JcaX509v1CertificateBuilder(builder.build(), BigInteger.valueOf(1), new DateTime(System.currentTimeMillis() - 50000), new DateTime(System.currentTimeMillis() + 50000), builder.build(), dudPublicKey);
		 ...
		 */
		public virtual void checkSm3WithSm2Creation()
		{
			//
			// set up the keys
			//
			...
			JcaX509v1CertificateBuilder certGen = new JcaX509v1CertificateBuilder(builder.build(), BigInteger.valueOf(1), new DateTime(System.currentTimeMillis() - 50000), new DateTime(System.currentTimeMillis() + 50000), builder.build(), pubKey);
		...
		private void checkComparison(byte[] encCert)
		{
			...
			if (bcCert.GetHashCode() != sunCert.GetHashCode())
			{
		...
		public virtual void checkCreation3()
		{
			...
			ECPrivateKeySpec privKeySpec = new ECPrivateKeySpec(new BigInteger("876300101507107567501066130761671078357010671067781776716671676178726717"), spec);

			ECPublicKeySpec pubKeySpec = new ECPublicKeySpec(curve.decodePoint(Hex.decode("025b6dc53bc61a2548ffb0f671472de6c9521a9d2d2534e65abfcbd5fe0c70")), spec);
	...
	//        }
			...
			try
			{
				...
				certGen = new JcaX509v3CertificateBuilder(builder.build(), BigInteger.valueOf(1), new DateTime(System.currentTimeMillis() - 50000), new DateTime(System.currentTimeMillis() + 50000), builder.build(), pubKey);
		...
		public virtual void checkCRLCreation4()
		{
			KeyPairGenerator kpGen = KeyPairGenerator.getInstance("RSA", BC);
		...
		public virtual void checkCRLCreation5()
		{
			KeyPairGenerator kpGen = KeyPairGenerator.getInstance("RSA", BC);
			...
			ContentSigner signer = (new JcaContentSignerBuilder("RSAPSS", new PSSParameterSpec("SHA-256", "MGF1", new MGF1ParameterSpec("SHA-256"), 20, 1))).setProvider(BC).build(pair.getPrivate());
		 ...
		 */
		public virtual void checkCreation4()
		{
			//
			// set up the keys
			//
		...
		public virtual void checkCreation5()
		{
			...
			certGen = (new JcaX509v3CertificateBuilder(builder.build(), BigInteger.valueOf(1), new DateTime(System.currentTimeMillis() - 50000), new DateTime(System.currentTimeMillis() + 50000), builder.build(), pubKey)).copyAndAddExtension(new ASN1ObjectIdentifier("2.5.29.15"), true, baseCert).copyAndAddExtension(new ASN1ObjectIdentifier("2.5.29.37"), false, baseCert);
		...
		public virtual void checkCreation6()
		{
			...
			isTrue("oid wrong", BCObjectIdentifiers_Fields.sphincs256_with_SHA512.getId().Equals(baseCert.getSigAlgOID()));
			...
			certGen = (new JcaX509v3CertificateBuilder(builder.build(), BigInteger.valueOf(1), new DateTime(System.currentTimeMillis() - 50000), new DateTime(System.currentTimeMillis() + 50000), builder.build(), nhKp.getPublic())).copyAndAddExtension(new ASN1ObjectIdentifier("2.5.29.15"), true, baseCert).copyAndAddExtension(new ASN1ObjectIdentifier("2.5.29.37"), false, baseCert);
		 ...
		 */
		public virtual void checkCreation7()
		{
			//
			// set up the keys
			//
		 ...
		 */
		public virtual void checkCreation8()
		{
			//
			// set up the keys
			//
		 ...
		 */
		public virtual void checkCreation9()
		{
			//
			// set up the keys
			//
		 ...
		 */
		public virtual void checkCreationQTESLA()
		{
			//
			// set up the keys
			//
		 ...
		 */
		public virtual void checkCreationDSA()
		{
			//
			// set up the keys
			//
			...
			string[] algs = new string[] {"SHA1WITHDSA", "DSAWITHSHA1", "SHA224WITHDSA", "SHA256WITHDSA", "SHA384WITHDSA", "SHA512WITHDSA", "SHA3-224WITHDSA", "SHA3-256WITHDSA", "SHA3-384WITHDSA", "SHA3-512WITHDSA"};

			ASN1ObjectIdentifier[] oids = new ASN1ObjectIdentifier[] {X9ObjectIdentifiers_Fields.id_dsa_with_sha1, X9ObjectIdentifiers_Fields.id_dsa_with_sha1, NISTObjectIdentifiers_Fields.dsa_with_sha224, NISTObjectIdentifiers_Fields.dsa_with_sha256, NISTObjectIdentifiers_Fields.dsa_with_sha384, NISTObjectIdentifiers_Fields.dsa_with_sha512, NISTObjectIdentifiers_Fields.id_dsa_with_sha3_224, NISTObjectIdentifiers_Fields.id_dsa_with_sha3_256, NISTObjectIdentifiers_Fields.id_dsa_with_sha3_384, NISTObjectIdentifiers_Fields.id_dsa_with_sha3_512};
		 ...
		 */
		public virtual void checkCreationRSA()
		{
			//
			// set up the keys
			//
			...
			string[] algs = new string[] {"SHA1WITHRSA", "SHA1WITHRSAENCRYPTION", "SHA224WITHRSA", "SHA224WITHRSAENCRYPTION", "SHA256WITHRSA", "SHA256WITHRSAENCRYPTION", "SHA384WITHRSA", "SHA384WITHRSAENCRYPTION", "SHA512WITHRSA", "SHA512WITHRSAENCRYPTION", "SHA3-224WITHRSA", "SHA3-224WITHRSAENCRYPTION", "SHA3-256WITHRSA", "SHA3-256WITHRSAENCRYPTION", "SHA3-384WITHRSA", "SHA3-384WITHRSAENCRYPTION", "SHA3-512WITHRSA", "SHA3-512WITHRSAENCRYPTION", "SHA1WITHRSAANDMGF1", "SHA224WITHRSAANDMGF1", "SHA256WITHRSAANDMGF1", "SHA384WITHRSAANDMGF1", "SHA512WITHRSAANDMGF1", "SHA3-224WITHRSAANDMGF1", "SHA3-256WITHRSAANDMGF1", "SHA3-384WITHRSAANDMGF1", "SHA3-512WITHRSAANDMGF1"};

			ASN1ObjectIdentifier[] oids = new ASN1ObjectIdentifier[] {PKCSObjectIdentifiers_Fields.sha1WithRSAEncryption, PKCSObjectIdentifiers_Fields.sha1WithRSAEncryption, PKCSObjectIdentifiers_Fields.sha224WithRSAEncryption, PKCSObjectIdentifiers_Fields.sha224WithRSAEncryption, PKCSObjectIdentifiers_Fields.sha256WithRSAEncryption, PKCSObjectIdentifiers_Fields.sha256WithRSAEncryption, PKCSObjectIdentifiers_Fields.sha384WithRSAEncryption, PKCSObjectIdentifiers_Fields.sha384WithRSAEncryption, PKCSObjectIdentifiers_Fields.sha512WithRSAEncryption, PKCSObjectIdentifiers_Fields.sha512WithRSAEncryption, NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_224, NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_224, NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_256, NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_256, NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_384, NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_384, NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_512, NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_512, PKCSObjectIdentifiers_Fields.id_RSASSA_PSS, PKCSObjectIdentifiers_Fields.id_RSASSA_PSS, PKCSObjectIdentifiers_Fields.id_RSASSA_PSS, PKCSObjectIdentifiers_Fields.id_RSASSA_PSS, PKCSObjectIdentifiers_Fields.id_RSASSA_PSS, PKCSObjectIdentifiers_Fields.id_RSASSA_PSS, PKCSObjectIdentifiers_Fields.id_RSASSA_PSS, PKCSObjectIdentifiers_Fields.id_RSASSA_PSS, PKCSObjectIdentifiers_Fields.id_RSASSA_PSS};
			...
			// create the certificate - version 3
			//
			ContentSigner sigGen = (new JcaContentSignerBuilder("RSAPSS", new PSSParameterSpec("SHA-256", "MGF1", new MGF1ParameterSpec("SHA-256"), 20, 1))).setProvider("BC").build(privKey);
			X509v3CertificateBuilder certGen = new JcaX509v3CertificateBuilder(builder.build(), BigInteger.valueOf(1), new DateTime(System.currentTimeMillis() - 50000), new DateTime(System.currentTimeMillis() + 50000), builder.build(), pubKey);
		 ...
		 */
		public virtual void checkCreationECDSA()
		{
			//
			// set up the keys
			//
			...
			string[] algs = new string[] {"SHA1WITHECDSA", "ECDSAWITHSHA1", "SHA224WITHECDSA", "SHA256WITHECDSA", "SHA384WITHECDSA", "SHA512WITHECDSA", "SHA3-224WITHECDSA", "SHA3-256WITHECDSA", "SHA3-384WITHECDSA", "SHA3-512WITHECDSA"};

			ASN1ObjectIdentifier[] oids = new ASN1ObjectIdentifier[] {X9ObjectIdentifiers_Fields.ecdsa_with_SHA1, X9ObjectIdentifiers_Fields.ecdsa_with_SHA1, X9ObjectIdentifiers_Fields.ecdsa_with_SHA224, X9ObjectIdentifiers_Fields.ecdsa_with_SHA256, X9ObjectIdentifiers_Fields.ecdsa_with_SHA384, X9ObjectIdentifiers_Fields.ecdsa_with_SHA512, NISTObjectIdentifiers_Fields.id_ecdsa_with_sha3_224, NISTObjectIdentifiers_Fields.id_ecdsa_with_sha3_256, NISTObjectIdentifiers_Fields.id_ecdsa_with_sha3_384, NISTObjectIdentifiers_Fields.id_ecdsa_with_sha3_512};
	...
	//            JavaSystem.@out.println(cert);
		...
		{
			return cf.generateCertificate(new ByteArrayInputStream(pemData.GetBytes(Encoding.ASCII)));
		}
		...
		private void testNullDerNullCert()
		{
			...
			Certificate @struct = Certificate.getInstance(ASN1Primitive.fromByteArray(cert.getEncoded()));
		...
		private void testDirect()
		{
			...
			X509v2CRLBuilder builder = new X509v2CRLBuilder(issuer, DateTime.Now);

			builder.addCRLEntry(certificate.getSerialNumber(), DateTime.Now, CRLReason.cACompromise);
		...
		private void testIndirect()
		{
			...
			X509v2CRLBuilder builder = new X509v2CRLBuilder(crlIssuer, DateTime.Now);
			...
			builder.addCRLEntry(certificate.getSerialNumber(), DateTime.Now, extGen.generate());
		...
		private void testIndirect2()
		{
			...
			builder.addCRLEntry(BigInteger.valueOf(100), DateTime.Now, CRLReason.cACompromise);
			builder.addCRLEntry(BigInteger.valueOf(120), DateTime.Now, CRLReason.cACompromise);
			...
			builder.addCRLEntry(BigInteger.valueOf(130), DateTime.Now, CRLReason.cACompromise);
		...
		private void zeroDataTest()
		{
			...
			{
				isTrue("no content found".Equals(e.Message));
			}
		...
		private void doSerialize(Serializable encodable)
		{
			...
			isEquals(encodable.GetHashCode(), obj.GetHashCode());
		}
		...
		public override void performTest()
		{
			...
			createECCert("SHA1withECDSA", X9ObjectIdentifiers_Fields.ecdsa_with_SHA1);
			createECCert("SHA224withECDSA", X9ObjectIdentifiers_Fields.ecdsa_with_SHA224);
			createECCert("SHA256withECDSA", X9ObjectIdentifiers_Fields.ecdsa_with_SHA256);
			createECCert("SHA384withECDSA", X9ObjectIdentifiers_Fields.ecdsa_with_SHA384);
			createECCert("SHA512withECDSA", X9ObjectIdentifiers_Fields.ecdsa_with_SHA512);
		...
		private static ASN1Primitive fromExtensionValue(byte[] encodedValue)
		{
