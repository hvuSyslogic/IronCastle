...
namespace org.bouncycastle.cert.test
{
	...
	public class BcAttrCertTest : TestCase
	{
		...
		public virtual void testCertWithBaseCertificateID()
		{
		...
		private void equalityAndHashCodeTest(X509AttributeCertificateHolder attrCert, byte[] encoding)
		{
			...
			if (attrCert2.getHolder().GetHashCode() != attrCert.getHolder().GetHashCode())
			{
			...
			if (attrCert2.getIssuer().GetHashCode() != attrCert.getIssuer().GetHashCode())
			{
		...
		public virtual void testGenerateWithCert()
		{
			...
			X509v2AttributeCertificateBuilder gen = new X509v2AttributeCertificateBuilder(new AttributeCertificateHolder(iCert), new AttributeCertificateIssuer(new X500Name("cn=test")), BigInteger.ONE, new DateTime(System.currentTimeMillis() - 50000), new DateTime(System.currentTimeMillis() + 50000));
			...
			if (!aCert.isValidOn(DateTime.Now))
			{
		...
		public virtual void testGenerateWithPrincipal()
		{
			X509CertificateHolder iCert = new X509CertificateHolder(signCert);
			...
			X509v2AttributeCertificateBuilder gen = new X509v2AttributeCertificateBuilder(new AttributeCertificateHolder(iCert.getSubject()), new AttributeCertificateIssuer(new X500Name("cn=test")), BigInteger.ONE, new DateTime(System.currentTimeMillis() - 50000), new DateTime(System.currentTimeMillis() + 50000));
		...
		public virtual void testFully()
		{
			...
			X509v2AttributeCertificateBuilder gen = new X509v2AttributeCertificateBuilder(aCert.getHolder(), aCert.getIssuer(), aCert.getSerialNumber(), new DateTime(System.currentTimeMillis() - 50000), new DateTime(System.currentTimeMillis() + 50000));
			...
			{
				JavaSystem.err.println(principal0.ToString());
