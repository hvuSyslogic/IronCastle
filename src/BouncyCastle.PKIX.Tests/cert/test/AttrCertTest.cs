...
namespace org.bouncycastle.cert.test
{
	...
	public class AttrCertTest : SimpleTest
	{
		...
		private void testGenerateWithCert()
		{
			...
			X509v2AttributeCertificateBuilder gen = new X509v2AttributeCertificateBuilder(new AttributeCertificateHolder(new JcaX509CertificateHolder(iCert)), new AttributeCertificateIssuer(new X500Name("cn=test")), BigInteger.ONE, new DateTime(System.currentTimeMillis() - 50000), new DateTime(System.currentTimeMillis() + 50000));
		...
		private void testGenerateWithPrincipal()
		{
			...
			X509v2AttributeCertificateBuilder gen = new X509v2AttributeCertificateBuilder(new AttributeCertificateHolder((new JcaX509CertificateHolder(iCert)).getSubject()), new AttributeCertificateIssuer(new X500Name("cn=test")), BigInteger.ONE, new DateTime(System.currentTimeMillis() - 50000), new DateTime(System.currentTimeMillis() + 50000));
