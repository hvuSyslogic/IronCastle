...
namespace org.bouncycastle.dvcs.test
{
	...
	using DVCSCertInfo = org.bouncycastle.asn1.dvcs.DVCSCertInfo;
	using DVCSCertInfoBuilder = org.bouncycastle.asn1.dvcs.DVCSCertInfoBuilder;
	using DVCSErrorNotice = org.bouncycastle.asn1.dvcs.DVCSErrorNotice;
	using DVCSRequest = org.bouncycastle.asn1.dvcs.DVCSRequest;
	...
	using DVCSResponse = org.bouncycastle.asn1.dvcs.DVCSResponse;
	...
	//    private static final String RESPONSE_VSD_TOMSK  = "";
		...
		private static bool areNull(string type, object result, object expected)
		{
		...
		public virtual void testParseRequests()
		{
		...
		private void testParseRequest(string name, string base64request, DVCSRequest expected)
		{
			...
			DVCSRequest request = new DVCSRequest(new CMSSignedData(requestBytes));

			validate(name, request.getContent(), expected);
		}

		public virtual void testParseResponses()
		{
		...
		private void testParseResponse(string name, string base64response, DVCSResponse expected)
		{
			...
			DVCSResponse response = new DVCSResponse(new CMSSignedData(responseBytes));
