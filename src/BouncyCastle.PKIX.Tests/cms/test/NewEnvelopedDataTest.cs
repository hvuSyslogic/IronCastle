...
namespace org.bouncycastle.cms.test
{
	...
	using JcePasswordEnvelopedRecipient = org.bouncycastle.cms.jcajce.JcePasswordEnvelopedRecipient;
	...
	using JcaAlgorithmParametersConverter = org.bouncycastle.@operator.jcajce.JcaAlgorithmParametersConverter;
	using Strings = org.bouncycastle.util.Strings;
	using Base64 = org.bouncycastle.util.encoders.Base64;
	using Hex = org.bouncycastle.util.encoders.Hex;

	public class NewEnvelopedDataTest : TestCase
	{
		...
		private byte[] tooShort3DES = Base64.decode("MIAGCSqGSIb3DQEHA6CAMIACAQAxgcQwgcECAQAwKjAlMRYwFAYDVQQKDA1C" + "b3VuY3kgQ2FzdGxlMQswCQYDVQQGEwJBVQIBCjANBgkqhkiG9w0BAQEFAASB" + "gJIM2QN0o6iv8Ux018pVCJ8js+ROV4t6+KoMwLJ4DzRKLU8XCAb9BS+crP+F" + "ghNTxTpTX8TaxPrO4wV0USgVHu2SvFnxNaWZjBDVIyZI2HR4QkSTqFMhsUB2" + "6CuZIWBZkhqQ6ruDfvn9UuBWVnfsBD4iryZ1idr713sDeVo5TyvTMIAGCSqG" + "SIb3DQEHATAUBggqhkiG9w0DBwQIQq9e4+WB3CqggAQIwU4cOlmkWUcAAAAA" + "AAAAAAAA");

		private byte[] tooShort3DESKey = Base64.decode("MIICdwIBADANBgkqhkiG9w0BAQEFAASCAmEwggJdAgEAAoGBAODZDCj0nQdV" + "f0GGeFsPjjvPx1Vem0V6IkJ4SzazGKfddk0pX58ZDCnG+S+OPiXmPDqValiu" + "9FtNy2/r9rrf/6qtcVQJkfSJv9E5Y7HgI98L/Y9lKxZWsfRqu/SlYO5zx0Dc" + "2rzDvvZRtrtaq0uuHXWJlbWda2L9S65sv/Le/zvjAgMBAAECgYEAnn+iGMTG" + "ZMMaH6Cg+t/uTa9cPougPMuplt2hd3+sY7izihUeONK5RkHiqmlE2gaAcnOd" + "McKysiIWxGC73mPEnsOObPkaFlneVb5CtjTaTMdptuLNEQkwvtKhuW2HnMra" + "4afEgFZdll3FyRpvW/CDooe4Bppjd4aGn/Sr/o9nOzECQQD4QKLwZssuclji" + "nD/8gU1CqGMMnGNogTMpHm1269HUOE7r1y3MuapUqSWsVhpuEQ8P/Tko0haJ" + "jeZn2eWTbZu/AkEA591snui8FMeGvkRgvyMFNvXZWDEjsh+N74XEL1lykTgZ" + "FQJ+cmThnrdM/8yj1dKkdASYrk5kFJ4PVE6CzDI43QJAFS22eNncJZc9u/9m" + "eg0x4SjqYk4JMQYsripZXlbZ7Mfs+7O8xYVlYZmYjC5ATPmJlmyc7r2VjKCd" + "cmilbEFikwJBAMh7yf8BaBdjitubzjeW9VxXaa37F01eQWD5PfBfHFP6uJ1V" + "AbayCfAtuHN6I7OwJih3DPmyqJC3NrQECs67IjUCQAb4TfVE/2G1s66SGnb4" + "no34BspoV/i4f0uLhJap84bTHcF/ZRSXCmQOCRGdSvQkXHeNPI5Lus6lOHuU" + "vUDbQC8=");

		// from RFC 4490

		private byte[] gost3410_RecipCert = Base64.decode("MIIB0DCCAX8CECv1xh7CEb0Xx9zUYma0LiEwCAYGKoUDAgIDMG0xHzAdBgNVBAMM" + "Fkdvc3RSMzQxMC0yMDAxIGV4YW1wbGUxEjAQBgNVBAoMCUNyeXB0b1BybzELMAkG" + "A1UEBhMCUlUxKTAnBgkqhkiG9w0BCQEWGkdvc3RSMzQxMC0yMDAxQGV4YW1wbGUu" + "Y29tMB4XDTA1MDgxNjE0MTgyMFoXDTE1MDgxNjE0MTgyMFowbTEfMB0GA1UEAwwW" + "R29zdFIzNDEwLTIwMDEgZXhhbXBsZTESMBAGA1UECgwJQ3J5cHRvUHJvMQswCQYD" + "VQQGEwJSVTEpMCcGCSqGSIb3DQEJARYaR29zdFIzNDEwLTIwMDFAZXhhbXBsZS5j" + "b20wYzAcBgYqhQMCAhMwEgYHKoUDAgIkAAYHKoUDAgIeAQNDAARAhJVodWACGkB1" + "CM0TjDGJLP3lBQN6Q1z0bSsP508yfleP68wWuZWIA9CafIWuD+SN6qa7flbHy7Df" + "D2a8yuoaYDAIBgYqhQMCAgMDQQA8L8kJRLcnqeyn1en7U23Sw6pkfEQu3u0xFkVP" + "vFQ/3cHeF26NG+xxtZPz3TaTVXdoiYkXYiD02rEx1bUcM97i");

		private byte[] gost3410_2001_KeyTrans = Base64.decode("MIIBpwYJKoZIhvcNAQcDoIIBmDCCAZQCAQAxggFTMIIBTwIBADCBgTBtMR8wHQYD" + "VQQDDBZHb3N0UjM0MTAtMjAwMSBleGFtcGxlMRIwEAYDVQQKDAlDcnlwdG9Qcm8x" + "CzAJBgNVBAYTAlJVMSkwJwYJKoZIhvcNAQkBFhpHb3N0UjM0MTAtMjAwMUBleGFt" + "cGxlLmNvbQIQK/XGHsIRvRfH3NRiZrQuITAcBgYqhQMCAhMwEgYHKoUDAgIkAAYH" + "KoUDAgIeAQSBpzCBpDAoBCBqL6ghBpVon5/kR6qey2EVK35BYLxdjfv1PSgbGJr5" + "dQQENm2Yt6B4BgcqhQMCAh8BoGMwHAYGKoUDAgITMBIGByqFAwICJAAGByqFAwIC" + "HgEDQwAEQE0rLzOQ5tyj3VUqzd/g7/sx93N+Tv+/eImKK8PNMZQESw5gSJYf28dd" + "Em/askCKd7W96vLsNMsjn5uL3Z4SwPYECJeV4ywrrSsMMDgGCSqGSIb3DQEHATAd" + "BgYqhQMCAhUwEwQIvBCLHwv/NCkGByqFAwICHwGADKqOch3uT7Mu4w+hNw==");

		private byte[] gost3410_2001_KeyAgree = Base64.decode("MIIBpAYJKoZIhvcNAQcDoIIBlTCCAZECAQIxggFQoYIBTAIBA6BloWMwHAYGKoUD" + "AgITMBIGByqFAwICJAAGByqFAwICHgEDQwAEQLNVOfRngZcrpcTZhB8n+4HtCDLm" + "mtTyAHi4/4Nk6tIdsHg8ff4DwfQG5DvMFrnF9vYZNxwXuKCqx9GhlLOlNiChCgQI" + "L/D20YZLMoowHgYGKoUDAgJgMBQGByqFAwICDQAwCQYHKoUDAgIfATCBszCBsDCB" + "gTBtMR8wHQYDVQQDDBZHb3
y0LjRhzBjMBwGBiqFAwICEzASBgcqhQMCAiQABgcqhQMCAh4BA0MA" + "BEA6Dzd7VQJA7712CfHiH4L0TVcaH+iLJ6vHkfdgAvS+8mGt/L2H9qQP7O41SgDKQqtfrr+tHDig7/ft5Bl1TFNoo4IBpTCC" + "AaEwDgYDVR0PAQH/BAQDAgH+MGMGA1UdJQRcMFoGCCsGAQUFBwMBBggrBgEFBQcDAgYIKwYBBQUHAwMGCCsGAQUFBwMEBggr" + "BgEFBQcDBQYIKwYBBQUHAwYGCCsGAQUFBwMHBggrBgEFBQcDCAYIKwYBBQUHAwkwDwYDVR0TAQH/BAUwAwEB/zAdBgNVHQ4E" + "FgQU8ZLn4r4PajaqWCwLYW6XauO3XsgwgfkGA1UdIwSB8TCB7oAU8ZLn4r4PajaqWCwLYW6XauO3Xsihgc+kgcwwgckxCzAJ" + "BgNVBAYTAlJVMSAwHgYDVQQIDBfQoS7Qn9C40YLQtdGA0LHRg9GA0LPRijEfMB0GA1UECgwW0KHQvtCy0YDQtdC80LXQvdC9" + "0LjQujEfMB0GA1UECwwW0KDRg9C60L7QstC+0LTRgdGC0LLQvjEZMBcGA1UEDAwQ0KDQtdC00LDQutGC0L7RgDE7MDkGA1UE" + "Awwy0J/Rg9GI0LrQuNC9INCQ0LvQtdC60YHQsNC90LTRgCDQodC10YDQs9C10LXQstC40YeCBETAHKcwCAYGKoUDAgIDA0EA" + "Ul4Y7XAhFUEoTUwdue+wbyxk86SpIFwC6NuVjTSIF3F9ACxfz2N6iwHaRv6GTVRIAEjj5G/rhdxRivvC8hU4QQ==");
		...
		private static void init()
		{
			if (!_initialised)
			{
				...
				_reciKemsCert = CMSTestUtil.makeCertificate(_reciKemsKP, _reciDN, _signKP, _signDN, new AlgorithmIdentifier(PKCSObjectIdentifiers_Fields.id_rsa_KEM));
			}
		}
		...
		public static Test suite()
		{
			...
			return new CMSTestSetup(new TestSuite(typeof(NewEnvelopedDataTest)));
		}
	...
	//    }
		...
		public virtual void testKeyTrans()
		{
			...
			assertTrue(collection.iterator().next() is RecipientInformation);
		}

		public virtual void testKeyTransOAEPDefault()
		{
			byte[] data = "WallaWallaWashington".GetBytes();
			...
			edGen.addRecipientInfoGenerator((new JceKeyTransRecipientInfoGenerator(_reciCert, paramsConverter.getAlgorithmIdentifier(PKCSObjectIdentifiers_Fields.id_RSAES_OAEP, OAEPParameterSpec.DEFAULT))).setProvider(BC));
			edGen.addRecipientInfoGenerator((new JceKeyTransRecipientInfoGenerator(ASN1OctetString.getInstance(ASN1OctetString.getInstance(_reciCert.getExtensionValue(Extension.subjectKeyIdentifier.getId())).getOctets()).getOctets(), paramsConverter.getAlgorithmIdentifier(PKCSObjectIdentifiers_Fields.id_RSAES_OAEP, OAEPParameterSpec.DEFAULT), _reciCert.getPublicKey())).setProvider(BC));
			...
			while (it.hasNext())
			{
				...
				assertEquals(PKCSObjectIdentifiers_Fields.id_RSAES_OAEP, recipient.getKeyEncryptionAlgorithm().getAlgorithm());
		...
		public virtual void testKeyTransOAEPSHA1()
		{
			doTestKeyTransOAEPDefaultNamed("SHA-1");
		}

		public virtual void testKeyTransOAEPSHA224()
		{
			doTestKeyTransOAEPDefaultNamed("SHA-224");
		}

		public virtual void testKeyTransOAEPSHA256()
		{
			doTestKeyTransOAEPDefaultNamed("SHA-256");
		}

		public virtual void testKeyTransOAEPSHA1AndSHA256()
		{
		...
		private void doTestKeyTransOAEPDefaultNamed(string digest, string mgfDigest)
		{
			...
			AlgorithmIdentifier oaepAlgId = paramsConverter.getAlgorithmIdentifier(PKCSObjectIdentifiers_Fields.id_RSAES_OAEP, oaepSpec);
		...
		public virtual void testKeyTransOAEPInCert()
		{
			byte[] data = "WallaWallaWashington".GetBytes();
		...
		public virtual void testKeyTransWithAlgMapping()
		{
			byte[] data = "WallaWallaWashington".GetBytes();

			CMSEnvelopedDataGenerator edGen = new CMSEnvelopedDataGenerator();

			edGen.addRecipientInfoGenerator((new JceKeyTransRecipientInfoGenerator(_reciCert)).setAlgorithmMapping(PKCSObjectIdentifiers_Fields.rsaEncryption, "RSA/2/PKCS1Padding").setProvider(BC));
			...
			while (it.hasNext())
			{
				...
				byte[] recData = recipient.getContent((new JceKeyTransEnvelopedRecipient(_reciKP.getPrivate())).setAlgorithmMapping(PKCSObjectIdentifiers_Fields.rsaEncryption, "RSA/2/PKCS1Padding").setProvider(BC));
		...
		public virtual void testOriginatorInfoGeneration()
		{
			byte[] data = "WallaWallaWashington".GetBytes();
		...
		public virtual void testKeyTransRC2bit40()
		{
		...
		public virtual void testKeyTransDESEDE3Short()
		{
			byte[] data = new byte[]{0, 1, 2, 3};
			...
			if (it.hasNext())
			{
				...
				{
					assertEquals("Expected key size for algorithm OID not found in recipient.", e.Message);
				}
		...
		public virtual void testKeyTransDESEDE3Light()
		{
			byte[] data = new byte[]{0, 1, 2, 3};
		...
		{
			tryKeyTrans(CMSAlgorithm.DES_CBC, CMSAlgorithm.DES_CBC, 8, typeof(DEROctetString));
		}

		public virtual void testKeyTransCAST5()
		{
			tryKeyTrans(CMSAlgorithm.CAST5_CBC, CMSAlgorithm.CAST5_CBC, 16, typeof(ASN1Sequence));
		}
		...
		public virtual void testKeyTransSEED()
		{
			tryKeyTrans(CMSAlgorithm.SEED_CBC, KISAObjectIdentifiers_Fields.id_seedCBC, 16, typeof(DEROctetString));
		}

		public virtual void testKeyTransCamellia128()
		{
			tryKeyTrans(CMSAlgorithm.CAMELLIA128_CBC, NTTObjectIdentifiers_Fields.id_camellia128_cbc, 16, typeof(DEROctetString));
		}

		public virtual void testKeyTransCamellia192()
		{
			tryKeyTrans(CMSAlgorithm.CAMELLIA192_CBC, NTTObjectIdentifiers_Fields.id_camellia192_cbc, 24, typeof(DEROctetString));
		}

		public virtual void testKeyTransCamellia256()
		{
			tryKeyTrans(CMSAlgorithm.CAMELLIA256_CBC, NTTObjectIdentifiers_Fields.id_camellia256_cbc, 32, typeof(DEROctetString));
		}
		...
		private void tryKeyTrans(ASN1ObjectIdentifier generatorOID, ASN1ObjectIdentifier checkOID, int keySize, Class asn1Params)
		{
			...
			if (asn1Params != null)
			{
				...
				assertTrue(asn1Params.isAssignableFrom(aIn.readObject().GetType()));
			}
		...
		public virtual void testErroneousKEK()
		{
			byte[] data = "WallaWallaWashington".GetBytes();
			...
			if (it.hasNext())
			{
				...
				assertEquals(recipient.getKeyEncryptionAlgOID(), NISTObjectIdentifiers_Fields.id_aes128_wrap.getId());
		...
		{
			tryKekAlgorithm(CMSTestUtil.makeAESKey(128), NISTObjectIdentifiers_Fields.id_aes128_wrap);

			tryKekAlgorithmAEAD(CMSTestUtil.makeAESKey(128), NISTObjectIdentifiers_Fields.id_aes128_wrap, CMSAlgorithm.AES128_GCM, NISTObjectIdentifiers_Fields.id_aes128_GCM);
			tryKekAlgorithmAEAD(CMSTestUtil.makeAESKey(128), NISTObjectIdentifiers_Fields.id_aes128_wrap, CMSAlgorithm.AES192_GCM, NISTObjectIdentifiers_Fields.id_aes192_GCM);
			tryKekAlgorithmAEAD(CMSTestUtil.makeAESKey(128), NISTObjectIdentifiers_Fields.id_aes128_wrap, CMSAlgorithm.AES256_GCM, NISTObjectIdentifiers_Fields.id_aes256_GCM);

			byte[] nonce = Hex.decode("0102030405060708090a0b0c");
			tryKekAlgorithmAEAD(CMSTestUtil.makeAESKey(128), NISTObjectIdentifiers_Fields.id_aes128_wrap, CMSAlgorithm.AES128_GCM, NISTObjectIdentifiers_Fields.id_aes128_GCM, (new GCMParameters(nonce, 11)).getEncoded());

			tryKekAlgorithmAEAD(CMSTestUtil.makeAESKey(128), NISTObjectIdentifiers_Fields.id_aes128_wrap, CMSAlgorithm.AES128_CCM, NISTObjectIdentifiers_Fields.id_aes128_CCM);
			tryKekAlgorithmAEAD(CMSTestUtil.makeAESKey(128), NISTObjectIdentifiers_Fields.id_aes128_wrap, CMSAlgorithm.AES192_CCM, NISTObjectIdentifiers_Fields.id_aes192_CCM);
			tryKekAlgorithmAEAD(CMSTestUtil.makeAESKey(128), NISTObjectIdentifiers_Fields.id_aes128_wrap, CMSAlgorithm.AES256_CCM, NISTObjectIdentifiers_Fields.id_aes256_CCM);

			tryKekAlgorithmAEAD(CMSTestUtil.makeAESKey(128), NISTObjectIdentifiers_Fields.id_aes128_wrap, CMSAlgorithm.AES128_CCM, NISTObjectIdentifiers_Fields.id_aes128_CCM, (new CCMParameters(nonce, 13)).getEncoded());
		}

		public virtual void testAES192KEK()
		{
			tryKekAlgorithm(CMSTestUtil.makeAESKey(192), NISTObjectIdentifiers_Fields.id_aes192_wrap);
		}

		public virtual void testAES256KEK()
		{
			tryKekAlgorithm(CMSTestUtil.makeAESKey(256), NISTObjectIdentifiers_Fields.id_aes256_wrap);
		}

		public virtual void testSEED128KEK()
		{
			tryKekAlgorithm(CMSTestUtil.makeSEEDKey(), KISAObjectIdentifiers_Fields.id_npki_app_cmsSeed_wrap);
		}

		public virtual void testCamellia128KEK()
		{
			tryKekAlgorithm(CMSTestUtil.makeCamelliaKey(128), NTTObjectIdentifiers_Fields.id_camellia128_wrap);
		}

		public virtual void testCamellia192KEK()
		{
			tryKekAlgorithm(CMSTestUtil.makeCamelliaKey(192), NTTObjectIdentifiers_Fields.id_camellia192_wrap);
		}

		public virtual void testCamellia256KEK()
		{
			tryKekAlgorithm(CMSTestUtil.makeCamelliaKey(256), NTTObjectIdentifiers_Fields.id_camellia256_wrap);
		}
		...
		private void tryKekAlgorithmAEAD(SecretKey kek, ASN1ObjectIdentifier algOid, ASN1ObjectIdentifier aeadAlgorithm, ASN1ObjectIdentifier baseOID)
		{
			...
			CMSEnvelopedData ed = edGen.generate(new CMSProcessableByteArray(data), (new JceCMSContentEncryptorBuilder(aeadAlgorithm)).setProvider(BC).build());
		...
		private void tryKekAlgorithmAEAD(SecretKey kek, ASN1ObjectIdentifier algOid, ASN1ObjectIdentifier aeadAlgorithm, ASN1ObjectIdentifier baseOID, byte[] encodedParameters)
		{
			...
			CMSEnvelopedData ed = edGen.generate(new CMSProcessableByteArray(data), (new JceCMSContentEncryptorBuilder(aeadAlgorithm)).setProvider(BC).setAlgorithmParameters(algParams).build());
		...
		private void checkAlteredMAC(SecretKey kek, ASN1ObjectIdentifier algOid, byte[] edData)
		{
			...
			eInfo.getEncryptedContent().getOctets()[10] ^= unchecked((byte)0xff);
		...
		public virtual void testFaultyAgreementRecipient()
		{
			...
			edGen.addRecipientInfoGenerator((new JceKeyAgreeRecipientInfoGenerator(algorithm, _origEcKP.getPrivate(), _origEcKP.getPublic(), CMSAlgorithm.AES128_WRAP)).setProvider(BC));

			try
			{
				edGen.generate(new CMSProcessableByteArray(data), (new JceCMSContentEncryptorBuilder(CMSAlgorithm.AES128_CBC)).setProvider(BC).build());
			}
			catch (CMSException e)
			{
				assertEquals(e.Message, "No recipients associated with generator - use addRecipient()");
			}
		}

		public virtual void testKeyWrapAlgorithmIdentifiers()
		{
			byte[] data = Hex.decode("504b492d4320434d5320456e76656c6f706564446174612053616d706c65");
		...
		private void doVerifyKeyWrap(byte[] data, ASN1ObjectIdentifier wrapAlgorithm, bool paramsAbsent)
		{
			CMSEnvelopedDataGenerator edGen = new CMSEnvelopedDataGenerator();

			edGen.addRecipientInfoGenerator((new JceKeyAgreeRecipientInfoGenerator(CMSAlgorithm.ECDH_SHA256KDF, _origEcKP.getPrivate(), _origEcKP.getPublic(), wrapAlgorithm)).addRecipient(_reciEcCert).setProvider(BC));
		...
		public virtual void testEphemeralStaticDHAgreement()
		{
			byte[] data = Hex.decode("504b492d4320434d5320456e76656c6f706564446174612053616d706c65");

			CMSEnvelopedDataGenerator edGen = new CMSEnvelopedDataGenerator();

			edGen.addRecipientInfoGenerator((new JceKeyAgreeRecipientInfoGenerator(PKCSObjectIdentifiers_Fields.id_alg_ESDH, _origDhKP.getPrivate(), _origDhKP.getPublic(), CMSAlgorithm.AES128_WRAP)).addRecipient(_reciDhCert).setProvider(BC));
		...
		public virtual void testStaticStaticDHAgreement()
		{
			byte[] data = Hex.decode("504b492d4320434d5320456e76656c6f706564446174612053616d706c65");

			CMSEnvelopedDataGenerator edGen = new CMSEnvelopedDataGenerator();

			edGen.addRecipientInfoGenerator(new JceKeyAgreeRecipientInfoGenerator(PKCSObjectIdentifiers_Fields.id_alg_SSDH, _origDhKP.getPrivate(), _origDhKP.getPublic(), CMSAlgorithm.AES128_WRAP)
				.setUserKeyingMaterial(data).addRecipient(_reciDhCert).setProvider(BC));
			...
			try
			{
				...
				edGen.addRecipientInfoGenerator((new JceKeyAgreeRecipientInfoGenerator(PKCSObjectIdentifiers_Fields.id_alg_SSDH, _origDhKP.getPrivate(), _origDhKP.getPublic(), CMSAlgorithm.AES128_WRAP)).addRecipient(_reciDhCert).setProvider(BC));
			...
			{
				Assert.assertEquals("User keying material must be set for static keys.", e.Message);
			}
		}
		...
		public virtual void testPasswordAES256WithPRF()
		{
			passwordUTF8Test(CMSEnvelopedDataGenerator.AES256_CBC, PasswordRecipient_PRF.HMacSHA1);
			passwordUTF8Test(CMSEnvelopedDataGenerator.AES256_CBC, PasswordRecipient_PRF.HMacSHA224);
			passwordUTF8Test(CMSEnvelopedDataGenerator.AES256_CBC, PasswordRecipient_PRF.HMacSHA256);
			passwordUTF8Test(CMSEnvelopedDataGenerator.AES256_CBC, PasswordRecipient_PRF.HMacSHA384);
			passwordUTF8Test(CMSEnvelopedDataGenerator.AES256_CBC, PasswordRecipient_PRF.HMacSHA512);
		}

		public virtual void testNoSaltOrIterationCount()
		{
			byte[] data = Hex.decode("504b492d4320434d5320456e76656c6f706564446174612053616d706c65");

			CMSEnvelopedDataGenerator edGen = new CMSEnvelopedDataGenerator();

			edGen.addRecipientInfoGenerator((new JcePasswordRecipientInfoGenerator(CMSAlgorithm.AES256_CBC, "abc\u5639\u563b".ToCharArray())).setProvider(BC).setPRF(PasswordRecipient_PRF.HMacSHA1));
			...
			if (it.hasNext())
			{
				...
				assertEquals(PBKDF2Params.getInstance(recipient.getKeyDerivationAlgorithm().getParameters()).getPrf(), PasswordRecipient_PRF.HMacSHA1.getAlgorithmID());
		...
		public virtual void testOpenSSLVectors()
		{
			byte[] expected = Strings.toByteArray("abcdefghijklmnopqrstuvwxyz0123456789\r\n");

			PEMParser pemParser = new PEMParser(new InputStreamReader(this.GetType().getResourceAsStream("ecdh/ecc.key")));
			...
			pemParser = new PEMParser(new InputStreamReader(this.GetType().getResourceAsStream("ecdh/ecc.crt")));
			...
			processInput(ecKey, expected, "ecdh/encSess1.asc", new AlgorithmIdentifier(PKCSObjectIdentifiers_Fields.id_alg_CMS3DESwrap, DERNull.INSTANCE));
			processInput(ecKey, expected, "ecdh/encSess2.asc", new AlgorithmIdentifier(PKCSObjectIdentifiers_Fields.id_alg_CMS3DESwrap, DERNull.INSTANCE));
			...
			processInput(ecKey, expected, "ecdh/encSessA.asc", new AlgorithmIdentifier(PKCSObjectIdentifiers_Fields.id_alg_CMS3DESwrap, DERNull.INSTANCE));
			processInput(ecKey, expected, "ecdh/encSessB.asc", new AlgorithmIdentifier(PKCSObjectIdentifiers_Fields.id_alg_CMS3DESwrap, DERNull.INSTANCE));
		...
		public virtual void testGost3410_2012_KeyTransGen()
		{
			...
			X509Certificate cert = (X509Certificate)CertificateFactory.getInstance("X.509", "BC").generateCertificate(new ByteArrayInputStream(gost2012_512_Reci_Cert));
			...
			assertEquals(ed.getEncryptionAlgOID(), CryptoProObjectIdentifiers_Fields.gostR28147_gcfb.getId());
			...
			Iterator it = c.iterator();
			 ...
			 while (it.hasNext())
			 {
				 ...
				 assertEquals(recipient.getKeyEncryptionAlgOID(), RosstandartObjectIdentifiers_Fields.id_tc26_gost_3410_12_512.getId());
		...
		public virtual void testGost3410_2001_KeyTrans()
		{
			KeyFactory keyFact = KeyFactory.getInstance("ECGOST3410", BC);

			PrivateKey privKey = keyFact.generatePrivate(new ECPrivateKeySpec(new BigInteger("0B293BE050D0082BDAE785631A6BAB68F35B42786D6DDA56AFAF169891040F77", 16), ECGOST3410NamedCurveTable.getParameterSpec("GostR3410-2001-CryptoPro-XchA")));
			...
			while (it.hasNext())
			{
				...
				assertEquals(recipient.getKeyEncryptionAlgOID(), CryptoProObjectIdentifiers_Fields.gostR3410_2001.getId());
		...
		public virtual void testGost3410_2012_KeyTrans()
		{
			KeyFactory keyFact = KeyFactory.getInstance("ECGOST3410-2012", BC);
			...
			while (it.hasNext())
			{
				...
				assertEquals(recipient.getKeyEncryptionAlgOID(), RosstandartObjectIdentifiers_Fields.id_tc26_gost_3410_12_256.getId());
		...
		public virtual void testGost3410_2001_KeyAgree()
		{
			KeyFactory keyFact = KeyFactory.getInstance("ECGOST3410", BC);
			...
			while (it.hasNext())
			{
				...
				assertEquals(recipient.getKeyEncryptionAlgOID(), CryptoProObjectIdentifiers_Fields.gostR3410_2001_CryptoPro_ESDH.getId());
		...
		public virtual void testGost3410_2001_KeyTransRand()
		{
			KeyFactory keyFact = KeyFactory.getInstance("ECGOST3410", BC);
		...
		public virtual void testGost3410_2001_KeyAgreeRand()
		{
			KeyFactory keyFact = KeyFactory.getInstance("ECGOST3410", BC);
		...
		public virtual void testGost3410_2012_KeyAgree()
		{
			KeyFactory keyFact = KeyFactory.getInstance("ECGOST3410-2012", BC);
			...
			while (it.hasNext())
			{
				...
				assertEquals(recipient.getKeyEncryptionAlgOID(), RosstandartObjectIdentifiers_Fields.id_tc26_agreement_gost_3410_12_256.getId());
		...
		public virtual void testGost3410_2012_512_KeyAgree()
		{
			KeyFactory keyFact = KeyFactory.getInstance("ECGOST3410-2012", BC);
			...
			while (it.hasNext())
			{
				...
				assertEquals(recipient.getKeyEncryptionAlgOID(), RosstandartObjectIdentifiers_Fields.id_tc26_agreement_gost_3410_12_512.getId());
		...
		public virtual void testGost3410_2001_KeyAgree_Creation()
		{
			...
			JceKeyAgreeRecipientInfoGenerator recipientGenerator = (new JceKeyAgreeRecipientInfoGenerator(CMSAlgorithm.ECDHGOST3410_2012_256, senderKey, senderCert.getPublicKey(), CMSAlgorithm.GOST28147_CRYPTOPRO_WRAP)).setProvider(BC);
			...
			CMSEnvelopedData ed = edGen.generate(new CMSProcessableByteArray(data), (new JceCMSContentEncryptorBuilder(CMSAlgorithm.GOST28147_GCFB)).setProvider(BC).build());
		...
		public virtual void testGost3410_2012_256_KeyAgree_Creation()
		{
			SecureRandom random = new SecureRandom();
			CertificateFactory certFact = CertificateFactory.getInstance("X.509", BC);
		...
		public virtual void testGost3410_2012_512_KeyAgree_Creation()
		{
			SecureRandom random = new SecureRandom();
			CertificateFactory certFact = CertificateFactory.getInstance("X.509", BC);
			...
			JceKeyAgreeRecipientInfoGenerator recipientGenerator = (new JceKeyAgreeRecipientInfoGenerator(CMSAlgorithm.ECDHGOST3410_2012_512, senderKey, senderCert.getPublicKey(), CMSAlgorithm.GOST28147_CRYPTOPRO_WRAP)).setProvider(BC);
		...
		{
			PEMParser pemParser;
			pemParser = new PEMParser(new InputStreamReader(this.GetType().getResourceAsStream(input)));
		...
		private void passwordTest(string algorithm)
		{
			...
			edGen.addRecipientInfoGenerator((new JcePasswordRecipientInfoGenerator(new ASN1ObjectIdentifier(algorithm), "password".ToCharArray())).setProvider(BC).setPasswordConversionScheme(PasswordRecipient_Fields.PKCS5_SCHEME2).setSaltAndIterationCount(new byte[20], 5));
			...
			if (it.hasNext())
			{
				...
				byte[] recData = recipient.getContent((new JcePasswordEnvelopedRecipient("password".ToCharArray())).setPasswordConversionScheme(PasswordRecipient_Fields.PKCS5_SCHEME2).setProvider(BC));
		...
		private void passwordUTF8Test(string algorithm, PasswordRecipient_PRF prf)
		{
			byte[] data = Hex.decode("504b492d4320434d5320456e76656c6f706564446174612053616d706c65");
			...
			ed = edGen.generate(new CMSProcessableByteArray(data), (new JceCMSContentEncryptorBuilder(CMSAlgorithm.AES128_CBC)).setProvider(BC).build());
