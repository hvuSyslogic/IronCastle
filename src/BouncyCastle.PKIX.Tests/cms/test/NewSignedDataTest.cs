...
namespace org.bouncycastle.cms.test
{
	...
	using ASN1ApplicationSpecific = org.bouncycastle.asn1.ASN1ApplicationSpecific;
	...
	using BcRSASignerInfoVerifierBuilder = org.bouncycastle.cms.bc.BcRSASignerInfoVerifierBuilder;
	...
	public class NewSignedDataTest : TestCase
	{
		...
		public NewSignedDataTest(string name) : base(name)
		{
		}
		...
		public static void Main(string[] args)
		{
			...
			junit.textui.TestRunner.run(typeof(NewSignedDataTest));
		}
		...
		public static Test suite()
		{
			...
			return new CMSTestSetup(new TestSuite(typeof(NewSignedDataTest)));
		}
		...
		public virtual void testDetachedVerification()
		{
		...
		public virtual void testEmptyContent()
		{
			...
			{
				assertEquals("No content found.", e.Message);
			}
		...
		public virtual void testSHA1AndMD5WithRSAEncapsulatedRepeated()
		{
			List certList = new ArrayList();
		...
		public virtual void testSHA1WithRSANoAttributesSimple()
		{
			List certList = new ArrayList();
			CMSTypedData msg = new CMSProcessableByteArray("Hello world!".GetBytes());
		...
		public virtual void testSHA1WithRSAAndOtherRevocation()
		{
			...
			Store dataOtherInfo = s.getOtherRevocationInfo(CMSObjectIdentifiers_Fields.id_ri_ocsp_response);
		...
		public virtual void testSHA1WithRSAAndAttributeTableSimple()
		{
			MessageDigest md = MessageDigest.getInstance("SHA1", BC);
			List certList = new ArrayList();
			CMSTypedData msg = new CMSProcessableByteArray("Hello world!".GetBytes());
			...
			Attribute attr = new Attribute(CMSAttributes_Fields.messageDigest, new DERSet(new DEROctetString(md.digest("Hello world!".GetBytes()))));
		...
		public virtual void testCMSAlgorithmProtection()
		{
			...
			SignerInfo sInew = new SignerInfo(sI.getSID(), new AlgorithmIdentifier(TeleTrusTObjectIdentifiers_Fields.ripemd128, DERNull.INSTANCE), sI.getAuthenticatedAttributes(), sI.getDigestEncryptionAlgorithm(), sI.getEncryptedDigest(), sI.getUnauthenticatedAttributes());
			...
			sInew = new SignerInfo(sI.getSID(), sI.getDigestAlgorithm(), sI.getAuthenticatedAttributes(), new AlgorithmIdentifier(PKCSObjectIdentifiers_Fields.id_RSASSA_PSS), sI.getEncryptedDigest(), sI.getUnauthenticatedAttributes());
		...
		{
			return new CMSSignedData(new ContentInfo(CMSObjectIdentifiers_Fields.signedData, new SignedData(sd.getDigestAlgorithms(), sd.getEncapContentInfo(), sd.getCertificates(), sd.getCRLs(), new DERSet(sI))));
		}

		private void verifySignatures(CMSSignedData s, bool shouldPass, string message)
		{
			Store certStore = s.getCertificates();
			SignerInformationStore signers = s.getSignerInfos();
		...
		public virtual void testSHA1WithRSAAndAttributeTable()
		{
			MessageDigest md = MessageDigest.getInstance("SHA1", BC);
			List certList = new ArrayList();
			CMSTypedData msg = new CMSProcessableByteArray("Hello world!".GetBytes());
		...
		public virtual void testRemoveAttribute()
		{
			...
			builder.setSignedAttributeGenerator(new CMSAttributeTableGeneratorAnonymousInnerClass(this));
			...
			// for JDK1.4 build
			Assert.assertNull(((SignerInformation)s.getSignerInfos().iterator().next()).getSignedAttributes().get(CMSAttributes_Fields.cmsAlgorithmProtect));
		...
		{
			private readonly NewSignedDataTest outerInstance;

			public CMSAttributeTableGeneratorAnonymousInnerClass(NewSignedDataTest outerInstance)
			{
			...
			public AttributeTable getAttributes(Map parameters)
			{
				...
				return table.remove(CMSAttributes_Fields.cmsAlgorithmProtect);
			}
		}

		public virtual void testSignerInformationExtension()
		{
			List certList = new ArrayList();
			CMSTypedData msg = new CMSProcessableByteArray("Hello world!".GetBytes());
			...
			while (it.hasNext())
			{
				...
				assertEquals(false, (new MyWrongSignerInformation(this, signer)).verify(verifier));

				MyRightSignerInformation rSigner = new MyRightSignerInformation(this, signer);
		...
		public class MyWrongSignerInformation : SignerInformation
		{
			private readonly NewSignedDataTest outerInstance;

			public MyWrongSignerInformation(NewSignedDataTest outerInstance, SignerInformation baseInfo) : base(baseInfo)
			{
				this.outerInstance = outerInstance;
			}
			...
			{
				return new byte[signedAttributeSet.getEncoded(ASN1Encoding_Fields.DL).Length];
			}
		}

		public class MyRightSignerInformation : SignerInformation
		{
			private readonly NewSignedDataTest outerInstance;

			internal bool used;

			public MyRightSignerInformation(NewSignedDataTest outerInstance, SignerInformation baseInfo) : base(baseInfo)
			{
				this.outerInstance = outerInstance;
			}
			...
			{
				used = true;
				return signedAttributeSet.getEncoded(ASN1Encoding_Fields.DL);
			}
		}

		public virtual void testRawSHA256MissingNull()
		{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final byte[] document = getInput("rawsha256nonull.p7m");
			byte[] document = getInput("rawsha256nonull.p7m");

//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.bouncycastle.cms.CMSSignedData s = new org.bouncycastle.cms.CMSSignedData(document);
			CMSSignedData s = new CMSSignedData(document);

//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.bouncycastle.util.Store certStore = s.getCertificates();
			Store certStore = s.getCertificates();
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.bouncycastle.cms.SignerInformation signerInformation = (org.bouncycastle.cms.SignerInformation)s.getSignerInfos().getSigners().iterator().next();
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.bouncycastle.cms.SignerInformationVerifier signerInformationVerifier = new org.bouncycastle.cms.jcajce.JcaSimpleSignerInfoVerifierBuilder().setProvider("BC").build(cert.getPublicKey());
		...
		public virtual void testLwSHA1WithRSAAndAttributeTable()
		{
			MessageDigest md = MessageDigest.getInstance("SHA1", BC);
			List certList = new ArrayList();
			CMSTypedData msg = new CMSProcessableByteArray("Hello world!".GetBytes());
			...
			gen.addSignerInfoGenerator(new SignerInfoGeneratorBuilder(new BcDigestCalculatorProvider())
					.setSignedAttributeGenerator(new DefaultSignedAttributeTableGenerator(new AttributeTable(v))).build(contentSignerBuilder.build(privKey), new JcaX509CertificateHolder(_origCert)));
		...
		public virtual void testLwSHA3_256WithRSAAndAttributeTable()
		{
		...
		public virtual void testSHA3_224WithRSAPSS()
		{
			rsaPSSTest("SHA3-224withRSAandMGF1");
		}

		public virtual void testSHA3_256WithRSAPSS()
		{
			rsaPSSTest("SHA3-256withRSAandMGF1");
		}

		public virtual void testSHA3_384WithRSAPSS()
		{
			rsaPSSTest("SHA3-384withRSAandMGF1");
		}

		public virtual void testSHA3_224WithDSAEncapsulated()
		{
			encapsulatedTest(_signDsaKP, _signDsaCert, "SHA3-224withDSA", NISTObjectIdentifiers_Fields.id_dsa_with_sha3_224);
		}

		public virtual void testSHA3_256WithDSAEncapsulated()
		{
			encapsulatedTest(_signDsaKP, _signDsaCert, "SHA3-256withDSA", NISTObjectIdentifiers_Fields.id_dsa_with_sha3_256);
		}

		public virtual void testSHA3_384WithDSAEncapsulated()
		{
			encapsulatedTest(_signDsaKP, _signDsaCert, "SHA3-384withDSA", NISTObjectIdentifiers_Fields.id_dsa_with_sha3_384);
		}

		public virtual void testSHA3_512WithDSAEncapsulated()
		{
			encapsulatedTest(_signDsaKP, _signDsaCert, "SHA3-512withDSA", NISTObjectIdentifiers_Fields.id_dsa_with_sha3_512);
		}

		// RFC 5754 update
		public virtual void testSHA224WithRSAEncapsulated()
		{
			encapsulatedTest(_signKP, _signCert, "SHA224withRSA", PKCSObjectIdentifiers_Fields.sha224WithRSAEncryption);
		}

		// RFC 5754 update
		public virtual void testSHA256WithRSAEncapsulated()
		{
			encapsulatedTest(_signKP, _signCert, "SHA256withRSA", PKCSObjectIdentifiers_Fields.sha256WithRSAEncryption);
		}

		public virtual void testSHA3_224WithRSAEncapsulated()
		{
			encapsulatedTest(_signKP, _signCert, "SHA3-224withRSA", NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_224);
		}

		public virtual void testSHA3_256WithRSAEncapsulated()
		{
			encapsulatedTest(_signKP, _signCert, "SHA3-256withRSA", NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_256);
		}

		public virtual void testSHA3_384WithRSAEncapsulated()
		{
			encapsulatedTest(_signKP, _signCert, "SHA3-384withRSA", NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_384);
		}

		public virtual void testSHA3_512WithRSAEncapsulated()
		{
			encapsulatedTest(_signKP, _signCert, "SHA3-512withRSA", NISTObjectIdentifiers_Fields.id_rsassa_pkcs1_v1_5_with_sha3_512);
		}

		public virtual void testRIPEMD128WithRSAEncapsulated()
		{
			encapsulatedTest(_signKP, _signCert, "RIPEMD128withRSA");
		}

		public virtual void testRIPEMD160WithRSAEncapsulated()
		{
			encapsulatedTest(_signKP, _signCert, "RIPEMD160withRSA");
		}

		public virtual void testRIPEMD256WithRSAEncapsulated()
		{
			encapsulatedTest(_signKP, _signCert, "RIPEMD256withRSA");
		}

		public virtual void testECDSAEncapsulated()
		{
			encapsulatedTest(_signEcDsaKP, _signEcDsaCert, "SHA1withECDSA");
		}

		public virtual void testECDSAEncapsulatedSubjectKeyID()
		{
			subjectKeyIDTest(_signEcDsaKP, _signEcDsaCert, "SHA1withECDSA");
		}

		public virtual void testECDSASHA224Encapsulated()
		{
			encapsulatedTest(_signEcDsaKP, _signEcDsaCert, "SHA224withECDSA");
		}

		public virtual void testECDSASHA256Encapsulated()
		{
			encapsulatedTest(_signEcDsaKP, _signEcDsaCert, "SHA256withECDSA");
		}

		public virtual void testECDSASHA384Encapsulated()
		{
			encapsulatedTest(_signEcDsaKP, _signEcDsaCert, "SHA384withECDSA");
		}

		public virtual void testECDSASHA512Encapsulated()
		{
			encapsulatedTest(_signEcDsaKP, _signEcDsaCert, "SHA512withECDSA");
		}

		public virtual void testECDSASHA3_224Encapsulated()
		{
			encapsulatedTest(_signEcDsaKP, _signEcDsaCert, "SHA3-224withECDSA");
		}

		public virtual void testECDSASHA3_256Encapsulated()
		{
			encapsulatedTest(_signEcDsaKP, _signEcDsaCert, "SHA3-256withECDSA");
		}

		public virtual void testECDSASHA3_384Encapsulated()
		{
			encapsulatedTest(_signEcDsaKP, _signEcDsaCert, "SHA3-384withECDSA");
		}

		public virtual void testECDSASHA3_512Encapsulated()
		{
			encapsulatedTest(_signEcDsaKP, _signEcDsaCert, "SHA3-512withECDSA");
		}

		public virtual void testECDSASHA512EncapsulatedWithKeyFactoryAsEC()
		{
		...
		public virtual void testDSAEncapsulated()
		{
			encapsulatedTest(_signDsaKP, _signDsaCert, "SHA1withDSA");
		}

		public virtual void testDSAEncapsulatedSubjectKeyID()
		{
			subjectKeyIDTest(_signDsaKP, _signDsaCert, "SHA1withDSA");
		}

		public virtual void testGOST3411WithGOST3410Encapsulated()
		{
			encapsulatedTest(_signGostKP, _signGostCert, "GOST3411withGOST3410");
		}

		public virtual void testGOST3411WithECGOST3410Encapsulated()
		{
			encapsulatedTest(_signEcGostKP, _signEcGostCert, "GOST3411withECGOST3410");
		}

		public virtual void testGostNoAttributesEncapsulated()
		{
		...
		public virtual void testSHA1WithRSACounterSignature()
		{
			List certList = new ArrayList();
			...
			while (it.hasNext())
			{
				...
				assertNull(cSigner.getSignedAttributes().get(PKCSObjectIdentifiers_Fields.pkcs_9_at_contentType));
				assertEquals(true, cSigner.verify((new JcaSimpleSignerInfoVerifierBuilder()).setProvider(BC).build(cert)));
			}
		}

		public virtual void testSHA1WithRSACounterSignatureAndVerifierProvider()
		{
			List certList = new ArrayList();
			List crlList = new ArrayList();
			CMSTypedData msg = new CMSProcessableByteArray("Hello World!".GetBytes());
			...
			SignerInformationVerifierProvider vProv = new SignerInformationVerifierProviderAnonymousInnerClass(this);
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.bouncycastle.cms.SignerInformation signer1 = org.bouncycastle.cms.SignerInformation.addCounterSigners(origSigner, counterSigners);
			...
			vProv = new SignerInformationVerifierProviderAnonymousInnerClass2(this);
		...
		public class SignerInformationVerifierProviderAnonymousInnerClass : SignerInformationVerifierProvider
		{
			...
			public SignerInformationVerifierProviderAnonymousInnerClass(NewSignedDataTest outerInstance)
			{
				this.outerInstance = outerInstance;
			}
		...
		public class SignerInformationVerifierProviderAnonymousInnerClass2 : SignerInformationVerifierProvider
		{
			...
			public SignerInformationVerifierProviderAnonymousInnerClass2(NewSignedDataTest outerInstance)
			{
				this.outerInstance = outerInstance;
			}
		...
		private void subjectKeyIDTest(KeyPair signaturePair, X509Certificate signatureCert, string signatureAlgorithm)
		{
			List certList = new ArrayList();
			List crlList = new ArrayList();
			CMSTypedData msg = new CMSProcessableByteArray("Hello World!".GetBytes());
		...
		private void encapsulatedTest(KeyPair signaturePair, X509Certificate signatureCert, string signatureAlgorithm)
		{
			encapsulatedTest(signaturePair, signatureCert, signatureAlgorithm, null);
		}

		private void encapsulatedTest(KeyPair signaturePair, X509Certificate signatureCert, string signatureAlgorithm, ASN1ObjectIdentifier sigAlgOid)
		{
			List certList = new ArrayList();
			List crlList = new ArrayList();
			CMSTypedData msg = new CMSProcessableByteArray("Hello World!".GetBytes());
			...
			assertTrue(collection.iterator().next() is SignerInformation);
		...
		//
		private void checkSignerStoreReplacement(CMSSignedData orig, SignerInformationStore signers)
		{
		...
		public virtual void testUnsortedAttributes()
		{
		...
		public virtual void testNullContentWithSigner()
		{
			List certList = new ArrayList();
		...
		public virtual void testEncapsulatedSamples()
		{
		...
		public virtual void testNoAttrEncapsulatedSample()
		{
		...
		public virtual void testCounterSig()
		{
		...
		public virtual void testForMultipleCounterSignatures()
		{
		...
		public class TestCMSSignatureAlgorithmNameGenerator : DefaultCMSSignatureAlgorithmNameGenerator
		{
			private readonly NewSignedDataTest outerInstance;

			public TestCMSSignatureAlgorithmNameGenerator(NewSignedDataTest outerInstance)
			{
				this.outerInstance = outerInstance;
			}

			public virtual void setDigestAlgorithmMapping(ASN1ObjectIdentifier oid, string algName)
			{
				base.setSigningDigestAlgorithmMapping(oid, algName);
			}

			public virtual void setEncryptionAlgorithmMapping(ASN1ObjectIdentifier oid, string algName)
			{
				base.setSigningEncryptionAlgorithmMapping(oid, algName);
			}
		}
	}
