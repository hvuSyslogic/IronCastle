namespace org.bouncycastle.cms.test
{
	...
	public class NewCompressedDataStreamTest : TestCase
	{
		public NewCompressedDataStreamTest(string name) : base(name)
		{
		}
		...
		{
			return new TestSuite(typeof(NewCompressedDataStreamTest));
		}
	}
