...
namespace org.bouncycastle.cms.test
{
	...
	using BufferingContentSigner = org.bouncycastle.@operator.BufferingContentSigner;
	...
	public class BcSignedDataTest : TestCase
	{
		...
		public BcSignedDataTest(string name) : base(name)
		{
		}
		...
		public static void Main(string[] args)
		{
			...
			junit.textui.TestRunner.run(typeof(BcSignedDataTest));
		}
		...
		public static Test suite()
		{
			...
			return new CMSTestSetup(new TestSuite(typeof(BcSignedDataTest)));
		}
		...
		public virtual void testDetachedVerificationWithBufferingContentSigner()
		{
			byte[] data = "Hello World!".GetBytes();
			List certList = new ArrayList();
			CMSTypedData msg = new CMSProcessableByteArray(data);
		...
		public virtual void testSHA1WithRSAViaConfig()
		{
			List certList = new ArrayList();
			CMSTypedData msg = new CMSProcessableByteArray("Hello world!".GetBytes());
			...
			TestCMSSignatureAlgorithmNameGenerator sigAlgNameGen = new TestCMSSignatureAlgorithmNameGenerator(this);

			sigAlgNameGen.setEncryptionAlgorithmMapping(PKCSObjectIdentifiers_Fields.rsaEncryption, "XXXX");
			sigAlgNameGen.setDigestAlgorithmMapping(OIWObjectIdentifiers_Fields.idSHA1, "YYYY");
			...
			{
				if (!e.Message.StartsWith("no such algorithm: YYYYwithXXXX"))
				{
					throw e;
				}
			}
			finally
			{
				...
				sigAlgNameGen.setEncryptionAlgorithmMapping(PKCSObjectIdentifiers_Fields.rsaEncryption, "RSA");
				sigAlgNameGen.setDigestAlgorithmMapping(OIWObjectIdentifiers_Fields.idSHA1, "SHA1");
			}
		...
		{
			private readonly BcSignedDataTest outerInstance;

			public TestCMSSignatureAlgorithmNameGenerator(BcSignedDataTest outerInstance)
			{
