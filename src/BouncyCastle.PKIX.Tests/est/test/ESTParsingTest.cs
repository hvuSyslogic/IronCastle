...
namespace org.bouncycastle.est.test
{
	...
	public class ESTParsingTest : TestCase
	{
		...
		public virtual void testParsingCsrattrs1()
		{
			CSRAttributesResponse response = new CSRAttributesResponse(csrattrs1);

			assertTrue(response.hasRequirement(PKCSObjectIdentifiers_Fields.pkcs_9_at_challengePassword));
			assertTrue(response.hasRequirement(X9ObjectIdentifiers_Fields.ecdsa_with_SHA384));
			assertFalse(response.isAttribute(X9ObjectIdentifiers_Fields.ecdsa_with_SHA384));
			assertTrue(response.isAttribute(X9ObjectIdentifiers_Fields.id_ecPublicKey));
			assertTrue(response.isAttribute(PKCSObjectIdentifiers_Fields.pkcs_9_at_extensionRequest));
		...
		public virtual void testParsingCsrattrs2()
		{
		...
		public virtual void testParsingSimpleEnrolRequest()
		{
			PKCS10CertificationRequest request = new PKCS10CertificationRequest(clientSimpleEnrol);

			Attribute challenge = request.getAttributes(PKCSObjectIdentifiers_Fields.pkcs_9_at_challengePassword)[0];
		...
		public virtual void testParsingSimpleEnrolResponse()
		{
