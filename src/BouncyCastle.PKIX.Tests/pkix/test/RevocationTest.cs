...
namespace org.bouncycastle.pkix.test
{
	...
	using X509RevocationChecker = org.bouncycastle.pkix.jcajce.X509RevocationChecker;
	using CollectionStore = org.bouncycastle.util.CollectionStore;
	using Base64 = org.bouncycastle.util.encoders.Base64;

	public class RevocationTest : TestCase
	{
		...
		private static readonly byte[] sampleTrust = Base64.decode("MIIDVDCCAjygAwIBAgIDAjRWMA0GCSqGSIb3DQEBBQUAMEIxCzAJBgNVBAYTAlVT" + "MRYwFAYDVQQKEw1HZW9UcnVzdCBJbmMuMRswGQYDVQQDExJHZW9UcnVzdCBHbG9i" + "YWwgQ0EwHhcNMDIwNTIxMDQwMDAwWhcNMjIwNTIxMDQwMDAwWjBCMQswCQYDVQQG" + "EwJVUzEWMBQGA1UEChMNR2VvVHJ1c3QgSW5jLjEbMBkGA1UEAxMSR2VvVHJ1c3Qg" + "R2xvYmFsIENBMIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA2swYYzD9" + "9BcjGlZ+W988bDjkcbd4kdS8odhM+KhDtgPpTSEHCIjaWC9mOSm9BXiLnTjoBbdq" + "fnGk5sRgprDvgOSJKA+eJdbtg/OtppHHmMlCGDUUna2YRpIuT8rxh0PBFpVXLVDv" + "iS2Aelet8u5fa9IAjbkU+BQVNdnARqN7csiRv8lVK83Qlz6cJmTM386DGXHKTubU" + "1XupGc1V3sjs0l44U+VcT4wt/lAjNvxm5suOpDkZALeVAjmRCw7+OC7RHQWa9k0+" + "bw8HHa8sHo9gOeL6NlMTOdReJivbPagUvTLrGAMoUgRx5aszPeE4uwc2hGKceeoW" + "MPRfwCvocWvk+QIDAQABo1MwUTAPBgNVHRMBAf8EBTADAQH/MB0GA1UdDgQWBBTA" + "ephojYn7qwVkDBF9qn1luMrMTjAfBgNVHSMEGDAWgBTAephojYn7qwVkDBF9qn1l" + "uMrMTjANBgkqhkiG9w0BAQUFAAOCAQEANeMpauUvXVSOKVCUn5kaFOSPeCpilKIn" + "Z57QzxpeR+nBsqTP3UEaBU6bS+5Kb1VSsyShNwrrZHYqLizz/Tt1kL/6cdjHPTfS" + "tQWVYrmm3ok9Nns4d0iXrKYgjy6myQzCsplFAMfOEVEiIuCl6rYVSAlk6l5PdPcF" + "PseKUgzbFbS9bZvlxrFUaKnjaZC2mqUPuLk/IH2uSrW4nOQdtqvmlKXBx4Ot2/Un" + "hw4EbNX/3aBd7YdStysVAq45pmp06drE57xNNB6pXE0zX5IJL4hmXXeXxx12E6nV" + "5fEWCRE11azbJHFwLJhWC9kXtNHjUStedejV0NxPNO3CBWaAocvmMw==");

		private static readonly byte[] sampleCA = Base64.decode("MIIETTCCAzWgAwIBAgIDAjpxMA0GCSqGSIb3DQEBCwUAMEIxCzAJBgNVBAYTAlVT" + "MRYwFAYDVQQKEw1HZW9UcnVzdCBJbmMuMRswGQYDVQQDExJHZW9UcnVzdCBHbG9i" + "YWwgQ0EwHhcNMTMxMjExMjM0NTUxWhcNMjIwNTIwMjM0NTUxWjBCMQswCQYDVQQG" + "EwJVUzEWMBQGA1UEChMNR2VvVHJ1c3QgSW5jLjEbMBkGA1UEAxMSUmFwaWRTU0wg" + "U0hBMjU2IENBMIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQE
7wAABAMARzBFAiEAiQrwaLoNvmFlNLapDYN18gA09iIAvtfAM0noB35a" + "wK8CIEjk9DPQthhMTtqDUA0LthHiLLeRIjlw9G7o3+4/a/A9MA0GCSqGSIb3DQEB" + "CwUAA4IBAQB1/JjAkaEFcQFeihxJvGc4DpbucdB0OfmQrkjH5HvSYi/5xlp+BOxM" + "es32KSI6CBiLhZviz3JVW05Zgz8tCEoV1D6kfmNQNQPXW958vO4QU88EPmbPo7fg" + "Hb38Xv1BesjNN7R7S/nS80hFFU1UsspsrfRJnEMshkD4Xrt8644g+5VqQGxeN0WZ" + "LkG40sYhBmVHwYBKIfefk8Erzxk58Fzfx4cIZZuIEqmVZVjuXGCmFzsW8StanBPP" + "8Vyr5e9TEEGbsEyjpibgzLqrphtSpBsN4OphPYWtFzQpgq09wqLkLkhEHp+EvwPN" + "gUt3Qm/EwLuDb+X5uVOqKWyP4PAlxmAr");

		internal static bool initialized = false;

		internal static KeyPair trustKp;
		internal static KeyPair caKp;
		internal static KeyPair eeKp;

		// initialise CertStore
		internal static X509Certificate trustCert;
		internal static X509Certificate caCert;
		internal static X509Certificate eeCert;
		internal static X509Certificate eeCertWithDistPoint;

		internal static X509CRL trustCrl;
		internal static X509CRL caCrl;
		...
		public virtual void testValidPath()
		{
			...
			DateTime validDate = new DateTime(trustCrl.getThisUpdate().getTime() + 60 * 60 * 1000);
			//validating path
			...
			X509RevocationChecker revocationChecker = (new X509RevocationChecker.Builder(new TrustAnchor(trustCert, null))).addCrls(new CollectionStore<CRL>(crls)).build();
		...
		public virtual void testEndEntityOnly()
		{
			List list = new ArrayList();
			...
			X509RevocationChecker revocationChecker = (new X509RevocationChecker.Builder(new TrustAnchor(trustCert, null))).setCheckEndEntityOnly(true).addCrls(new CollectionStore<CRL>(crls)).build();
		...
		public virtual void testRevokedEndEntityOnly()
		{
			List list = new ArrayList();
			...
			{
				assertTrue(e.Message.StartsWith(@"certificate [issuer=""CN=CA Cert"",serialNumber=3,subject=""CN=End Entity""] revoked"));
				assertTrue(e.Message.EndsWith(", reason: privilegeWithdrawn"));
			}
		}

		public virtual void testRevokedEndEntityWithSoftFailure()
		{
			List list = new ArrayList();
			...
			X509RevocationChecker revocationChecker = (new X509RevocationChecker.Builder(new TrustAnchor(trustCert, null))).setCheckEndEntityOnly(true).setSoftFailHardLimit(true, 0).build();
			...
			{
				assertTrue(e.Message.Equals(@"No CRLs found for issuer ""cn=CA Cert"""));
			}
		}

		public virtual void testRevokedWithCRLDistPointEndEntityOnly()
		{
		   ...
		   // crls.add(TestUtil.makeCrl(caCert, caKp.getPrivate(), eeCert.getSerialNumber()));
			...
			X509RevocationChecker revocationChecker = (new X509RevocationChecker.Builder(new TrustAnchor(trustCert, null))).setCheckEndEntityOnly(true).addCrls(new CollectionStore<CRL>(crls)).usingProvider("BC").build();
