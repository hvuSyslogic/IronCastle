namespace org.bouncycastle.asn1.test
{
	...
	public class ASN1IntegerTest : SimpleTest
	{
		private static readonly byte[] suspectKey = Base64.decode("MIGJAoGBAHNc+iExm94LUrJdPSJ4QJ9tDRuvaNmGVHpJ4X7a5zKI02v+2E7RotuiR2MHDJfVJkb9LUs2kb3XBlyENhtMLsbeH+3Muy3" + "hGDlh/mLJSh1s4c5jDKBRYOHom7Uc8wP0P2+zBCA+OEdikNDFBaP5PbR2Xq9okG2kPh35M2quAiMTAgMBAAE=");
		...
		/// </summary>
		public virtual void testValidEncodingSingleByte()
		{
			System.setProperty("org.bouncycastle.asn1.allow_unsafe_integer", "false");
			//
		...
		public virtual void testValidEncodingMultiByte()
		{
			System.setProperty("org.bouncycastle.asn1.allow_unsafe_integer", "false");
			//
			// Without property, single byte.
		...
		public virtual void testInvalidEncoding_00()
		{
			System.setProperty("org.bouncycastle.asn1.allow_unsafe_integer", "false");
			try
			{
		...
		public virtual void testInvalidEncoding_ff()
		{
			System.setProperty("org.bouncycastle.asn1.allow_unsafe_integer", "false");
			try
			{
		...
		public virtual void testInvalidEncoding_00_32bits()
		{
			System.setProperty("org.bouncycastle.asn1.allow_unsafe_integer", "false");
			//
		...
		public virtual void testInvalidEncoding_ff_32bits()
		{
			System.setProperty("org.bouncycastle.asn1.allow_unsafe_integer", "false");
			//
			// Check what would pass loose validation fails outside of loose validation.
		...
		*/
		...
		public virtual void testLooseValidEncoding_zero_32BAligned()
		{
			System.setProperty("org.bouncycastle.asn1.allow_unsafe_integer", "false");
			//
		...
		public virtual void testLooseValidEncoding_FF_32BAligned()
		{
			System.setProperty("org.bouncycastle.asn1.allow_unsafe_integer", "false");
			//
		...
		public virtual void testLooseValidEncoding_FF_32BAligned_1not0()
		{
			System.setProperty("org.bouncycastle.asn1.allow_unsafe_integer", "false");
			//
		...
		public virtual void testLooseValidEncoding_FF_32BAligned_2not0()
		{
			System.setProperty("org.bouncycastle.asn1.allow_unsafe_integer", "false");
			//
			// Should pass as loose validation permits 3 leading 0xFF bytes.
		...
		public virtual void testOversizedEncoding()
		{
			System.setProperty("org.bouncycastle.asn1.allow_unsafe_integer", "false");
			//
			// Should pass as loose validation permits 3 leading 0xFF bytes.
