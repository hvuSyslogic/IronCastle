namespace org.bouncycastle.asn1.test
{
	...
	public class AttributeTableUnitTest : SimpleTest
	{
		private static readonly ASN1ObjectIdentifier type1 = new ASN1ObjectIdentifier("1.1.1");
		private static readonly ASN1ObjectIdentifier type2 = new ASN1ObjectIdentifier("1.1.2");
		private static readonly ASN1ObjectIdentifier type3 = new ASN1ObjectIdentifier("1.1.3");
