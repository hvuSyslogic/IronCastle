...
namespace org.bouncycastle.asn1.test
{
	...
	public class DERApplicationSpecificTest : SimpleTest
	{
		...
		public override void performTest()
		{
			...
			ASN1Integer recVal = (ASN1Integer)tagged.getObject(BERTags_Fields.INTEGER);
			...
			byte[] encoded = certObj.getEncoded(ASN1Encoding_Fields.DER);
