...
namespace org.bouncycastle.asn1.test
{
	...
	public class PKCS12Test : SimpleTest
	{
		...
		public override void performTest()
		{
			...
			// private key section
			//
			if (!c[0].getContentType().Equals(PKCSObjectIdentifiers_Fields.data))
			{
			...
			b = new SafeBag(PKCSObjectIdentifiers_Fields.pkcs8ShroudedKeyBag, encInfo.toASN1Primitive(), b.getBagAttributes());
			...
			c[0] = new ContentInfo(PKCSObjectIdentifiers_Fields.data, new BEROctetString(abOut.toByteArray()));

			//
			// certificates
			//
			if (!c[1].getContentType().Equals(PKCSObjectIdentifiers_Fields.encryptedData))
			{
			...
			c[1] = new ContentInfo(PKCSObjectIdentifiers_Fields.encryptedData, eData);
			...
			info = new ContentInfo(PKCSObjectIdentifiers_Fields.data, new BEROctetString(abOut.toByteArray()));
