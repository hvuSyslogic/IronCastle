namespace org.bouncycastle.math.ec.rfc7748.test
{
	...
	public class X448Test : TestCase
	{
	...
	//    @Test
		...
		{
			byte[] u = new byte[X448.POINT_SIZE];
			u[0] = 5;
	...
	//    @Test
		public virtual void testECDHVector1()
		{
	...
	//    @Test
		public virtual void testX448Iterated()
		{
			checkIterated(1000);
		}
	...
	//    @Test
		public virtual void testX448Vector1()
		{
	...
	//    @Test
		public virtual void testX448Vector2()
		{
			checkX448Vector("203d494428b8399352665ddca42f9de8fef600908e0d461cb021f8c538345dd77c3e4806e25f46d3315c44e0a5b4371282dd2c8d5be3095f", "0fbcc2f993cd56d3305b0b7d9e55d4c1a8fb5dbb52f8e9a1e9b6201b165d015894e56c4d3570bee52fe205e28a78b91cdfbde71ce8d157db", "884a02576239ff7a2f2f63b2db6a9ff37047ac13568e1e30fe63c4a7ad1b3ee3a5700df34321d62077e63633c575c1c954514e99da7c179d", "Vector #2");
		}
		...
		private static void checkIterated(int count)
		{
			...
			byte[] k = new byte[X448.POINT_SIZE];
			k[0] = 5;
			byte[] u = new byte[X448.POINT_SIZE];
			u[0] = 5;
			...
			while (iterations < count)
			{
				...
				JavaSystem.arraycopy(k, 0, u, 0, X448.POINT_SIZE);
				JavaSystem.arraycopy(r, 0, k, 0, X448.POINT_SIZE);

				switch (++iterations)
				{
				case 1:
					checkValue(k, "Iterated @1", "3f482c8a9f19b01e6c46ee9711d9dc14fd4bf67af30765c2ae2b846a4d23a8cd0db897086239492caf350b51f833868b9bc2b3bca9cf4113");
					break;
				case 1000:
					checkValue(k, "Iterated @1000", "aa3b4749d55b9daf1e5b00288826c467274ce3ebbdd5c17b975e09d4af6c67cf10d087202db88286e2b79fceea3ec353ef54faa26e219f38");
					break;
				case 1000000:
					checkValue(k, "Iterated @1000000", "077f453681caca3693198420bbe515cae0002472519b3e67661a7e89cab94695c8f4bcd66e61b9b9c946da8d524de3d69bd9d9d66b997e37");
					break;
				default:
					break;
				}
