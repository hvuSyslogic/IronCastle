namespace org.bouncycastle.math.ec.rfc7748.test
{
	...
	public class X25519Test : TestCase
	{
	...
	//    @Test
		...
		{
			byte[] u = new byte[X25519.POINT_SIZE];
			u[0] = 9;
	...
	//    @Test
		public virtual void testX25519Iterated()
		{
			checkIterated(1000);
		}
	...
	//    @Test
		public virtual void testX25519Vector1()
		{
	...
	//    @Test
		public virtual void testX25519Vector2()
		{
		...
		private static void checkIterated(int count)
		{
			...
			byte[] k = new byte[X25519.POINT_SIZE];
			k[0] = 9;
			byte[] u = new byte[X25519.POINT_SIZE];
			u[0] = 9;
			...
			while (iterations < count)
			{
				...
				JavaSystem.arraycopy(k, 0, u, 0, X25519.POINT_SIZE);
				JavaSystem.arraycopy(r, 0, k, 0, X25519.POINT_SIZE);
