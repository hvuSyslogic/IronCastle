...
//
//        JavaSystem.@out.println(curveName + ": Multiply WTNAF took millis:  " + (now2 - now1));
//        JavaSystem.@out.println(curveName + ": Multiply WNAF took millis:   " + (now3 - now2));
//        JavaSystem.@out.println(curveName + ": Multiply FPNAF took millis:  " + (now4 - now3));
//        JavaSystem.@out.println(curveName + ": Multiply REFE took millis:   " + (now5 - now4));
//
////        JavaSystem.@out.println(curveName + ": refRWTnaf  = " + ecPointToString(refRWTnaf));
////        JavaSystem.@out.println(curveName + ": refWnaf    = " + ecPointToString(refWnaf));
////        JavaSystem.@out.println(curveName + ": refFpNaf   = " + ecPointToString(refFpNaf));
////        JavaSystem.@out.println(curveName + ": reference  = " + ecPointToString(reference) + "\n");
...
//        assertEquals("FPNAF multiplication is incorrect", refFpNaf, reference);
//
//        JavaSystem.@out.println(curveName + ": Multiply WNAF took millis:   " + (now2 - now1));
//        JavaSystem.@out.println(curveName + ": Multiply FPNAF took millis:  " + (now3 - now2));
//        JavaSystem.@out.println(curveName + ": Multiply REFE took millis:   " + (now4 - now3));
//
////        JavaSystem.@out.println(curveName + ": refWnaf    = " + ecPointToString(refWnaf));
////        JavaSystem.@out.println(curveName + ": refFpNaf   = " + ecPointToString(refFpNaf));
////        JavaSystem.@out.println(curveName + ": reference  = " + ecPointToString(reference));
