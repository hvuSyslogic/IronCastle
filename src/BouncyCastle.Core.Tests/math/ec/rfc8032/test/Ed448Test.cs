namespace org.bouncycastle.math.ec.rfc8032.test
{
	...
	public class Ed448Test : TestCase
	{
	...
	//    @Test
		public virtual void testEd448Consistency()
		{
			...
			for (int i = 0; i < 10; ++i)
			{
				...
				sig1[Ed448.PUBLIC_KEY_SIZE - 1] ^= unchecked((byte)0x80);
	...
	//    @Test
		public virtual void testEd448phConsistency()
		{
			byte[] sk = new byte[Ed448.SECRET_KEY_SIZE];
			byte[] pk = new byte[Ed448.PUBLIC_KEY_SIZE];
			byte[] ctx = new byte[RANDOM.nextInt() & 7];
	...
	//    @Test
		public virtual void testEd448Vector3()
		{
			checkEd448Vector(("c4eab05d357007c632f3dbb48489924d" + "552b08fe0c353a0d4a1f00acda2c463a" + "fbea67c5e8d2877c5e3bc397a659949e" + "f8021e954e0a12274e"), ("43ba28f430cdff456ae531545f7ecd0a" + "c834a55d9358c0372bfa0c6c6798c086" + "6aea01eb00742802b8438ea4cb82169c" + "235160627b4c3a9480"), "03", "666f6f", ("d4f8f6131770dd46f40867d6fd5d5055" + "de43541f8c5e35abbcd001b32a89f7d2" + "151f7647f11d8ca2ae279fb842d60721" + "7fce6e042f6815ea000c85741de5c8da" + "1144a6a1aba7f96de42505d7a7298524" + "fda538fccbbb754f578c1cad10d54d0d" + "5428407e85dcbc98a49155c13764e66c" + "3c00"), "Ed448 Vector #3");
		}

	//    @Test
		public virtual void testEd448Vector4()
		{
			checkEd448Vector(("cd23d24f714274e744343237b93290f5" + "11f6425f98e64459ff203e8985083ffd" + "f60500553abc0e05cd02184bdb89c4cc" + "d67e187951267eb328"), ("dcea9e78f35a1bf3499a831b10b86c90" + "aac01cd84b67a0109b55a36e9328b1e3" + "65fce161d71ce7131a543ea4cb5f7e9f" + "1d8b00696447001400"), "0c3e544074ec63b0265e0c", "", ("1f0a8888ce25e8d458a21130879b840a" + "9089d999aaba039eaf3e3afa090a09d3" + "89dba82c4ff2ae8ac5cdfb7c55e94d5d" + "961a29fe0109941e00b8dbdeea6d3b05" + "1068df7254c0cdc129cbe62db2dc957d" + "bb47b51fd3f213fb8698f064774250a5" + "028961c9bf8ffd973fe5d5c206492b14" + "0e00"), "Ed448 Vector #4");
		}

	//    @Test
		public virtual void testEd448Vector5()
		{
			checkEd448Vector(("258cdd4ada32ed9c9ff54e63756ae582" + "fb8fab2ac721f2c8e676a72768513d93" + "9f63dddb55609133f29adf86ec9929dc" + "cb52c1c5fd2ff7e21b"), ("3ba16da0c6f2cc1f30187740756f5e79" + "8d6bc5fc015d7c63cc9510ee3fd44adc" + "24d8e968b6e46e6f94d19b945361726b" + "d75e149ef09817f580"), "64a65f3cdedcdd66811e2915", "", ("7eeeab7c4e50fb799b418ee5e3197ff6" + "bf15d43a14c34389b59dd1a7b1b85b4a" + "e90438aca634bea45e3a2695f1270f07" + "fdcdf7c62b8efeaf00b45c2c96ba457e" + "b1a8bf075a3db28e5c24f6b923ed4ad7" + "47c3c9e03c7079efb87cb110d3a99861" + "e72003cbae6d6b8b827e4e6c143064ff" + "3c00"), "Ed448 Vector #5");
		}

	//    @Test
		public virtual void testEd448Vector6()
		{
	...
	//    @Test
		public virtual void testEd448Vector256()
		{
			...
			checkEd448Vector(("2ec5fe3c17045abdb136a5e6a913e32a" + "b75ae68b53d2fc149b77e504132d3756" + "9b7e766ba74a19bd6162343a21c8590a" + "a9cebca9014c636df5"), ("79756f014dcfe2079f5dd9e718be4171" + "e2ef2486a08f25186f6bff43a9936b9b" + "fe12402b08ae65798a3d81e22e9ec80e" + "7690862ef3d4ed3a00"), m, "", ("c650ddbb0601c19ca11439e1640dd931" + "f43c518ea5bea70d3dcde5f4191fe53f" + "00cf966546b72bcc7d58be2b9badef28" + "743954e3a44a23f880e8d4f1cfce2d7a" + "61452d26da05896f0a50da66a239a8a1" + "88b6d825b3305ad77b73fbac0836ecc6" + "0987fd08527c1a8e80d5823e65cafe2a" + "3d00"), "Ed448 Vector #256");
		}

	//    @Test
		public virtual void testEd448Vector1023()
		{
			string m = "6ddf802e1aae4986935f7f981ba3f035" +
	...
	//    @Test
		...
		private static void checkEd448Vector(string sSK, string sPK, string sM, string sCTX, string sSig, string text)
		{
			...
			badsig[Ed448.SIGNATURE_SIZE - 1] ^= unchecked((byte)0x80);
