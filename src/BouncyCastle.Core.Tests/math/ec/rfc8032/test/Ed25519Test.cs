namespace org.bouncycastle.math.ec.rfc8032.test
{
	...
	public class Ed25519Test : TestCase
	{
	...
	//    @Test
		public virtual void testEd25519Consistency()
		{
			...
			for (int i = 0; i < 10; ++i)
			{
				...
				sig1[Ed25519.PUBLIC_KEY_SIZE - 1] ^= unchecked((byte)0x80);
	...
	//    @Test
		public virtual void testEd25519ctxConsistency()
		{
			byte[] sk = new byte[Ed25519.SECRET_KEY_SIZE];
			byte[] pk = new byte[Ed25519.PUBLIC_KEY_SIZE];
	...
	//    @Test
		public virtual void testEd25519phConsistency()
		{
			byte[] sk = new byte[Ed25519.SECRET_KEY_SIZE];
			byte[] pk = new byte[Ed25519.PUBLIC_KEY_SIZE];
			byte[] ctx = new byte[RANDOM.nextInt() & 7];
	...
	//    @Test
		public virtual void testEd25519Vector1()
		{
			checkEd25519Vector(("9d61b19deffd5a60ba844af492ec2cc4" + "4449c5697b326919703bac031cae7f60"), ("d75a980182b10ab7d54bfed3c964073a" + "0ee172f3daa62325af021a68f707511a"), "", ("e5564300c360ac729086e2cc806e828a" + "84877f1eb8e5d974d873e06522490155" + "5fb8821590a33bacc61e39701cf9b46b" + "d25bf5f0595bbe24655141438e7a100b"), "Ed25519 Vector #1");
		}

	//    @Test
		public virtual void testEd25519Vector2()
		{
			checkEd25519Vector(("4ccd089b28ff96da9db6c346ec114e0f" + "5b8a319f35aba624da8cf6ed4fb8a6fb"), ("3d4017c3e843895a92b70aa74d1b7ebc" + "9c982ccf2ec4968cc0cd55f12af4660c"), "72", ("92a009a9f0d4cab8720e820b5f642540" + "a2b27b5416503f8fb3762223ebdb69da" + "085ac1e43e15996e458f3613d0f11d8c" + "387b2eaeb4302aeeb00d291612bb0c00"), "Ed25519 Vector #2");
		}

	//    @Test
		public virtual void testEd25519Vector3()
		{
			checkEd25519Vector(("c5aa8df43f9f837bedb7442f31dcb7b1" + "66d38535076f094b85ce3a2e0b4458f7"), ("fc51cd8e6218a1a38da47ed00230f058" + "0816ed13ba3303ac5deb911548908025"), "af82", ("6291d657deec24024827e69c3abe01a3" + "0ce548a284743a445e3680d7db5ac3ac" + "18ff9b538d16f290ae67f760984dc659" + "4a7c15e9716ed28dc027beceea1ec40a"), "Ed25519 Vector #3");
		}

	//    @Test
		public virtual void testEd25519Vector1023()
		{
			string m = "08b8b2b733424243760fe426a4b54908" +
	...
	//    @Test
		public virtual void testEd25519VectorSHAabc()
		{
			checkEd25519Vector(("833fe62409237b9d62ec77587520911e" + "9a759cec1d19755b7da901b96dca3d42"), ("ec172b93ad5e563bf4932c70e1245034" + "c35467ef2efd4d64ebf819683467e2bf"), ("ddaf35a193617abacc417349ae204131" + "12e6fa4e89a97ea20a9eeee64b55d39a" + "2192992a274fc1a836ba3c23a3feebbd" + "454d4423643ce80e2a9ac94fa54ca49f"), ("dc2a4459e7369633a52b1bf277839a00" + "201009a3efbf3ecb69bea2186c26b589" + "09351fc9ac90b3ecfdfbc7c66431e030" + "3dca179c138ac17ad9bef1177331a704"), "Ed25519 Vector SHA(abc)");
		}

	//    @Test
		public virtual void testEd25519ctxVector1()
		{
	...
	//    @Test
		public virtual void testEd25519ctxVector2()
		{
	...
	//    @Test
		public virtual void testEd25519ctxVector3()
		{
	...
	//    @Test
		public virtual void testEd25519ctxVector4()
		{
	...
	//    @Test
		public virtual void testEd25519phVector1()
		{
		...
		private static void checkEd25519Vector(string sSK, string sPK, string sM, string sSig, string text)
		{
			...
			badsig[Ed25519.SIGNATURE_SIZE - 1] ^= unchecked((byte)0x80);
