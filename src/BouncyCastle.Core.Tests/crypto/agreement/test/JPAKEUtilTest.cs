namespace org.bouncycastle.crypto.agreement.test
{
	...
	public class JPAKEUtilTest : TestCase
	{
		private static readonly BigInteger TEN = BigInteger.valueOf(10);

		public virtual void testValidateGx4()
		{
		...
		public virtual void testValidateGa()
		{
		...
		public virtual void testValidateParticipantIdsDiffer()
		{
		...
		public virtual void testValidateParticipantIdsEqual()
		{
		...
		public virtual void testValidateMacTag()
		{
		...
		public virtual void testValidateNotNull()
		{
		...
		public virtual void testValidateZeroKnowledgeProof()
		{
			JPAKEPrimeOrderGroup pg1 = JPAKEPrimeOrderGroups.SUN_JCE_1024;
