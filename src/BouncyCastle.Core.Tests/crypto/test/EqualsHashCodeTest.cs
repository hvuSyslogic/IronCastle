namespace org.bouncycastle.crypto.test
{
	...
	public class DHTestKeyParameters : DHKeyParameters
	{
		public DHTestKeyParameters(bool isPrivate, DHParameters @params) : base(isPrivate, @params)
		{
		}
	}

	public class ElGamalTestKeyParameters : ElGamalKeyParameters
	{
		public ElGamalTestKeyParameters(bool isPrivate, ElGamalParameters @params) : base(isPrivate, @params)
		{
		}
	}

	public class EqualsHashCodeTest : SimpleTest
	{
