...
namespace org.bouncycastle.crypto.test
{
	...
	using SM2Engine = org.bouncycastle.crypto.engines.SM2Engine;
	...
	public class SM2EngineTest : SimpleTest
	{
		...
		private void doEngineTestFp()
		{
			...
			isTrue("enc wrong", Arrays.areEqual(Hex.decode("04245C26 FB68B1DD DDB12C4B 6BF9F2B6 D5FE60A3 83B0D18D 1C4144AB F17F6252" + "E776CB92 64C2A7E8 8E52B199 03FDC473 78F605E3 6811F5C0 7423A24B 84400F01" + "B8650053 A89B41C4 18B0C3AA D00D886C 00286467 9C3D7360 C30156FA B7C80A02" + "76712DA9 D8094A63 4B766D3A 285E0748 0653426D"), enc));
