...
namespace org.bouncycastle.crypto.test
{
	...
	public class PKCS5Test : SimpleTest
	{
		...
		public class PBETest : SimpleTest
		{
			...
			public PBETest(PKCS5Test outerInstance, int id, BufferedBlockCipher cipher, byte[] sample, int keySize)
			{
			...
			public override void performTest()
			{
				...
				if (scheme.getAlgorithm().Equals(PKCSObjectIdentifiers_Fields.RC2_CBC))
				{
		...
		public override void performTest()
		{
			...
			generator.init(PBEParametersGenerator.PKCS5PasswordToBytes(password), salt, 5);
			...
			generator.init(PBEParametersGenerator.PKCS5PasswordToBytes(password), salt, 500);
