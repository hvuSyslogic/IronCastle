namespace org.bouncycastle.crypto.test
{
	...
	using HKDFBytesGenerator = org.bouncycastle.crypto.generators.HKDFBytesGenerator;
	...
	/// </summary>
	public class HKDFGeneratorTest : SimpleTest
	{
		...
		{
			{
				...
				compareOKM(1, okm, Hex.decode("3cb25f25faacd57a90434f64d0362f2a" + "2d2d0a90cf1a5a4c5db02d56ecc4c5bf" + "34007208d5b887185865"));
			}
			...
			// ===
			{
				...
				compareOKM(2, okm, Hex.decode("b11e398dc80327a1c8e7f78c596a4934" + "4f012eda2d4efad8a050cc4c19afa97c" + "59045a99cac7827271cb41c65e590e09" + "da3275600c2f09b8367793a9aca3db71" + "cc30c58179ec3e87c14c01d5c1f3434f" + "1d87"));
			}

			{
				...
				compareOKM(3, okm, Hex.decode("8da4e775a563c18f715f802a063c5a31" + "b8a11f5c5ee1879ec3454e5f3c738d2d" + "9d201395faa4b61a96c8"));
			}

			{
				...
				compareOKM(4, okm, Hex.decode("085a01ea1b10f36933068b56efa5ad81" + "a4f14b822f5b091568a9cdd4f155fda2" + "c22e422478d305f3f896"));
			}
...

			{
				...
				compareOKM(6, okm, Hex.decode("0ac1af7002b3d761d1e55298da9d0506" + "b9ae52057220a306e07b6b87e8df21d0" + "ea00033de03984d34918"));
			}

			{
				...
				compareOKM(7, okm, Hex.decode("2c91117204d745f3500d636a62f64f0a" + "b3bae548aa53d423b0d1f27ebba6f5e5" + "673a081d70cce7acfc48"));
			}

			{
				...
				compareOKM(101, okm, Hex.decode("2c91117204d745f3500d636a62f64f0a" + "b3bae548aa53d423b0d1f27ebba6f5e5" + "673a081d70cce7acfc48"));
			}
