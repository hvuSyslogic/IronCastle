namespace org.bouncycastle.crypto.test
{
	...
	public class ElGamalTest : SimpleTest
	{
		...
		private void testEnc(int size, int privateValueSize, BigInteger g, BigInteger p)
		{
		...
		private void checkKeySize(int privateValueSize, ElGamalPrivateKeyParameters priv)
		{
		...
		/// </summary>
		/// <param name="size"> size of key in bits. </param>
