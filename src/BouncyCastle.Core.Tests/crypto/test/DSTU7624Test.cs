namespace org.bouncycastle.crypto.test
{
	...
	using DSTU7624Mac = org.bouncycastle.crypto.macs.DSTU7624Mac;
	...
	using KXTSBlockCipher = org.bouncycastle.crypto.modes.KXTSBlockCipher;
	...
	public class DSTU7624Test : CipherTest
	{
		...
		public DSTU7624Test() : base(tests, new DSTU7624Engine(128), new KeyParameter(new byte[16]))
		{
		}
		...
		private void MacTests()
		{
			...
			byte[] authtext = Hex.decode("202122232425262728292A2B2C2D2E2F" + "303132333435363738393A3B3C3D3E3F" + "404142434445464748494A4B4C4D4E4F");
			...
			{
				fail("Failed MAC test 1 - expected " + Hex.toHexString(expectedMac) + " got " + Hex.toHexString(mac));
			}


			//test 2
			key = Hex.decode("000102030405060708090A0B0C0D0E0F" + "101112131415161718191A1B1C1D1E1F" + "202122232425262728292A2B2C2D2E2F" + "303132333435363738393A3B3C3D3E3F");

			authtext = Hex.decode("404142434445464748494A4B4C4D4E4F" + "505152535455565758595A5B5C5D5E5F" + "606162636465666768696A6B6C6D6E6F" + "707172737475767778797A7B7C7D7E7F" + "808182838485868788898A8B8C8D8E8F" + "909192939495969798999A9B9C9D9E9F" + "A0A1A2A3A4A5A6A7A8A9AAABACADAEAF" + "B0B1B2B3B4B5B6B7B8B9BABBBCBDBEBF");
			...
			if (!Arrays.areEqual(mac, expectedMac))
			{
				fail("Failed MAC test 2 - expected " + Hex.toHexString(expectedMac) + " got " + Hex.toHexString(mac));
			}
		}
		...
		private void KeyWrapTests()
		{
			...
			{
				fail("Failed KW (wrapping) test 1 - expected " + Hex.toHexString(expectedWrappedText) + " got " + Hex.toHexString(output));
			}
			...
			{
				fail("Failed KW (unwrapping) test 1 - expected " + Hex.toHexString(expected) + " got " + Hex.toHexString(output));
			}
			...
			if (!Arrays.areEqual(output, expectedWrappedText))
			{
				fail("Failed KW (wrapping) test 2 - expected " + Hex.toHexString(expectedWrappedText) + " got " + Hex.toHexString(output));
			}
			...
			{
				fail("Failed KW (unwrapping) test 2 - expected " + Hex.toHexString(textToWrap) + " got " + Hex.toHexString(output));
			}
			...
			if (!Arrays.areEqual(output, expectedWrappedText))
			{
				fail("Failed KW (wrapping) test 3 - expected " + Hex.toHexString(expectedWrappedText) + " got " + Hex.toHexString(output));
			}
			...
			if (!Arrays.areEqual(output, textToWrap))
			{
				fail("Failed KW (unwrapping) test 3 - expected " + Hex.toHexString(textToWrap) + " got " + Hex.toHexString(output));
			}
			...
			if (!Arrays.areEqual(output, expectedWrappedText))
			{
				fail("Failed KW (wrapping) test 4 - expected " + Hex.toHexString(expectedWrappedText) + " got " + Hex.toHexString(output));
			}
			...
			if (!Arrays.areEqual(output, textToWrap))
			{
				fail("Failed KW (unwrapping) test 4 - expected " + Hex.toHexString(textToWrap) + " got " + Hex.toHexString(output));
			}
			...
			if (!Arrays.areEqual(output, expectedWrappedText))
			{
				fail("Failed KW (wrapping) test 5 - expected " + Hex.toHexString(expectedWrappedText) + " got " + Hex.toHexString(output));
			}
			...
			if (!Arrays.areEqual(output, textToWrap))
			{
				fail("Failed KW (unwrapping) test 5 - expected " + Hex.toHexString(textToWrap) + " got " + Hex.toHexString(output));
			}
		}
		...
		private void CCMModeTests()
		{
			...
			JavaSystem.arraycopy(input, 0, expectedDecrypted, 0, input.Length);
			JavaSystem.arraycopy(expectedMac, 0, expectedDecrypted, input.Length, expectedMac.Length);
			int len;
			...
			if (!Arrays.areEqual(mac, expectedMac))
			{
				fail("Failed CCM mac test 1 - expected " + Hex.toHexString(expectedMac) + " got " + Hex.toHexString(mac));
			}

			if (!Arrays.areEqual(encrypted, expectedEncrypted))
			{
				fail("Failed CCM encrypt test 1 - expected " + Hex.toHexString(expectedEncrypted) + " got " + Hex.toHexString(encrypted));
			}
			...
			{
				fail("Failed CCM decrypt/verify mac test 1 - expected " + Hex.toHexString(expectedDecrypted) + " got " + Hex.toHexString(decrypted));
			}
			...
			if (!Arrays.areEqual(mac, expectedMac))
			{
				fail("Failed CCM mac test 2 - expected " + Hex.toHexString(expectedMac) + " got " + Hex.toHexString(mac));
			}

			if (!Arrays.areEqual(encrypted, expectedEncrypted))
			{
				fail("Failed CCM encrypt test 2 - expected " + Hex.toHexString(expectedEncrypted) + " got " + Hex.toHexString(encrypted));
			}
			...
			if (!Arrays.areEqual(decrypted, expectedDecrypted))
			{
				fail("Failed CCM decrypt/verify mac test 2 - expected " + Hex.toHexString(expectedDecrypted) + " got " + Hex.toHexString(decrypted));
			}
			...
			if (!Arrays.areEqual(mac, expectedMac))
			{
				fail("Failed CCM mac test 3 - expected " + Hex.toHexString(expectedMac) + " got " + Hex.toHexString(mac));
			}

			if (!Arrays.areEqual(encrypted, expectedEncrypted))
			{
				fail("Failed CCM encrypt test 3 - expected " + Hex.toHexString(expectedEncrypted) + " got " + Hex.toHexString(encrypted));
			}
			...
			if (!Arrays.areEqual(decrypted, expectedDecrypted))
			{
				fail("Failed CCM decrypt/verify mac test 3 - expected " + Hex.toHexString(expectedDecrypted) + " got " + Hex.toHexString(decrypted));
			}
			...
			if (!Arrays.areEqual(mac, expectedMac))
			{
				fail("Failed CCM mac test 4 - expected " + Hex.toHexString(expectedMac) + " got " + Hex.toHexString(mac));
			}

			if (!Arrays.areEqual(encrypted, expectedEncrypted))
			{
				fail("Failed CCM encrypt test 4 - expected " + Hex.toHexString(expectedEncrypted) + " got " + Hex.toHexString(encrypted));
			}
			...
			if (!Arrays.areEqual(decrypted, expectedDecrypted))
			{
				fail("Failed CCM decrypt/verify mac test 4 - expected " + Hex.toHexString(expectedDecrypted) + " got " + Hex.toHexString(decrypted));
			}
		...
		private void XTSModeTests()
		{
			...
			{
				fail("Failed XTS encrypt test 1 - expected " + Hex.toHexString(expectedCipherText) + " got " + Hex.toHexString(output));
			}
			...
			{
				fail("Failed XTS decrypt test 1 - expected " + Hex.toHexString(plainText) + " got " + Hex.toHexString(decrypted));
			}
			...
			if (!Arrays.areEqual(output, expectedCipherText))
			{
				fail("Failed XTS encrypt test 2 - expected " + Hex.toHexString(expectedCipherText) + " got " + Hex.toHexString(output));
			}
			...
			if (!Arrays.areEqual(decrypted, plainText))
			{
				fail("Failed XTS decrypt test 2 - expected " + Hex.toHexString(plainText) + " got " + Hex.toHexString(decrypted));
			}
			...
			if (!Arrays.areEqual(output, expectedCipherText))
			{
				fail("Failed XTS encrypt test 3 - expected " + Hex.toHexString(expectedCipherText) + " got " + Hex.toHexString(output));
			}
			...
			if (!Arrays.areEqual(decrypted, plainText))
			{
				fail("Failed XTS decrypt test 3 - expected " + Hex.toHexString(plainText) + " got " + Hex.toHexString(decrypted));
			}
			...
			if (!Arrays.areEqual(output, expectedCipherText))
			{
				fail("Failed XTS encrypt test 4 - expected " + Hex.toHexString(expectedCipherText) + " got " + Hex.toHexString(output));
			}
			...
			if (!Arrays.areEqual(decrypted, plainText))
			{
				fail("Failed XTS decrypt test 4 - expected " + Hex.toHexString(plainText) + " got " + Hex.toHexString(decrypted));
			}
			...
			if (!Arrays.areEqual(output, expectedCipherText))
			{
				fail("Failed XTS encrypt test 5 - expected " + Hex.toHexString(expectedCipherText) + " got " + Hex.toHexString(output));
			}
			...
			if (!Arrays.areEqual(decrypted, plainText))
			{
				fail("Failed XTS decrypt test 5 - expected " + Hex.toHexString(plainText) + " got " + Hex.toHexString(decrypted));
			}
		}
		...
		private void GCMModeTests()
		{
			...
			JavaSystem.arraycopy(expectedEncrypted, 0, expectedOutput, 0, expectedEncrypted.Length);
			JavaSystem.arraycopy(expectedMac, 0, expectedOutput, expectedEncrypted.Length, expectedMac.Length);
			...
			JavaSystem.arraycopy(expectedMac, 0, decrypted, plainText.Length, mac.Length);
			...
			if (!Arrays.areEqual(mac, expectedMac))
			{
				fail("Failed GCM/GMAC test 1 - expected mac: " + Hex.toHexString(expectedMac) + " got mac: " + Hex.toHexString(mac));
			}

			if (!Arrays.areEqual(encrypted, expectedOutput))
			{
				fail("Failed GCM/GMAC test 1 - expected encrypted: " + Hex.toHexString(expectedOutput) + " got encrypted: " + Hex.toHexString(encrypted));
			}
			...
			JavaSystem.arraycopy(decrypted, 0, tempDecrypted, 0, plainText.Length);
			decrypted = tempDecrypted;


			if (!Arrays.areEqual(decrypted, plainText))
			{
				fail("Failed GCM/GMAC test 1 - expected decrypted: " + Hex.toHexString(plainText) + " got decrypted: " + Hex.toHexString(decrypted));
			}
			...
			if (!Arrays.areEqual(mac, expectedMac))
			{
				fail("Failed GCM/GMAC test 2 - expected mac: " + Hex.toHexString(expectedMac) + " got mac: " + Hex.toHexString(mac));
			}

			if (!Arrays.areEqual(encrypted, expectedOutput))
			{
				fail("Failed GCM/GMAC test 2 - expected encrypted: " + Hex.toHexString(expectedOutput) + " got encrypted: " + Hex.toHexString(encrypted));
			}
			...
			if (!Arrays.areEqual(decrypted, plainText))
			{
				fail("Failed GCM/GMAC test 2 - expected decrypted: " + Hex.toHexString(plainText) + " got decrypted: " + Hex.toHexString(decrypted));
			}
			...
			if (!Arrays.areEqual(mac, expectedMac))
			{
				fail("Failed GCM/GMAC test 3 - expected mac: " + Hex.toHexString(expectedMac) + " got mac: " + Hex.toHexString(mac));
			}

			if (!Arrays.areEqual(encrypted, expectedOutput))
			{
				fail("Failed GCM/GMAC test 3 - expected encrypted: " + Hex.toHexString(expectedOutput) + " got encrypted: " + Hex.toHexString(encrypted));
			}
			...
			if (!Arrays.areEqual(decrypted, plainText))
			{
				fail("Failed GCM/GMAC test 3 - expected decrypted: " + Hex.toHexString(plainText) + " got decrypted: " + Hex.toHexString(decrypted));
			}
			...
			if (!Arrays.areEqual(mac, expectedMac))
			{
				fail("Failed GCM/GMAC test 4 - expected mac: " + Hex.toHexString(expectedMac) + " got mac: " + Hex.toHexString(mac));
			}

			if (!Arrays.areEqual(encrypted, expectedOutput))
			{
				fail("Failed GCM/GMAC test 4 - expected encrypted: " + Hex.toHexString(expectedOutput) + " got encrypted: " + Hex.toHexString(encrypted));
			}
			...
			if (!Arrays.areEqual(decrypted, plainText))
			{
				fail("Failed GCM/GMAC test 4 - expected decrypted: " + Hex.toHexString(plainText) + " got decrypted: " + Hex.toHexString(decrypted));
			}
			...
			if (!Arrays.areEqual(mac, expectedMac))
			{
				fail("Failed GCM/GMAC test 5 - expected mac: " + Hex.toHexString(expectedMac) + " got mac: " + Hex.toHexString(mac));
			}

			if (!Arrays.areEqual(encrypted, expectedOutput))
			{
				fail("Failed GCM/GMAC test 5 - expected encrypted: " + Hex.toHexString(expectedOutput) + " got encrypted: " + Hex.toHexString(encrypted));
			}
			...
			if (!Arrays.areEqual(decrypted, plainText))
			{
				fail("Failed GCM/GMAC test 5 - expected decrypted: " + Hex.toHexString(plainText) + " got decrypted: " + Hex.toHexString(decrypted));
			}
			...
			if (!Arrays.areEqual(mac, expectedMac))
			{
				fail("Failed GCM/GMAC test 6 - expected mac: " + Hex.toHexString(expectedMac) + " got mac: " + Hex.toHexString(mac));
			}

			if (!Arrays.areEqual(encrypted, expectedOutput))
			{
				fail("Failed GCM/GMAC test 6 - expected encrypted: " + Hex.toHexString(expectedOutput) + " got encrypted: " + Hex.toHexString(encrypted));
			}
			...
			if (!Arrays.areEqual(decrypted, plainText))
			{
				fail("Failed GCM/GMAC test 6 - expected decrypted: " + Hex.toHexString(plainText) + " got decrypted: " + Hex.toHexString(decrypted));
			}
			...
			if (!Arrays.areEqual(mac, expectedMac))
			{
				fail("Failed GCM/GMAC test 7 - expected mac: " + Hex.toHexString(expectedMac) + " got mac: " + Hex.toHexString(mac));
			}
			...
			if (!Arrays.areEqual(mac, expectedMac))
			{
				fail("Failed GCM/GMAC test 8 - expected mac: " + Hex.toHexString(expectedMac) + " got mac: " + Hex.toHexString(mac));
			}
			...
			if (!Arrays.areEqual(mac, expectedMac))
			{
				fail("Failed GCM/GMAC test 9 - expected mac: " + Hex.toHexString(expectedMac) + " got mac: " + Hex.toHexString(mac));
			}
			...
			if (!Arrays.areEqual(mac, expectedMac))
			{
				fail("Failed GCM/GMAC test 10 - expected mac: " + Hex.toHexString(expectedMac) + " got mac: " + Hex.toHexString(mac));
			}
			...
			if (!Arrays.areEqual(mac, expectedMac))
			{
				fail("Failed GCM/GMAC test 11 - expected mac: " + Hex.toHexString(expectedMac) + " got mac: " + Hex.toHexString(mac));
			}
			...
			if (!Arrays.areEqual(mac, expectedMac))
			{
				fail("Failed GCM/GMAC test 11 (mac) - expected mac: " + Hex.toHexString(expectedMac) + " got mac: " + Hex.toHexString(mac));
			}
		}
		...
		private void doFinalTest(AEADBlockCipher cipher, byte[] key, byte[] iv, byte[] authText, byte[] input, byte[] expected)
		{
			...
			if (!Arrays.areEqual(output, expected))
			{
				JavaSystem.err.println(Hex.toHexString(output));
				JavaSystem.err.println(Hex.toHexString(expected));
