namespace org.bouncycastle.crypto.test
{
	...
	public class WhirlpoolDigestTest : DigestTest
	{
		...
		private string createHexOutputFromDigest(byte[] digestBytes)
		{
			...
			resStr = StringHelper.NewString(Hex.encode(resBuf));
			return resStr;
		}
