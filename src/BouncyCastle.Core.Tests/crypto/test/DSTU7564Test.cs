namespace org.bouncycastle.crypto.test
{
	...
	public class DSTU7564Test : DigestTest
	{
		...
		private static string[] digests = new string[] {"cd5101d1ccdf0d1d1f4ada56e888cd724ca1a0838a3521e7131d4fb78d0f5eb6", "c51a1d639596fb613d86557314a150c40f8fff3de48bc93a3b03c161f4105ee4", "0bd1b36109f1318411a0517315aa46b8839df06622a278676f5487996c9cfc04", "02621dbb53f2c7001be64d7308ecb80d21ba7797c92e98d1efc240d41e4c414b"};
		...
		public DSTU7564Test() : base(new DSTU7564Digest(256), messages, digests)
		{
		}
		...
		private void overflowTest()
		{
			...
			{
				fail("Failed overflow test 1 - expected " + Hex.toHexString(expectedMac) + " got " + Hex.toHexString(mac));
			}
			...
			if (!Arrays.areEqual(expectedMac, mac))
			{
				fail("Failed overflow test 2 - expected " + Hex.toHexString(expectedMac) + " got " + Hex.toHexString(mac));
			}
			...
			{
				fail("Failed overflow test 3 - expected " + Hex.toHexString(expectedDigest) + " got " + Hex.toHexString(digestBuf));
			}
			...
			if (!Arrays.areEqual(expectedDigest, digestBuf))
			{
				fail("Failed overflow test 4 - expected " + Hex.toHexString(expectedDigest) + " got " + Hex.toHexString(digestBuf));
			}
			...
			if (!Arrays.areEqual(expectedDigest, digestBuf))
			{
				fail("Failed overflow test 5 - expected " + Hex.toHexString(expectedDigest) + " got " + Hex.toHexString(digestBuf));
			}
			...
			if (!Arrays.areEqual(expectedDigest, digestBuf))
			{
				fail("Failed overflow test 6 - expected " + Hex.toHexString(expectedDigest) + " got " + Hex.toHexString(digestBuf));
			}
			...
			if (!Arrays.areEqual(expectedDigest, digestBuf))
			{
				fail("Failed overflow test 7 - expected " + Hex.toHexString(expectedDigest) + " got " + Hex.toHexString(digestBuf));
			}
			...
			if (!Arrays.areEqual(expectedDigest, digestBuf))
			{
				fail("Failed overflow test 8 - expected " + Hex.toHexString(expectedDigest) + " got " + Hex.toHexString(digestBuf));
			}
			...
			if (!Arrays.areEqual(expectedDigest, digestBuf))
			{
				fail("Failed overflow test 9 - expected " + Hex.toHexString(expectedDigest) + " got " + Hex.toHexString(digestBuf));
			}
			...
			if (!Arrays.areEqual(expectedDigest, digestBuf))
			{
				fail("Failed overflow test 10 - expected " + Hex.toHexString(expectedDigest) + " got " + Hex.toHexString(digestBuf));
			}
			...
			if (!Arrays.areEqual(expectedDigest, digestBuf))
			{
				fail("Failed overflow test 11 - expected " + Hex.toHexString(expectedDigest) + " got " + Hex.toHexString(digestBuf));
			}
			...
			if (!Arrays.areEqual(expectedDigest, digestBuf))
			{
				fail("Failed overflow test 12 - expected " + Hex.toHexString(expectedDigest) + " got " + Hex.toHexString(digestBuf));
			}
			...
			if (!Arrays.areEqual(expectedDigest, digestBuf))
			{
				fail("Failed overflow test 13 - expected " + Hex.toHexString(expectedDigest) + " got " + Hex.toHexString(digestBuf));
			}
		}
		...
		private void macTests()
		{
			...
			if (!Arrays.areEqual(expectedMac, mac))
			{
				fail("Failed mac test 1a - expected " + Hex.toHexString(expectedMac) + " got " + Hex.toHexString(mac));
			}
			...
			if (!Arrays.areEqual(expectedMac, mac))
			{
				fail("Failed mac test 3 - expected " + Hex.toHexString(expectedMac) + " got " + Hex.toHexString(mac));
			}
		}
		...
		private void hash512Tests()
		{
			...
			{
				fail("Failed hash-512 test 1 - expected " + Hex.toHexString(expectedHash) + " got " + Hex.toHexString(hash));
			}
			...
			if (!Arrays.areEqual(expectedHash, hash))
			{
				fail("Failed hash-512 test 2 - expected " + Hex.toHexString(expectedHash) + " got " + Hex.toHexString(hash));
			}
			...
			if (!Arrays.areEqual(expectedHash, hash))
			{
				fail("Failed hash-512 test 3 - expected " + Hex.toHexString(expectedHash) + " got " + Hex.toHexString(hash));
			}
			...
			if (!Arrays.areEqual(expectedHash, hash))
			{
				fail("Failed hash-512 test 4 - expected " + Hex.toHexString(expectedHash) + " got " + Hex.toHexString(hash));
			}
			...
			if (!Arrays.areEqual(expectedHash, hash))
			{
				fail("Failed hash-512 test 5 - expected " + Hex.toHexString(expectedHash) + " got " + Hex.toHexString(hash));
			}
			...
			if (!Arrays.areEqual(expectedHash, hash))
			{
				fail("Failed hash-512 test 6 - expected " + Hex.toHexString(expectedHash) + " got " + Hex.toHexString(hash));
			}
		}
		...
		private void hash384Tests()
		{
			...
			if (!Arrays.areEqual(expectedHash, hash))
			{
				fail("Failed hash-384 test 1 - expected " + Hex.toHexString(expectedHash) + " got " + Hex.toHexString(hash));
			}
		}
		...
		private void hash256Tests()
		{
			...
			if (!Arrays.areEqual(expectedHash, hash))
			{
				fail("Failed hash-256 test 1 - expected " + Hex.toHexString(expectedHash) + " got " + Hex.toHexString(hash));
			}
			...
			if (!Arrays.areEqual(expectedHash, hash))
			{
				fail("Failed hash-256 test 2 - expected " + Hex.toHexString(expectedHash) + " got " + Hex.toHexString(hash));
			}
			...
			if (!Arrays.areEqual(expectedHash, hash))
			{
				fail("Failed hash-256 test 3 - expected " + Hex.toHexString(expectedHash) + " got " + Hex.toHexString(hash));
			}
			...
			if (!Arrays.areEqual(expectedHash, hash))
			{
				fail("Failed hash-256 test 4 - expected " + Hex.toHexString(expectedHash) + " got " + Hex.toHexString(hash));
			}
			...
			if (!Arrays.areEqual(expectedHash, hash))
			{
				fail("Failed hash-256 test 5 - expected " + Hex.toHexString(expectedHash) + " got " + Hex.toHexString(hash));
			}
			...
			if (!Arrays.areEqual(expectedHash, hash))
			{
				fail("Failed hash-256 test 6 - expected " + Hex.toHexString(expectedHash) + " got " + Hex.toHexString(hash));
			}
		}
	}
