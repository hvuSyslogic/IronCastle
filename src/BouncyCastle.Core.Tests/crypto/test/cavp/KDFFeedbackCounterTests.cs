namespace org.bouncycastle.crypto.test.cavp
{
	...
	public sealed class KDFFeedbackCounterTests : CAVPListener
	{
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.bouncycastle.crypto.params.KDFFeedbackParameters params = org.bouncycastle.crypto.params.KDFFeedbackParameters.createWithCounter(ki, iv, fixedInputData, r);
			KDFFeedbackParameters @params = KDFFeedbackParameters.createWithCounter(ki, iv, fixedInputData, r);
			gen.init(@params);
