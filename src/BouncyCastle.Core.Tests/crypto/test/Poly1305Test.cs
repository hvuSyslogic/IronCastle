namespace org.bouncycastle.crypto.test
{
	...
	public class Poly1305Test : SimpleTest
	{
		...
		public class TestCase
		{
			...
			internal readonly byte[] expectedMac;
			...
			public TestCase(string key, string nonce, string message, string expectedMac)
			{
				...
				this.nonce = (string.ReferenceEquals(nonce, null)) ? null : Hex.decode(nonce);
...
//ORIGINAL LINE: final org.bouncycastle.crypto.Mac mac;
			Mac mac;
			if (tc.nonce == null)
			{
			...
			{
				fail("Mismatched output " + i, StringHelper.NewString(Hex.encode(tc.expectedMac)), StringHelper.NewString(Hex.encode(@out)));
			}
		}
		...
		private void testSequential()
		{
			...
			int c = 0;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.bouncycastle.crypto.Mac mac = new org.bouncycastle.crypto.macs.Poly1305(new org.bouncycastle.crypto.engines.AESEngine());
			Mac mac = new Poly1305(new AESEngine());
			for (int loop = 0; loop < 13; loop++)
			{
				...
				for (; ;)
				{
					...
					// {
					// JavaSystem.err.println("Key bad");
					// JavaSystem.err.println(new String(Hex.encode(tc.key)));
					// JavaSystem.err.println(new String(Hex.encode(kr)));
					// System.exit(1);
					// }
					// if (!Arrays.areEqual(tc.nonce, n))
					// {
					// JavaSystem.err.println("Nonce bad");
					// System.exit(1);
					// }
					// JavaSystem.@out.printf("[%d] m: %s\n", c, new String(Hex.encode(m, 0, len)));
					// JavaSystem.@out.printf("[%d] K: %s\n", c, new String(Hex.encodje(kr)));
					// JavaSystem.@out.printf("[%d] N: %s\n", c, new String(Hex.encode(n)));
					// JavaSystem.@out.printf("[%d] M: ", c);
					// }
					// JavaSystem.@out.printf("%d/%s\n", c, new String(Hex.encode(out)));
			...
			{
				fail("Sequential Poly1305 " + c, "89824ddf0816481051f4a82731cd56d5", StringHelper.NewString(Hex.encode(@out)));
			}
		}
		...
		public virtual void rfc7539Test()
		{
			// From RFC 7539
			...
			keyMaterial = Hex.decode("746869732069732033322d6279746520" + "6b657920666f7220506f6c7931333035");
			...
			data = Hex.decode("00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00" + "00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00" + "00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00" + "00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00");
			...
			data = Hex.decode("41 6e 79 20 73 75 62 6d 69 73 73 69 6f 6e 20 74" + "6f 20 74 68 65 20 49 45 54 46 20 69 6e 74 65 6e" + "64 65 64 20 62 79 20 74 68 65 20 43 6f 6e 74 72" + "69 62 75 74 6f 72 20 66 6f 72 20 70 75 62 6c 69" + "63 61 74 69 6f 6e 20 61 73 20 61 6c 6c 20 6f 72" + "20 70 61 72 74 20 6f 66 20 61 6e 20 49 45 54 46" + "20 49 6e 74 65 72 6e 65 74 2d 44 72 61 66 74 20" + "6f 72 20 52 46 43 20 61 6e 64 20 61 6e 79 20 73" + "74 61 74 65 6d 65 6e 74 20 6d 61 64 65 20 77 69" + "74 68 69 6e 20 74 68 65 20 63 6f 6e 74 65 78 74" + "20 6f 66 20 61 6e 20 49 45 54 46 20 61 63 74 69" + "76 69 74 79 20 69 73 20 63 6f 6e 73 69 64 65 72" + "65 64 20 61 6e 20 22 49 45 54 46 20 43 6f 6e 74" + "72 69 62 75 74 69 6f 6e 22 2e 20 53 75 63 68 20" + "73 74 61 74 65 6d 65 6e 74 73 20 69 6e 63 6c 75" + "64 65 20 6f 72 61 6c 20 73 74 61 74 65 6d 65 6e" + "74 73 20 69 6e 20 49 45 54 46 20 73 65 73 73 69" + "6f 6e 73 2c 20 61 73 20 77 65 6c 6c 20 61 73 20" + "77 72 69 74 74 65 6e 20 61 6e 64 20 65 6c 65 63" + "74 72 6f 6e 69 63 20 63 6f 6d 6d 75 6e 69 63 61" + "74 69 6f 6e 73 20 6d 61 64 65 20 61 74 20 61 6e" + "79 20 74 69 6d 65 20 6f 72 20 70 6c 61 63 65 2c" + "20 77 68 69 63 68 20 61 72 65 20 61 64 64 72 65" + "73 73 65 64 20 74 6f");
			...
			data = Hex.decode("27 54 77 61 73 20 62 72 69 6c 6c 69 67 2c 20 61" + "6e 64 20 74 68 65 20 73 6c 69 74 68 79 20 74 6f" + "76 65 73 0a 44 69 64 20 67 79 72 65 20 61 6e 64" + "20 67 69 6d 62 6c 65 20 69 6e 20 74 68 65 20 77" + "61 62 65 3a 0a 41 6c 6c 20 6d 69 6d 73 79 20 77" + "65 72 65 20 74 68 65 20 62 6f 72 6f 67 6f 76 65" + "73 2c 0a 41 6e 64 20 74 68 65 20 6d 6f 6d 65 20" + "72 61 74 68 73 20 6f 75 74 67 72 61 62 65 2e");
			...
			data = Hex.decode("E3 35 94 D7 50 5E 43 B9 00 00 00 00 00 00 00 00" + "33 94 D7 50 5E 43 79 CD 01 00 00 00 00 00 00 00" + "00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00" + "01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00");

			checkVector(keyMaterial, data, Hex.decode("14 00 00 00 00 00 00 00 55 00 00 00 00 00 00 00"));

			// A.3 #11
			keyMaterial = Hex.decode("01 00 00 00 00 00 00 00 04 00 00 00 00 00 00 0000 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00");
			data = Hex.decode("E3 35 94 D7 50 5E 43 B9 00 00 00 00 00 00 00 00" + "33 94 D7 50 5E 43 79 CD 01 00 00 00 00 00 00 00" + "00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00");
