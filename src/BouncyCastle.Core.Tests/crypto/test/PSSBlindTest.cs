namespace org.bouncycastle.crypto.test
{
	...
	using RSABlindingEngine = org.bouncycastle.crypto.engines.RSABlindingEngine;
	using RSAEngine = org.bouncycastle.crypto.engines.RSAEngine;
	using RSABlindingFactorGenerator = org.bouncycastle.crypto.generators.RSABlindingFactorGenerator;
	...
	using PSSSigner = org.bouncycastle.crypto.signers.PSSSigner;
	 ...
	 */
	public class PSSBlindTest : SimpleTest
	{
		...
		public class FixedRandom : SecureRandom
		{
			private readonly PSSBlindTest outerInstance;

			internal byte[] vals;

			public FixedRandom(PSSBlindTest outerInstance, byte[] vals)
			{
			...
			{
				JavaSystem.arraycopy(vals, 0, bytes, 0, vals.Length);
			}
		}
		...
		//
		private RSAKeyParameters pub1 = new RSAKeyParameters(false, new BigInteger("",16), new BigInteger("010001",16));
		...
		private RSAKeyParameters pub2 = new RSAKeyParameters(false, new BigInteger("", 16), new BigInteger("010001", 16));
		...
		private RSAKeyParameters pub4 = new RSAKeyParameters(false, new BigInteger("", 16), new BigInteger("010001", 16));
		...
		private RSAKeyParameters pub8 = new RSAKeyParameters(false, new BigInteger("", 16), new BigInteger("010001", 16));
		...
		private RSAKeyParameters pub9 = new RSAKeyParameters(false, new BigInteger("", 16), new BigInteger("010001", 16));
		...
		private void testSig(int id, RSAKeyParameters pub, RSAKeyParameters prv, byte[] slt, byte[] msg, byte[] sig)
		{
			...
			blindSigner.init(true, new ParametersWithRandom(@params, new FixedRandom(this, slt)));
		...
		private bool isProcessingOkay(RSAKeyParameters pub, RSAKeyParameters prv, byte[] data, SecureRandom random)
		{
			RSABlindingFactorGenerator blindFactorGen = new RSABlindingFactorGenerator();
			RSABlindingEngine blindingEngine = new RSABlindingEngine();
			PSSSigner blindSigner = new PSSSigner(blindingEngine, new SHA1Digest(), 20);
		...
		public override void performTest()
		{
			...
			RSAKeyParameters[] kprv = new RSAKeyParameters[] {prv1, prv2, prv4, prv8, prv9};
			RSAKeyParameters[] kpub = new RSAKeyParameters[] {pub1, pub2, pub4, pub8, pub9};
