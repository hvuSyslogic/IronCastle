...
{
	using GSKKDFParameters = org.bouncycastle.crypto.agreement.kdf.GSKKDFParameters;
	using GSKKFDGenerator = org.bouncycastle.crypto.agreement.kdf.GSKKFDGenerator;
	using SHA256Digest = org.bouncycastle.crypto.digests.SHA256Digest;
	using Hex = org.bouncycastle.util.encoders.Hex;
	using SimpleTest = org.bouncycastle.util.test.SimpleTest;

	public class GSKKDFTest : SimpleTest
	{
		...
		public override void performTest()
		{
			...
			{
				isEquals("output buffer too small", e.Message);
			}
		}
