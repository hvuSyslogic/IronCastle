namespace org.bouncycastle.crypto.test
{
	...
	public class GOST3412Test : CipherTest
	{
		...
		public GOST3412Test() : base(tests, new GOST3412_2015Engine(), new KeyParameter(new byte[32]))
		{
		}
