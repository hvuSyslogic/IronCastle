...
namespace org.bouncycastle.crypto.test
{
	...
	public class SRP6Test : SimpleTest
	{
		...
		{
			byte[] I = "alice".GetBytes(Encoding.UTF8);
			byte[] P = "password123".GetBytes(Encoding.UTF8);
			...
			BigInteger expect_v = fromHex("7E273DE8696FFC4F4E337D05B4B375BEB0DDE1569E8FA00A9886D812" + "9BADA1F1822223CA1A605B530E379BA4729FDC59F105B4787E5186F5" + "C671085A1447B52A48CF1970B4FB6F8400BBF4CEBFBB168152E08AB5" + "EA53D15C1AFF87B2B9DA6E04E058AD51CC72BFC9033B564E26480D78" + "E955A5E29E7AB245DB2BE315E2099AFB");
			BigInteger expect_A = fromHex("61D5E490F6F1B79547B0704C436F523DD0E560F0C64115BB72557EC4" + "4352E8903211C04692272D8B2D1A5358A2CF1B6E0BFCF99F921530EC" + "8E39356179EAE45E42BA92AEACED825171E1E8B9AF6D9C03E1327F44" + "BE087EF06530E69F66615261EEF54073CA11CF5858F0EDFDFE15EFEA" + "B349EF5D76988A3672FAC47B0769447B");
			BigInteger expect_B = fromHex("BD0C61512C692C0CB6D041FA01BB152D4916A1E77AF46AE105393011" + "BAF38964DC46A0670DD125B95A981652236F99D9B681CBF87837EC99" + "6C6DA04453728610D0C6DDB58B318885D7D82C7F8DEB75CE7BD4FBAA" + "37089E6F9C6059F388838E7A00030B331EB76840910440B1B27AAEAE" + "EB4012B7D7665238A8E3FB004B117B58");
			BigInteger expect_u = fromHex("CE38B9593487DA98554ED47D70A7AE5F462EF019");
			BigInteger expect_S = fromHex("B0DC82BABCF30674AE450C0287745E7990A3381F63B387AAF271A10D" + "233861E359B48220F7C4693C9AE12B0A6F67809F0876E2D013800D6C" + "41BB59B6D5979B5C00A172B4A2A5903A0BDCAF8A709585EB2AFAFA8F" + "3499B200210DCC1F10EB33943CD67FC88A2F39A4BE5BEC4EC0A3212D" + "C346D7E474B29EDE8A469FFECA686E5A");
...
//ORIGINAL LINE: final java.math.BigInteger aVal = a;
			BigInteger aVal = a;
			SRP6Client client = new SRP6ClientAnonymousInnerClass(this, aVal);
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.math.BigInteger bVal = b;
			BigInteger bVal = b;
			SRP6Server server = new SRP6ServerAnonymousInnerClass(this, bVal);
		...
		public class SRP6ClientAnonymousInnerClass : SRP6Client
		{
			private readonly SRP6Test outerInstance;

			private BigInteger aVal;

			public SRP6ClientAnonymousInnerClass(SRP6Test outerInstance, BigInteger aVal)
			{
				this.outerInstance = outerInstance;
				this.aVal = aVal;
			}

			public override BigInteger selectPrivateValue()
			{
				return aVal;
			}
		}

		public class SRP6ServerAnonymousInnerClass : SRP6Server
		{
			private readonly SRP6Test outerInstance;

			private BigInteger bVal;

			public SRP6ServerAnonymousInnerClass(SRP6Test outerInstance, BigInteger bVal)
			{
				this.outerInstance = outerInstance;
				this.bVal = bVal;
			}
