namespace org.bouncycastle.crypto.test
{
	...
	public class BigSkippingCipherTest : TestCase
	{
		public virtual void testAESCTR()
		{
		...
		public virtual void testSalsa20()
		{
		...
		public virtual void testChaCha()
		{
			CipherParameters @params = new ParametersWithIV(new KeyParameter(Hex.decode("0053A6F94C9FF24598EB3E91E4378ADD3083D6297CCF2275C81B6EC11467BA0D")), Hex.decode("0D74DB42A91077DE"));
		...
		public virtual void testCipher(Random random, SkippingStreamCipher linearEngine, SkippingStreamCipher skippingEngine)
		{
