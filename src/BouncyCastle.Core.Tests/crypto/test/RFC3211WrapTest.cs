namespace org.bouncycastle.crypto.test
{
	...
	/// </summary>
	public class RFC3211WrapTest : SimpleTest
	{
		internal SecureRandom r1 = new FixedSecureRandom(Hex.decode("C436F541"));

		internal SecureRandom r2 = new FixedSecureRandom(Hex.decode("FA060A45"));
		...
		private void wrapTest(int id, BlockCipher engine, byte[] kek, byte[] iv, SecureRandom rand, byte[] @in, byte[] @out)
		{
			...
			{
				fail("rfailed unwrap test " + id + " expected " + StringHelper.NewString(Hex.encode(@in)) + " got " + StringHelper.NewString(Hex.encode(pText)));
			}
		}
		...
		public override void performTest()
		{
			...
			wrapTest(2, new DESedeEngine(), Hex.decode("6A8970BF68C92CAEA84A8DF28510858607126380CC47AB2D"), Hex.decode("BAF1CA7931213C4E"), r2, Hex.decode("8C637D887223A2F965B566EB014B0FA5D52300A3F7EA40FFFC577203C71BAF3B"), Hex.decode("C03C514ABDB9E2C5AAC038572B5E24553876B377AAFB82ECA5A9D73F8AB143D9EC74E6CAD7DB260C"));
