namespace org.bouncycastle.crypto.prng.test
{
	...
	public class HashDRBGTest : SimpleTest
	{
		...
		public override void performTest()
		{
			...
			try
			{
				d = new HashSP800DRBG(new SHA256Digest(), 256, (new SHA256EntropyProvider(this)).get(128), null, null);
			...
			try
			{
				d = new HashSP800DRBG(new SHA1Digest(), 256, (new SHA256EntropyProvider(this)).get(256), null, null);
				fail("no exception thrown");
			}
			catch (IllegalArgumentException e)
			{
		...
		{
			private readonly HashDRBGTest outerInstance;

			public SHA1EntropyProvider(HashDRBGTest outerInstance) : base(Hex.decode("000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F202122232425262728292A2B2C2D2E2F30313233343536" + "808182838485868788898A8B8C8D8E8F909192939495969798999A9B9C9D9E9FA0A1A2A3A4A5A6A7A8A9AAABACADAEAFB0B1B2B3B4B5B6" + "C0C1C2C3C4C5C6C7C8C9CACBCCCDCECFD0D1D2D3D4D5D6D7D8D9DADBDCDDDEDFE0E1E2E3E4E5E6E7E8E9EAEBECEDEEEFF0F1F2F3F4F5F6"), true)
			{
		...
		public class SHA256EntropyProvider : TestEntropySourceProvider
		{
			...
			public SHA256EntropyProvider(HashDRBGTest outerInstance) : base(Hex.decode("00010203040506" + "0708090A0B0C0D0E0F101112131415161718191A1B1C1D1E" + "1F202122232425262728292A2B2C2D2E2F30313233343536" + "80818283848586" + "8788898A8B8C8D8E8F909192939495969798999A9B9C9D9E" + "9FA0A1A2A3A4A5A6A7A8A9AAABACADAEAFB0B1B2B3B4B5B6" + "C0C1C2C3C4C5C6" + "C7C8C9CACBCCCDCECFD0D1D2D3D4D5D6D7D8D9DADBDCDDDE" + "DFE0E1E2E3E4E5E6E7E8E9EAEBECEDEEEFF0F1F2F3F4F5F6"), true)
			{
				this.outerInstance = outerInstance;
			}
		}
		...
		public class SHA512EntropyProvider : TestEntropySourceProvider
		{
			...
			public SHA512EntropyProvider(HashDRBGTest outerInstance) : base(Hex.decode("000102030405060708090A0B0C0D0E" + "0F101112131415161718191A1B1C1D1E1F20212223242526" + "2728292A2B2C2D2E2F303132333435363738393A3B3C3D3E" + "3F404142434445464748494A4B4C4D4E4F50515253545556" + "5758595A5B5C5D5E5F606162636465666768696A6B6C6D6E" + "808182838485868788898A8B8C8D8E" + "8F909192939495969798999A9B9C9D9E9FA0A1A2A3A4A5A6" + "A7A8A9AAABACADAEAFB0B1B2B3B4B5B6B7B8B9BABBBCBDBE" + "BFC0C1C2C3C4C5C6C7C8C9CACBCCCDCECFD0D1D2D3D4D5D6" + "D7D8D9DADBDCDDDEDFE0E1E2E3E4E5E6E7E8E9EAEBECEDEE" + "C0C1C2C3C4C5C6C7C8C9CACBCCCDCE" + "CFD0D1D2D3D4D5D6D7D8D9DADBDCDDDEDFE0E1E2E3E4E5E6" + "E7E8E9EAEBECEDEEEFF0F1F2F3F4F5F6F7F8F9FAFBFCFDFE" + "FF000102030405060708090A0B0C0D0E0F10111213141516" + "1718191A1B1C1D1E1F202122232425262728292A2B2C2D2E"), true)
			{
				this.outerInstance = outerInstance;
			}
		}
