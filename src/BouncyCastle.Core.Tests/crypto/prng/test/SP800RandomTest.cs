namespace org.bouncycastle.crypto.prng.test
{
	...
	public class SP800RandomTest : SimpleTest
	{
		...
		{
			DRBGTestVector tv = (new DRBGTestVector(new SHA1Digest(), (new SHA1EntropyProvider(this)).get(440), true, "2021222324", 80, new string[] {"532CA1165DCFF21C55592687639884AF4BC4B057DF8F41DE653AB44E2ADEC7C9303E75ABE277EDBF", "73C2C67C696D686D0C4DBCEB5C2AF7DDF6F020B6874FAE4390F102117ECAAFF54418529A367005A0"})).setPersonalizationString("404142434445464748494A4B4C4D4E4F505152535455565758595A5B5C5D5E5F606162636465666768696A6B6C6D6E6F70717273747576");

			doHashTest(0, tv);

			tv = (new DRBGTestVector(new SHA1Digest(), (new SHA1EntropyProvider(this)).get(440), false, "2021222324", 80, new string[] {"AB438BD3B01A0AF85CFEE29F7D7B71621C4908B909124D430E7B406FB1086EA994C582E0D656D989", "29D9098F987E7005314A0F51B3DD2B8122F4AED706735DE6AD5DDBF223177C1E5F3AEBC52FAB90B9"})).setPersonalizationString("404142434445464748494A4B4C4D4E4F505152535455565758595A5B5C5D5E5F606162636465666768696A6B6C6D6E6F70717273747576");
		...
		{
			SP800SecureRandomBuilder rBuild = new SP800SecureRandomBuilder(new SHA1EntropyProvider(this));
		...
		{
			DRBGTestVector tv = (new DRBGTestVector(new SHA1Digest(), (new SHA1EntropyProvider(this)).get(440), true, "2021222324", 80, new string[] {"6C37FDD729AA40F80BC6AB08CA7CC649794F6998B57081E4220F22C5C283E2C91B8E305AB869C625", "CAF57DCFEA393B9236BF691FA456FEA7FDF1DF8361482CA54D5FA723F4C88B4FA504BF03277FA783"})).setPersonalizationString("404142434445464748494A4B4C4D4E4F505152535455565758595A5B5C5D5E5F606162636465666768696A6B6C6D6E6F70717273747576");

			doHMACTest(tv);

			tv = new DRBGTestVector(new SHA1Digest(), (new SHA1EntropyProvider(this)).get(440), false, "2021222324", 80, new string[] {"5A7D3B449F481CB38DF79AD2B1FCC01E57F8135E8C0B22CD0630BFB0127FB5408C8EFC17A929896E", "82cf772ec3e84b00fc74f5df104efbfb2428554e9ce367d03aeade37827fa8e9cb6a08196115d948"});
		...
		{
			DRBGTestVector tv = new DRBGTestVector(new DESedeEngine(), 168, (new Bit232EntropyProvider(this)).get(232), false, "20212223242526", 112, new string[] {"ABC88224514D0316EA3D48AEE3C9A2B4", "D3D3F372E43E7ABDC4FA293743EED076"});

			doCTRTest(tv);

			tv = (new DRBGTestVector(new DESedeEngine(), 168, (new Bit232EntropyProvider(this)).get(232), true, "20212223242526", 112, new string[] {"64983055D014550B39DE699E43130B64", "035FDDA8582A2214EC722C410A8D95D3"})).setPersonalizationString("404142434445464748494A4B4C4D4E4F505152535455565758595A5B5C");
		...
		{
			SP800SecureRandomBuilder rBuild = new SP800SecureRandomBuilder(new Bit232EntropyProvider(this));
		...
		// for HMAC/Hash
		public class SHA1EntropyProvider : TestEntropySourceProvider
		{
			private readonly SP800RandomTest outerInstance;

			public SHA1EntropyProvider(SP800RandomTest outerInstance) : base(Hex.decode("000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F202122232425262728292A2B2C2D2E2F30313233343536" + "808182838485868788898A8B8C8D8E8F909192939495969798999A9B9C9D9E9FA0A1A2A3A4A5A6A7A8A9AAABACADAEAFB0B1B2B3B4B5B6" + "C0C1C2C3C4C5C6C7C8C9CACBCCCDCECFD0D1D2D3D4D5D6D7D8D9DADBDCDDDEDFE0E1E2E3E4E5E6E7E8E9EAEBECEDEEEFF0F1F2F3F4F5F6"), true)
			{
		...
		// for Dual EC
		public class SHA256EntropyProvider : TestEntropySourceProvider
		{
			private readonly SP800RandomTest outerInstance;

			public SHA256EntropyProvider(SP800RandomTest outerInstance) : base(Hex.decode("000102030405060708090A0B0C0D0E0F " + "808182838485868788898A8B8C8D8E8F" + "C0C1C2C3C4C5C6C7C8C9CACBCCCDCECF"), true)
			{
				this.outerInstance = outerInstance;
			}
		}
		...
		public class Bit232EntropyProvider : TestEntropySourceProvider
		{
			...
			public Bit232EntropyProvider(SP800RandomTest outerInstance) : base(Hex.decode("000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C" + "808182838485868788898A8B8C8D8E8F909192939495969798999A9B9C" + "C0C1C2C3C4C5C6C7C8C9CACBCCCDCECFD0D1D2D3D4D5D6D7D8D9DADBDC"), true)
			{
				this.outerInstance = outerInstance;
			}
		}
