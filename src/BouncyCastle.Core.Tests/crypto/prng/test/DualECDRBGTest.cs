namespace org.bouncycastle.crypto.prng.test
{
	...
	using DualECSP800DRBG = org.bouncycastle.crypto.prng.drbg.DualECSP800DRBG;
	...
	/// </summary>
	public class DualECDRBGTest : SimpleTest
	{
		...
		public override void performTest()
		{
			...
			try
			{
				d = new DualECSP800DRBG(new SHA256Digest(), 256, (new SHA256EntropyProvider(this)).get(128), null, null);
			...
			try
			{
				d = new DualECSP800DRBG(new SHA256Digest(), 256, (new SHA256EntropyProvider(this)).get(1 << (13 - 1) + 1), null, null);
				fail("no exception thrown");
			}
			catch (IllegalArgumentException e)
			{
			...
			try
			{
				d = new DualECSP800DRBG(new SHA1Digest(), 256, (new SHA256EntropyProvider(this)).get(256), null, null);
				fail("no exception thrown");
			}
			catch (IllegalArgumentException e)
			{
		...
		{
			private readonly DualECDRBGTest outerInstance;

			public SHA256EntropyProvider(DualECDRBGTest outerInstance) : base(Hex.decode("000102030405060708090A0B0C0D0E0F " + "808182838485868788898A8B8C8D8E8F" + "C0C1C2C3C4C5C6C7C8C9CACBCCCDCECF"), true)
			{
		...
		public class SHA384EntropyProvider : TestEntropySourceProvider
		{
			...
			public SHA384EntropyProvider(DualECDRBGTest outerInstance) : base(Hex.decode("000102030405060708090A0B0C0D0E0F1011121314151617" + "808182838485868788898A8B8C8D8E8F9091929394959697" + "C0C1C2C3C4C5C6C7C8C9CACBCCCDCECFD0D1D2D3D4D5D6D7"), true)
			{
				this.outerInstance = outerInstance;
			}
		}
		...
		public class SHA512EntropyProvider : TestEntropySourceProvider
		{
			...
			public SHA512EntropyProvider(DualECDRBGTest outerInstance) : base(Hex.decode("000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F" + "808182838485868788898A8B8C8D8E8F909192939495969798999A9B9C9D9E9F" + "C0C1C2C3C4C5C6C7C8C9CACBCCCDCECFD0D1D2D3D4D5D6D7D8D9DADBDCDDDEDF"), true)
			{
				this.outerInstance = outerInstance;
			}
		}
