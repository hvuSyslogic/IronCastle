...
namespace org.bouncycastle.crypto.tls.test
{
	...
	{
		protected internal TlsSession session;
		...
		public override void notifyAlertRaised(short alertLevel, short alertDescription, string message, Exception cause)
		{
			...
			@out.println("DTLS client raised alert: " + AlertLevel.getText(alertLevel) + ", " + AlertDescription.getText(alertDescription));
		...
		{
			PrintStream @out = (alertLevel == AlertLevel.fatal) ? System.err : System.out;
			@out.println("DTLS client received alert: " + AlertLevel.getText(alertLevel) + ", " + AlertDescription.getText(alertDescription));
		}
	...
	//    }
		...
		public override void notifyServerVersion(ProtocolVersion serverVersion)
		{
			...
			JavaSystem.@out.println("Negotiated " + serverVersion);
		}
		...
		{
			private readonly MockDTLSClient outerInstance;

			public TlsAuthenticationAnonymousInnerClass(MockDTLSClient outerInstance)
			{
			...
			public void notifyServerCertificate(Certificate serverCertificate)
			{
				...
				JavaSystem.@out.println("DTLS client received server certificate chain of length " + chain.Length);
