namespace org.bouncycastle.pqc.crypto.test
{
	...
	public class NTRUSignatureParametersTest : TestCase
	{
		public virtual void testLoadSave()
		{
			foreach (NTRUSigningKeyGenerationParameters @params in new NTRUSigningKeyGenerationParameters[]{NTRUSigningKeyGenerationParameters.TEST157, NTRUSigningKeyGenerationParameters.TEST157_PROD, NTRUSigningKeyGenerationParameters.APR2011_743, NTRUSigningKeyGenerationParameters.APR2011_743_PROD})
			{
				testLoadSave(@params);
			}
		}
