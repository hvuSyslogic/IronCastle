...
namespace org.bouncycastle.pqc.crypto.test
{
	...
	using NHOtherInfoGenerator = org.bouncycastle.pqc.crypto.newhope.NHOtherInfoGenerator;
	using Arrays = org.bouncycastle.util.Arrays;
	using Hex = org.bouncycastle.util.encoders.Hex;
	using SimpleTest = org.bouncycastle.util.test.SimpleTest;

	public class NewHopeTest : SimpleTest
	{
	...
	//    private static final byte[] KEYB = Hex.decode("5946400eed4b18ce8d7fb1f744e46e5689009aa4672526c0c59a0adb3dd3ca37");
		...
		private void testPrivInfoGeneration()
		{
			...
			NHOtherInfoGenerator.PartyU partyU = new NHOtherInfoGenerator.PartyU(new AlgorithmIdentifier(OIWObjectIdentifiers_Fields.idSHA1), Hex.decode("beef"), Hex.decode("cafe"), random);

			byte[] partA = partyU.getSuppPrivInfoPartA();

			NHOtherInfoGenerator.PartyV partyV = new NHOtherInfoGenerator.PartyV(new AlgorithmIdentifier(OIWObjectIdentifiers_Fields.idSHA1), Hex.decode("beef"), Hex.decode("cafe"), random);
